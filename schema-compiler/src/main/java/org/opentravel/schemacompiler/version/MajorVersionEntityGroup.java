...
/**
 * Collection of all entities assigned to the same major-version namespace, regardless
 * of whether or not they are owned by the same library.  If multiple minor versions of
 * a particular entity exist, only the latest version will be included in the major-version
 * group.
 */
public class MajorVersionEntityGroup implements Comparable<MajorVersionEntityGroup> {
	...
	/**
	 * Constructor that defines the namespace and version scheme of the
	 * named entity group.
	 * 
	...
	/**
	 * Returns the entity from this group with the specified member name.  If no such
	 * entity exists, this method will return null.
	 * 
