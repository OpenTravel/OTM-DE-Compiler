...
public class OTA2VersionScheme implements VersionScheme {
    ...
    private static final Pattern versionedNamespacePattern =
        Pattern.compile( "(.*?)([/_-][vV])(\\d+)?(?:_(\\d+))?(?:_(\\d+))?" );
    private static final Pattern versionPattern = Pattern.compile( "(\\d+)(?:\\.(\\d+))?(?:\\.(\\d+))?" );
    private static final Pattern prefixPattern = Pattern.compile( "([A-Za-z0-9]+)-\\d*" );

    /**
     * @see org.opentravel.schemacompiler.version.VersionScheme#getVersionIdentifier(java.lang.String, java.lang.String,
     *      java.lang.String)
     */
    @Override
    ...
    public String getVersionIdentifier(String namespaceUri) {
        ...
        if (m.matches()) {
            ...
            versionIdentifier = getDefaultVersionIdentifier();
        }
        return versionIdentifier;
    }

    /**
     * @see org.opentravel.schemacompiler.version.VersionScheme#setVersionIdentifier(java.lang.String, java.lang.String)
     */
    @Override
    public String setVersionIdentifier(String namespaceUri, String versionIdentifier) {
        ...
        for (int i = 0; i < versionParts.length; i++) {
            versionPartsStr[i] = ((isPaddedVersionIds && (versionParts[i] < 10)) ? "0" : "") + versionParts[i];
        }
    ...
    /**
     * @see org.opentravel.schemacompiler.version.VersionScheme#getDefaultVersionIdentifier()
     */
    @Override
    ...
    /**
     * Returns true if the given major version string (assumed to be obtained from a versioned namespace URI) contains a
     * '0' character for padding in front of the actual version number. This check was included for
     * backwards-compatibility with some of the legacy identifiers that were in existence prior to finalizing this
     * version scheme.
     * 
    ...
    /**
     * @see org.opentravel.schemacompiler.version.VersionScheme#getPrefix(java.lang.String, java.lang.String)
     */
    @Override
    ...
    public String getMajorVersion(String versionIdentifier) {
        return "" + splitVersionIdentifier( versionIdentifier )[0];
    }
    ...
    public String getMinorVersion(String versionIdentifier) {
        return "" + splitVersionIdentifier( versionIdentifier )[1];
    }
    ...
    public String getPatchLevel(String versionIdentifier) {
        return "" + splitVersionIdentifier( versionIdentifier )[2];
    }
    ...
    public boolean isValidNamespace(String namespaceUri) {
        return URLUtils.isValidURI( namespaceUri ) && versionedNamespacePattern.matcher( namespaceUri ).matches();
    }
    ...
    /**
     * @see org.opentravel.schemacompiler.version.VersionScheme#getDefaultFileHint(java.lang.String, java.lang.String)
     */
    @Override
    public String getDefaultFileHint(String namespaceUri, String libraryName) {
        return libraryName.replaceAll( "\\s+", "_" ) + "_" + getVersionIdentifier( namespaceUri ).replace( '.', '_' )
            + ".otm";
    }
