...
public final class PatchVersionHelper extends AbstractVersionHelper {
    ...
    public List<TLExtensionPointFacet> getLaterPatchVersions(Versioned versionedEntity) throws VersionSchemeException {
        ...
        if (versionedMember.getOwningLibrary() instanceof TLLibrary) {
            List<TLLibrary> patchVersionLibraries =
                getLaterPatchVersions( (TLLibrary) versionedMember.getOwningLibrary() );
    ...
    /**
     * Adds all of the extension point facets from the list of patch version libraries that extend the given versioned
     * entity.
     * 
    ...
    private void addPatchingFacets(Versioned versionedEntity, List<TLLibrary> patchVersionLibraries,
        ...
        // can refer
        Set<TLPatchableFacet> entityFacets =
            new HashSet<>( getVersionHandler( versionedEntity ).getPatchableFacets( versionedEntity ) );
     ...
     * @return TLLibrary
     * @throws VersionSchemeException thrown if the library's version scheme is not recognized
     * @throws LibrarySaveException thrown if an exception occurs while saving the new library version
     */
