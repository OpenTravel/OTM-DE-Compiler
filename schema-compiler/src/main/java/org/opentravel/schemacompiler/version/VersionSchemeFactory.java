...
/**
 * Factory used to obtain <code>VersionScheme</code> instances based on a version scheme identifier string.
 * 
 * @author S. Livezey
 */
public class VersionSchemeFactory {
    ...
    /**
     * Examines the local classpath for the file that will identify the version scheme implementation class for the
     * requested version scheme identifier.
     * 
     * @param versionSchemeIdentifier the string that identifies the desired version scheme implementation
     * @return VersionScheme
     * @throws VersionSchemeException thrown if the a class cannot be identified for the specified version scheme
     *         identifier
     */
    @SuppressWarnings("unchecked")
    public VersionScheme getVersionScheme(String versionSchemeIdentifier) throws VersionSchemeException {
        Class<? extends VersionScheme> versionSchemeClass =
            (Class<? extends VersionScheme>) versionSchemeMappings.get( versionSchemeIdentifier );
        ...
        if (versionSchemeClass != null) {
            try {
                ...
                throw new VersionSchemeException(
                    "Error instantiating version scheme implementation class: " + versionSchemeClass.getName(), e );
            }
        } else {
            throw new VersionSchemeException( "Unknown version scheme identifier: " + versionSchemeIdentifier );
        }
        return versionScheme;
    }
     ...
     * 
     * @param mappings the version scheme mappings to assign
     */
    public void setVersionSchemeMappings(Properties mappings) {
        try {
            ...
            for (Object key : mappings.keySet()) {
                ...
                versionSchemeMappings.put( versionSchemeIdentitifer, Class.forName( versionSchemeClass ) );
            }
     ...
     * 
     * @param defaultVersionScheme the default version scheme to assign
     */
