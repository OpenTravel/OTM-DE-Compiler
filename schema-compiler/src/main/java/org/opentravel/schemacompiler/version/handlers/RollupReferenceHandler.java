...
public class RollupReferenceHandler {
     ...
     * @param rollupLibraries the collection of libraries being rolled up
     */
    @SafeVarargs
    ...
    private ClassSpecificFunction<Void> captureReferencesFunction =
        new ClassSpecificFunction<Void>().addFunction( TLAttribute.class, e -> {
    ...
    private class RollupReferenceAdjustmentVisitor extends ModelElementVisitorAdapter {
        ...
        private List<? extends TLMemberField<?>> getInheritedMembers(TLMemberField<?> originalField,
            ...
            if (originalField instanceof TLAttribute) {
                if (sameNameOwner instanceof TLFacet) {
                    ...
                    inheritedMembers =
                        PropertyCodegenUtils.getInheritedAttributes( (TLValueWithAttributes) sameNameOwner );
                }
                ...
                if (sameNameOwner instanceof TLFacet) {
                    ...
                    inheritedMembers =
                        PropertyCodegenUtils.getInheritedIndicators( (TLValueWithAttributes) sameNameOwner );
                }
            }
        ...
        public boolean visitSimple(TLSimple simple) {
            if (rollupReferences.hasReference( simple )) {
                TLAttributeType sameNameEntity =
                    findSameNameEntity( rollupReferences.getReference( simple, TLAttributeType.class ),
        ...
        public boolean visitValueWithAttributes(TLValueWithAttributes vwa) {
            if (rollupReferences.hasReference( vwa )) {
                TLAttributeType sameNameEntity = findSameNameEntity(
                    rollupReferences.getReference( vwa, TLAttributeType.class ), (TLLibrary) vwa.getOwningLibrary() );
        ...
        public boolean visitSimpleFacet(TLSimpleFacet simpleFacet) {
            if (rollupReferences.hasReference( simpleFacet )) {
                TLAttributeType sameNameEntity =
                    findSameNameEntity( rollupReferences.getReference( simpleFacet, TLAttributeType.class ),
        ...
        public boolean visitAttribute(TLAttribute attribute) {
            if (rollupReferences.hasReference( attribute )) {
                TLPropertyType sameNameEntity =
                    findSameNameEntity( rollupReferences.getReference( attribute, TLPropertyType.class ),
        ...
        public boolean visitElement(TLProperty element) {
            if (rollupReferences.hasReference( element )) {
                TLPropertyType sameNameEntity =
                    findSameNameEntity( rollupReferences.getReference( element, TLPropertyType.class ),
        ...
        public boolean visitExtension(TLExtension extension) {
            if (rollupReferences.hasReference( extension )) {
                NamedEntity sameNameEntity =
                    findSameNameEntity( rollupReferences.getReference( extension, NamedEntity.class ),
        ...
        public boolean visitResource(TLResource resource) {
            if (rollupReferences.hasReference( resource )) {
                TLBusinessObject sameNameEntity =
                    findSameNameEntity( rollupReferences.getReference( resource, TLBusinessObject.class ),
        ...
        public boolean visitResourceParentRef(TLResourceParentRef parentRef) {
            if (rollupReferences.hasReference( parentRef )) {
                TLParamGroup sameNameParamGroup =
                    findSameNameParamGroup( rollupReferences.getReference( parentRef, TLParamGroup.class ),
                        (TLLibrary) parentRef.getOwningLibrary() );
                TLResource sameNameResource =
                    findSameNameEntity( rollupReferences.getReference( parentRef, TLResource.class ),
                        (TLLibrary) parentRef.getOwningLibrary() );
        ...
        public boolean visitParameter(TLParameter parameter) {
            if (rollupReferences.hasReference( parameter )) {
                TLMemberField<?> sameNameField =
                    findSameNameField( rollupReferences.getReference( parameter, TLMemberField.class ),
        ...
        public boolean visitActionRequest(TLActionRequest actionRequest) {
            if (rollupReferences.hasReference( actionRequest )) {
                TLParamGroup sameNameParamGroup =
                    findSameNameParamGroup( rollupReferences.getReference( actionRequest, TLParamGroup.class ),
                        (TLLibrary) actionRequest.getOwningLibrary() );
                TLActionFacet sameNamePayloadType =
                    findSameNameEntity( rollupReferences.getReference( actionRequest, TLActionFacet.class ),
                        (TLLibrary) actionRequest.getOwningLibrary() );
        ...
        public boolean visitActionResponse(TLActionResponse actionResponse) {
            if (rollupReferences.hasReference( actionResponse )) {
                TLActionFacet sameNamePayloadType =
                    findSameNameEntity( rollupReferences.getReference( actionResponse, TLActionFacet.class ),
