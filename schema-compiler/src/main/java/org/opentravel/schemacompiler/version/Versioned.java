...
public interface Versioned extends NamedEntity {
    ...
    /**
     * Returns the fully-qualified namespace for the model element, including the version identifier suffix.
     * 
     * @return String
     */
    ...
    /**
     * Returns the base namespace for the model element. The base namespace URI is the portion that does not include the
     ...
     * <li>The other item's version is considered to be later than this item's version according to the version
     * scheme.</li>
     * </ul>
     * 
