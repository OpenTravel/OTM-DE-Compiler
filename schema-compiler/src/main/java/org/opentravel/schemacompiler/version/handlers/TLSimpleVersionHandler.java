...
/**
 * <code>VersionHandler</code> implementation for <code>TLSimple</code> model entities.
 * 
 * @author S. Livezey
 */
public class TLSimpleVersionHandler extends VersionHandler<TLSimple> {
    ...
    public void rollupMinorVersion(TLSimple minorVersion, TLSimple majorVersionTarget,
        ...
        new VersionHandlerMergeUtils( getFactory() ).mergeSimpleConstraints( majorVersionTarget, minorVersion );
    }
