...
public class VersionHandlerFactory {
    ...
    /**
     * Returns a <code>ModelElementCloner</code> that can be used to create a deep clone of a model entity.
     * 
    ...
    /**
     * Initializes the mappings of <code>Versioned</code> objects to <code>VersionHandler</code> implementation classes.
     */
    static {
