...
public class VersionHandlerMergeUtils {
    ...
    /**
     * Merges the contents of the given list into the specified target entity. If any attributes with the same name
     * already exist in the target, the merge item(s) will be ignored.
     * 
    ...
    /**
     * Merges the contents of the given list into the specified target entity. If any properties with the same name
     * already exist in the target (or, in the case of complex types, properties from the same substitution group), the
     * merge item(s) will be ignored.
     * 
    ...
    /**
     * Scans the the target facet in order to find existing properties that will not need to be merged to the new
     * version.
     * 
    ...
    /**
     * Merges the contents of the given list into the specified target entity. If any indicators with the same name
     * already exist in the target, the merge item(s) will be ignored.
     * 
    ...
    /**
     * Adds the given facet to the identity map, using the full identity string of the facet as the key.
     * 
    ...
    public void addToIdentityFacetMap(TLFacet facet, Map<String,TLFacet> identityFacetMap) {
        if (facet != null) {
            if (facet instanceof TLContextualFacet) {
                identityFacetMap.put( facet.getFacetType().getIdentityName( ((TLContextualFacet) facet).getName() ),
                    facet );
    ...
    /**
     * Merges the contents of the given list into the specified target entity. If any enumerated values with the same
     * literal already exist in the target, the merge item(s) will be ignored.
     * 
    ...
    /**
     * Merges the constraints of the given source entity into the target. If any constraint is already defined in the
     * target entity, that source item constraint will be ignored.
     * 
