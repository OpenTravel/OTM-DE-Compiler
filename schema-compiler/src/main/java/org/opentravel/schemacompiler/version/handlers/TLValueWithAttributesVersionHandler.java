...
/**
 * <code>VersionHandler</code> implementation for <code>TLValueWithAttributes</code> model entities.
 *
 * @author S. Livezey
 */
public class TLValueWithAttributesVersionHandler extends VersionHandler<TLValueWithAttributes> {
    ...
    protected NamedEntity getBaseExtension(TLValueWithAttributes entity) throws VersionSchemeException {
        ...
        if (entity != null) {
            ...
            TLValueWithAttributes earliestMinorVersion =
    ...
    public void rollupMinorVersion(TLValueWithAttributes minorVersion, TLValueWithAttributes majorVersionTarget,
        ...
        new VersionHandlerMergeUtils( getFactory() ).mergeAttributes( majorVersionTarget, minorVersion.getAttributes(),
            referenceHandler );
        new VersionHandlerMergeUtils( getFactory() ).mergeIndicators( majorVersionTarget,
            minorVersion.getIndicators() );
    }
