...
/**
 * Defines the contract for the encoding and management of version schemes as part of an encoded namespace URI.
 * 
 * @author S. Livezey
 */
public interface VersionScheme {
     ...
     * 
     * @param majorVersion the major version of the versioned component
     * @param minorVersion the minor version of the versioned component
     * @param patchLevel the patch level of the versioned component
     * @return String
     */
    public String getVersionIdentifier(String majorVersion, String minorVersion, String patchLevel);

    /**
     * Returns the version identifier string encoded into the given namespace URI, or null if a version identifier is
     * not specified on the namespace. Null will also be returned if the given URI does not conform to the format
     * required by the version scheme.
     * 
     * @param namespaceUri the namespace URI from which to obtain the version identifier
     * @return String
     */
     ...
     * 
     * @param namespaceUri the namespace URI to be updated
     * @param versionIdentifier the un-encoded version identifier as returned by the 'getVersionIdentifier()' method
     * @return String
     * @throws IllegalArgumentException thrown if either the namespace URI or version identifier are not valid for the
     *         version scheme
     */
     ...
     * 
     * @param prefix the original prefix from which to derive the base prefix string
     * @param versionIdentifier the version identifier to assign for the new prefix
     * @return String
     */
     ...
     * 
     * @param namespaceUri the namespace URI for which to return the base
     * @return String
     * @throws IllegalArgumentException thrown if the namespace URI is not valid for the version scheme
     */
     ...
     * 
     * @param namespaceUri the namespace URI for which to return the major-version namespace
     * @return String
     */
    public String getMajorVersionNamespace(String namespaceUri);

    /**
     * Returns true if the given namespace URI conforms to the formatting required by this version scheme.
     * 
     * @param namespaceUri the namespace URI to validate
     * @return boolean
     */
    public boolean isValidNamespace(String namespaceUri);

    /**
     * Returns true if the given version identifier conforms to the formatting required by this version scheme.
     * 
     * @param versionIdentifier the version identifier to be validated
     * @return boolean
     */
     ...
     * 
     * @param namespaceUri the namespace URI to analyze
     * @return boolean
     */
    ...
    /**
     * Returns a comparator that is capable of sorting <code>Versioned</code> objects that are assigned to this version
     * scheme.
     * 
    ...
    /**
     * Returns the list of namespace URI's that represent the major version chain for the given namespace. The version
     * chain consists of all previous versions up to and including the major version that originated the chain.
     * 
     * <p>
     * For example, the version chain for version <code>2.3.2</code> is: <code>2.3.2</code>, <code>2.3.1</code>,
     * <code>2.3.0</code>, <code>2.2.0</code>, <code>2.1.0</code>, <code>2.0.0</code>.
     * 
     * <p>
     * Versions such as <code>2.0.1</code> or <code>2.2.5</code> would not be included in this chain (even if they
     * exist) because they would be assumed to be "rolled up" into versions that are part of the chain.
     * 
     * @param namespaceUri the namespace for which to return the major version chain of namespaces
     * @return List&lt;String&gt;
     */
     ...
     * 
     * @param namespaceUri the namespace to which the user-defined library is assigned
     * @param libraryName the name of the user-defined library
     * @return String
     */
