...
/**
 * Defines the contract for the encoding and management of version schemes as part of an
 * encoded namespace URI.
 * 
 * @author S. Livezey
 */
public interface VersionScheme {
	...
	/**
	 * Returns the version identifier string encoded into the given namespace URI, or null
	 * if a version identifier is not specified on the namespace.  Null will also be returned
	 * if the given URI does not conform to the format required by the version scheme.
	 * 
	 ...
	 * @param versionIdentifier  the un-encoded version identifier as returned by the 'getVersionIdentifer()' method
	 * @return String
	...
	/**
	 * Returns true if the given namespace URI conforms to the formatting required by this
	 * version scheme.
	 * 
	 ...
	 * version scheme.
	 * 
	 * @param patchLevel  the patch-level string to validate
	 * @return boolean
	 */
	 ...
	 * namespace.  The version chain consists of all previous versions up to and including the
	 * major version that originated the chain.
	 * 
	 * <p>For example, the version chain for version <code>2.3.2</code> is: <code>2.3.2</code>,
	 * <code>2.3.1</code>, <code>2.3.0</code>, <code>2.2.0</code>, <code>2.1.0</code>, <code>2.0.0</code>.
	 * 
	 * <p>Versions such as <code>2.0.1</code> or <code>2.2.5</code> would not be included in this chain (even
	 * if they exist) because they would be assumed to be "rolled up" into versions that are part of the chain.
	 *  
	 * @param namespaceUri
	 * @return List<String>
	 */
