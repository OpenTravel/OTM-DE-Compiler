...
public class TypeNameIntegrityChecker
    ...
    private static ClassSpecificAssignment<String> assignTypeNameFunction =
        new ClassSpecificAssignment<String>().addAssignment( TLSimple.class, (s, v) -> s.setParentTypeName( v ) )
