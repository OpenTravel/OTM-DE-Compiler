...
/**
 * Integrity checker base class that provides support for the auto-creation of
 * <code>TLContext</code> declarations.
 * 
 * @param <E>
 ...
 * @author S. Livezey
 */
public abstract class ContextAutoCreateIntegrityChecker<E extends ModelEvent<S>, S> extends
        AbstractIntegrityChecker<E, S> {

    /**
     * Searches the context declarations in the given library and automatically creates one with the
     * specified context ID, if it does not already exist.
     * 
     * @param library
     *            the library that owns the context declaration(s)
     * @param contextId
