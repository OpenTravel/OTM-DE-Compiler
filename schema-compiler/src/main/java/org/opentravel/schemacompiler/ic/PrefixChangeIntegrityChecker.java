...
/**
 * Model integrity check listener, that ensures all 'typeName' fields in a library are updated when the prefix field of
 * a referenced namespace is modified.
 * 
 * @author S. Livezey
 */
public class PrefixChangeIntegrityChecker
    extends AbstractIntegrityChecker<ValueChangeEvent<TLNamespaceImport,String>,TLNamespaceImport> {
    ...
    /**
     * Visitor that handles updates the entity name field for any entities who reference another entity assigned to the
     * namespace whose prefix was modified.
     * 
     * @author S. Livezey
     */
    private static class ImportPrefixChangeVisitor extends ModelElementVisitorAdapter {
        ...
        /**
         * Constructor that specifies the library whose members may have been affected by a prefix-change event, and the
         * namespace whose associated prefix was modified.
         * 
        ...
        public boolean visitSimple(TLSimple simple) {
            if ((simple.getParentType() != null) && affectedNamespace.equals( simple.getParentType().getNamespace() )) {
                simple.setParentTypeName(
                    symbolResolver.buildEntityName( affectedNamespace, simple.getParentType().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitValueWithAttributes(TLValueWithAttributes valueWithAttributes) {
            if ((valueWithAttributes.getParentType() != null)
                ...
                valueWithAttributes.setParentTypeName( symbolResolver.buildEntityName( affectedNamespace,
                    valueWithAttributes.getParentType().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitExtension(TLExtension extension) {
            if ((extension.getExtendsEntity() != null)
                ...
                extension.setExtendsEntityName(
                    symbolResolver.buildEntityName( affectedNamespace, extension.getExtendsEntity().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitSimpleFacet(TLSimpleFacet simpleFacet) {
            if ((simpleFacet.getSimpleType() != null)
                ...
                simpleFacet.setSimpleTypeName(
                    symbolResolver.buildEntityName( affectedNamespace, simpleFacet.getSimpleType().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitContextualFacet(TLContextualFacet facet) {
            if ((facet.getOwningEntity() != null)
                ...
                facet.setOwningEntityName(
                    symbolResolver.buildEntityName( affectedNamespace, facet.getOwningEntity().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitAttribute(TLAttribute attribute) {
            if ((attribute.getType() != null) && affectedNamespace.equals( attribute.getType().getNamespace() )) {
                attribute.setTypeName(
                    symbolResolver.buildEntityName( affectedNamespace, attribute.getType().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitElement(TLProperty element) {
            if ((element.getType() != null) && affectedNamespace.equals( element.getType().getNamespace() )) {
                element.setTypeName(
                    symbolResolver.buildEntityName( affectedNamespace, element.getType().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitResource(TLResource resource) {
            if ((resource.getBusinessObjectRef() != null)
                ...
                resource.setBusinessObjectRefName( symbolResolver.buildEntityName( affectedNamespace,
                    resource.getBusinessObjectRef().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitResourceParentRef(TLResourceParentRef parentRef) {
            if ((parentRef.getParentResource() != null)
                ...
                parentRef.setParentResourceName(
                    symbolResolver.buildEntityName( affectedNamespace, parentRef.getParentResource().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitParamGroup(TLParamGroup paramGroup) {
            if ((paramGroup.getFacetRef() != null)
                ...
                paramGroup.setFacetRefName(
                    symbolResolver.buildEntityName( affectedNamespace, paramGroup.getFacetRef().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitActionRequest(TLActionRequest actionRequest) {
            if ((actionRequest.getPayloadType() != null)
                ...
                actionRequest.setPayloadTypeName( symbolResolver.buildEntityName( affectedNamespace,
                    actionRequest.getPayloadType().getLocalName() ) );
            }
            return true;
        }
        ...
        public boolean visitActionResponse(TLActionResponse actionResponse) {
            if ((actionResponse.getPayloadType() != null)
                ...
                actionResponse.setPayloadTypeName( symbolResolver.buildEntityName( affectedNamespace,
                    actionResponse.getPayloadType().getLocalName() ) );
            }
            return true;
        }
