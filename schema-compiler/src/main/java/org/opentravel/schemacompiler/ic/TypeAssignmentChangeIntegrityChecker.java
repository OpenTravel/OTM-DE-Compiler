 ...
 * maintained by a <code>TLLibrary</code> instance. It is invoked whenever type assignments are
 * modified within the model, taking action to add or remove imports/includes as required.
 * 
 * @author S. Livezey
 */
public class TypeAssignmentChangeIntegrityChecker
        extends
        ImportManagementIntegrityChecker<ValueChangeEvent<TLModelElement, NamedEntity>, TLModelElement> {
