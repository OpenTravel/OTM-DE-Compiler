...
public abstract class ImportManagementIntegrityChecker<E extends ModelEvent<S>,S>
	...
	/**
	 * Check each library in the list of references provided and add any missing imports or includes
	...
	private static void verifyLibraryImport(TLLibrary owningLibrary, AbstractLibrary referencedLibrary,
		...
		if (referencedNamespace != null) {
			...
			if (importReference == null) { // Add a new namespace for this import
				importReference = new TLNamespaceImport( getUniquePrefix( owningLibrary, referencedLibrary ),
						referencedNamespace );
	...
	/**
	 * Adds the file hint provided to the given import reference if such a hint does not
	 * already exist.
	 * 
