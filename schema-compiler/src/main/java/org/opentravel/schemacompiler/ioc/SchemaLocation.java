...
public class SchemaLocation {
    ...
    /**
     * Returns the file format of the schema. As a convention, this value should match one of the target format
     * constants defined in the <code>CodeGeneratorFactory</code> class.
     *
    ...
    /**
     * Assigns the file format of the schema. As a convention, this value should match one of the target format
     * constants defined in the <code>CodeGeneratorFactory</code> class.
     *
     * @see org.opentravel.schemacompiler.codegen.CodeGeneratorFactory
