...
public class InheritanceHierarchyBuilder {
    ...
    private static final TLFacetType[] ISOLATED_HIERARCHIES =
        new TLFacetType[] {TLFacetType.QUERY, TLFacetType.REQUEST, TLFacetType.RESPONSE, TLFacetType.NOTIFICATION};
    ...
    private NamedEntity getIsolatedRootMember(TLFacet memberFacet, TLAlias memberAlias,
        ...
        while (baseFacetOwner != null) {
            ...
            TLFacet baseFacet =
                FacetCodegenUtils.getFacetOfType( baseFacetOwner, memberFacet.getFacetType(), facetName );
