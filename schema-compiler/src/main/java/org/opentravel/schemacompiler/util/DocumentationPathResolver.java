...
/**
 * Static utility methods that assist with the resolution of
 * <code>TLDocumentationOwner</code> elements and documentation
 * patches within the OTM model.
 */
public class DocumentationPathResolver {
	...
	private static class ResolverContext {
		...
		/**
		 * If no further path components are available the given model element is
		 * assigned as the final resolved documentation owner.
		 *
		...
		/**
		 * Advances to the next available path component.  If no further path
		 * components are available, this method will return false.
		 * 
		 * @return boolean
		 */
	...
	/**
	 * Provides the contract for resolving a documentation path
	 * component for a particular type of documentation owner.
	 * 
	...
	private interface PathResolver<T extends ModelElement> {
		...
		/**
		 * Resolves the next path component and returns the resulting model
		 * element.
		 * 
	...
	private static class LibraryResolver implements PathResolver<TLLibrary> {
		...
		/**
		 * @see org.opentravel.schemacompiler.util.DocumentationPathResolver.PathResolver#resolve(org.opentravel.schemacompiler.model.ModelElement, org.opentravel.schemacompiler.util.DocumentationPathResolver.ResolverContext)
		 */
		@Override
	...
	/**
	 * Handles resolution of path components for all model elements that are not handled
	 * by other resolvers.
	 */
