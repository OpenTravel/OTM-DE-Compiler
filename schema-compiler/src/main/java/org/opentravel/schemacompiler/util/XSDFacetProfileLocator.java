...
/**
 * Implements a recursive routine to locate the <code>XSDFacetProfile</code> for certain simple types that obtain their
 * profile from other related model elements.
 */
public class XSDFacetProfileLocator {
    ...
    /**
     * Recursive routine that searches for a concrete <code>XSDFacetProfile</code> while avoiding infinite loops due to
     * circular references.
     * 
