...
/**
 * Performs model-level comparisons of two OTM model components. The algorithm can handle comparisons of two versions of
 * the same OTM component or two different components that are otherwise unrelated. There is no requirement for both
 * components to exist within the same OTM model instance.
 */
public class ModelComparator {
    ...
    /**
     * Compares two versions of the same OTM release and writes a formatted HTML report of the results to the output
     * stream provided.
     * 
     * @param oldRelease the old release version
     * @param newRelease the new release version
    ...
    /**
     * Compares two versions of the same OTM project and writes a formatted HTML report of the results to the output
     * stream provided.
     * 
     * @param oldProject the old project version
     * @param newProject the new project version
     ...
     * @throws IOException thrown if an error occurs during report generation
     */
    public void compareProjects(Project oldProject, Project newProject, OutputStream out) throws IOException {
    ...
    /**
     * Compares two versions of the same OTM library and writes a formatted HTML report of the results to the output
     * stream provided.
     * 
     * @param oldLibrary the old library version
     * @param newLibrary the new library version
     ...
     * @throws IOException thrown if an error occurs during report generation
     */
    public void compareLibraries(TLLibrary oldLibrary, TLLibrary newLibrary, OutputStream out) throws IOException {
    ...
    public EntityChangeSet compareEntities(NamedEntity oldEntity, NamedEntity newEntity) {
        ...
        return comparator.compareEntities( new EntityComparisonFacade( oldEntity ),
            new EntityComparisonFacade( newEntity ) );
    }

    /**
     * Compares two versions of the same OTM entity and writes a formatted HTML report of the results to the output
     * stream provided.
     * 
     * @param oldEntity the old entity version
     * @param newEntity the new entity version
     ...
     * @throws IOException thrown if an error occurs during report generation
     */
    public void compareEntities(NamedEntity oldEntity, NamedEntity newEntity, OutputStream out) throws IOException {
    ...
    /**
     * Compares two versions of the same OTM resource and writes a formatted HTML report of the results to the output
     * stream provided.
     * 
     * @param oldResource the old resource version
     * @param newResource the new resource version
     ...
     * @throws IOException thrown if an error occurs during report generation
     */
    public void compareResources(TLResource oldResource, TLResource newResource, OutputStream out) throws IOException {
        generateReport( compareResources( oldResource, newResource ), RESOURCE_DIFF_TEMPLATE, out );
    }

    /**
     * Generates a formatted HTML report using a velocity template and the OTM-Diff results provided.
     * 
     ...
     * @throws IOException thrown if an error occurs during report generation
     */
    private void generateReport(Object changeSet, String templateName, OutputStream out) throws IOException {
    ...
    /**
     * Initializes and configures the default instance of the Velocity template processing engine.
     */
    static {
        try {
