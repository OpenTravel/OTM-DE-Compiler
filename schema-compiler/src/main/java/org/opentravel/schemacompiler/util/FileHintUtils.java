...
/**
 * Handles the resolution of file hints for OTM import declarations. In some cases, the file paths contain white-space
 * characters. This class attempts to resolve the naming conflicts to return a list of valid file-hint paths.
 * 
 * @author S. Livezey
 */
public class FileHintUtils {
    ...
    /**
     * Attempts to resolve each of the given file hints to resources on the local file system. If any of the hints
     * represent files that do not exist, they are combined with adjacent hints in an attempt to resolve white-space
     * character issues.
     * 
     * @param hints the space-separated list of file hints to resolve
     * @param libraryUrl the URL of the owning library
     * @return List&lt;String&gt;
     */
    public static List<String> resolveHints(String hints, URL libraryUrl) {
        return (hints == null) ? new ArrayList<>() : resolveHints( hints.trim().split( "\\s+" ), libraryUrl );
    }
     ...
     * character issues.
     * 
     * @param hints the array of file hints to resolve
     * @param libraryUrl the URL of the owning library
     * @return List&lt;String&gt;
     */
    public static List<String> resolveHints(String[] hints, URL libraryUrl) {
        return (hints == null) ? new ArrayList<>() : resolveHints( Arrays.asList( hints ), libraryUrl );
    }
     ...
     * character issues.
     * 
     * @param hints the list of file hints to resolve
     * @param libraryUrl the URL of the owning library
     * @return List&lt;String&gt;
     */
    ...
    private static void resolveFileHint(String hint, URL libraryUrl, List<String> resolvedHints,
        ...
        try {
            ...
            if (hintFile.exists() || (badHints.isEmpty() && hasFileExtension( hint ))) {
                ...
                hintFile = URLUtils.toFile( URLUtils.getResolvedURL( compoundHint, libraryUrl ) );
     ...
     * 
     * @param hint the file hint string to analyze
     * @return boolean
     */
