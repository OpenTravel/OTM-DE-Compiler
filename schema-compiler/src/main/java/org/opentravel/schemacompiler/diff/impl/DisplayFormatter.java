...
public class DisplayFormatter {
    ...
    /**
     * Constructor that supplies the repository manager instance to use for remote library lookups.
     * 
    ...
    public String getEntityTypeDisplayName(Class<?> entityType) {
        return (entityType == null) ? null
            : SchemaCompilerApplicationContext.getContext().getMessage( entityType.getSimpleName() + ".displayName",
    ...
    public String getLibraryStatusDisplayName(TLLibraryStatus status) {
        return (status == null) ? null
            : SchemaCompilerApplicationContext.getContext().getMessage( status.toString(), null, Locale.getDefault() );
    }
    ...
    /**
     * Returns the name of the field as it will be referenced in an XML schema declaration.
     * 
    ...
    /**
     * Returns the repository URL for the given library or null if the library is not managed by a repository.
     * 
        ...
        if ((item != null) && (item.getRepository() instanceof RemoteRepository)) {
            try {
                StringBuilder urlBuilder =
                    new StringBuilder( ((RemoteRepository) item.getRepository()).getEndpointUrl() );
    ...
    /**
     * Returns the repository URL for the given release or null if the release is not managed by a repository.
     * 
    ...
    /**
     * Returns the repository URL for the given entity or null if the entity's library is not managed by a repository.
     * 
     * @param entity the entity for which to return a repository URL
     * @return String
     */
    public String getEntityViewDetailsUrl(NamedEntity entity) {
        AbstractLibrary lib =
            ((entity == null) || (entity instanceof TLActionFacet)) ? null : entity.getOwningLibrary();
        String url = null;
    ...
    /**
     * Returns the repository item for the given library or null if the library is not managed by a repository.
     * 
    ...
    /**
     * Returns the repository item for the given release or null if the release is not managed by a repository.
     * 
