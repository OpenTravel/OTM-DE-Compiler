...
public class ModelCompareOptions {
    ...
    /**
     * Returns the flag indicating whether field-level version changes will be supressed from the generation diff
     * reports. During major version upgrades, this can have a large effect on reducing the "noise" due to nothing but
     * version updates at the field level.
     *
     * @return boolean
     */
    ...
    /**
     * Assigns the flag indicating whether field-level version changes will be supressed from the generation diff
     * reports. During major version upgrades, this can have a large effect on reducing the "noise" due to nothing but
     * version updates at the field level.
     *
    ...
    /**
     * Returns the flag indicating whether library-level NS/Prefix/Version/Status changes will be supressed from the
     * generation diff reports. During major version upgrades, this can have a large effect on reducing the "noise" due
     * to nothing but version updates at the field level.
     *
     * @return boolean
     */
    ...
    /**
     * Assigns the flag indicating whether library-level NS/Prefix/Version/Status changes will be supressed from the
     * generation diff reports. During major version upgrades, this can have a large effect on reducing the "noise" due
     * to nothing but version updates at the field level.
     *
     * @param suppressLibraryPropertyChanges the flag value to assign
     */
    public void setSuppressLibraryPropertyChanges(boolean suppressLibraryPropertyChanges) {
        this.suppressLibraryPropertyChanges = suppressLibraryPropertyChanges;
    }

    /**
     * Returns the flag indicating whether library/Entity/Field-level documentation changes will be supressed from the
     * generation diff reports. During major version upgrades, this can have a large effect on reducing the "noise" due
     * to nothing but version updates at the field level.
     *
     * @return boolean
    ...
    /**
     * Assigns the flag indicating whether library/Entity/Field-level documentation changes will be supressed from the
     * generation diff reports. During major version upgrades, this can have a large effect on reducing the "noise" due
     * to nothing but version updates at the field level.
     *
     * @param suppressDocumentationChanges the flag value to assign
     */
    public void setSuppressDocumentationChanges(boolean suppressDocumentationChanges) {
        this.suppressDocumentationChanges = suppressDocumentationChanges;
    }
    ...
    public void loadOptions(Properties props) {
        String suppressFieldVersionChangesStr =
            props.getProperty( "suppressFieldVersionChanges", defaultOptions.isSuppressFieldVersionChanges() + "" );
        String suppressLibraryPropertyChangesStr = props.getProperty( "suppressLibraryPropertyChanges",
            defaultOptions.isSuppressLibraryPropertyChanges() + "" );
        String suppressDocumentationChangesStr =
            props.getProperty( "suppressDocumentationChanges", defaultOptions.isSuppressDocumentationChanges() + "" );
