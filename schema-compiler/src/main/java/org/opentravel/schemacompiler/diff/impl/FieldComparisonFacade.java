...
/**
 * Facade used to compare the contents of two fields even though the two fields
 * may be defined as different OTM member field types (attribute, element, or
 * indicator).
 */
public class FieldComparisonFacade {
	...
	/**
	 * If the given owner is an instance of <code>TLFacet</code>, this method
	 * will return its identity name.  Otherwise, null will be returned.
	 * 
