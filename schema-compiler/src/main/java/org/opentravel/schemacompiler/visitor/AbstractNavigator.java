...
/**
 * Base navigator class that provides common methods for navigation and duplicate node
 * avoidance during the traversal process.
 * 
...
public abstract class AbstractNavigator<T> {
	...
	/**
	 * Navigates the entity and its children, invoking the applicable visitor method each time
	 * an entity of the structure is encountered.
	 * 
	 ...
	 * 
	 * <p>NOTE: A side effect of this method is that the node being checked is automatically marked
	 * as visited.  Hence, a direct call to 'addVisitedNode()' is redundant unless the objective is
	 * to skip visitation of the node altogether.
	 * 
