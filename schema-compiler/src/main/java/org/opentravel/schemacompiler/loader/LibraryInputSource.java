...
public interface LibraryInputSource<C> {
	...
	/**
	 * Resolves the library module namespace provided and returns an input stream that can be
	 * used to load the module's XML content.  If the content of the module is not accessible,
	 * this method will return null.
	 * 
	 * @param libraryContentURL  the resource locator that can be used to obtain the module's content
	 * @return C
	 */
