...
/**
 * Loader that handles the loading and/or parsing of content from a single library module's input source.
 * 
...
public interface LibraryModuleLoader<C> {
    ...
    /**
     * Returns true if the given input source is for a <code>Library</code> element. If the input source is directed at
     * a <code>Schema</code> resource, false will be returned.
     * 
    ...
    /**
     * Loads the content of a single library module from the input source provided. If the library cannot be loaded from
     * the specified URL, a validation finding will be added to the collection provided, and this method will return
     * null.
     * 
    ...
    /**
     * Loads the content of a single XML schema from the input source provided. If the schema cannot be loaded from the
     * specified URL, a validation finding will be added to the collection provided, and this method will return null.
     * 
     * @param inputSource the input source from which to load module's content
     * @param validationFindings the validation errors/warnings discovered during the loading process
