...
public class LibrarySchema1_3_ModuleLoader extends AbstractLibraryModuleLoader {
     ...
     */
    public synchronized LibraryModuleInfo<Object> loadLibrary(
            LibraryInputSource<InputStream> inputSource, ValidationFindings validationFindings)
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new JAXBException("The library file does not contain OTM v1.3 content.",
                            cce);
                }
            }
