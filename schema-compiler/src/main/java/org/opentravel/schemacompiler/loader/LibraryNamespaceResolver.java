...
/**
 * Resolves library module references by returning the library resource URL(s) associated with the library modules'
 * namespace. Because multiple libraries can be associated with a single namespace, the 'resolveLibraryNamespace()'
 * returns a collection of URL's.
 * 
 * @author S. Livezey
 */
public interface LibraryNamespaceResolver {
    ...
    /**
     * Resolves the library import using the namespace URI and/or file hints provided, returning a collection of URLs
     * that can be used to obtain the content of each library module.
     * 
    ...
    /**
     * Resolves the given library using the namespace URI and/or file hints provided, returning a URL that can be used
     * to obtain the library module's content.
     * 
     * @param libraryNamespace the library module namespace to resolve
    ...
    /**
     * Assigns the URL location of the library with the given repository file URI. This is included as an optimization
     * to prevent repeated downloads of file content during the namespace resolution phase of a load.
     * 
     * @param repositoryUri the URI of the repository item
     * @param namespace the namespace of the repository item to be resolved
