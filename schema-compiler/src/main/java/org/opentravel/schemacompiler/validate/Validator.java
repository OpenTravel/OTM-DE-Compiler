...
public interface Validator<T extends Validatable> {
    ...
    /**
     * Assigns the context that can provide relevant information or resources that extend beyond the object being
     * validated.
     * 
    ...
    /**
     * Performs all necessary validation checks and returns any findings that were discovered. If no findings were
     * reported, null is a valid return value from this method.
     * 
