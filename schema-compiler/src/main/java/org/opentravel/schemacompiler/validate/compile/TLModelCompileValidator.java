...
/**
 * Static utility methods used for the validation of <code>TLModel</code> elements prior to compilation / code
 * generation.
 * 
 * @author S. Livezey
 */
public class TLModelCompileValidator {
    ...
    /**
     * Utility method that validates all elements of the given model using the default rule set for library compilation.
     * 
    ...
    /**
     * Utility method that validates the given model element using the specified rule set from the application context
     * file. If the object has not yet been assigned to a model, some validation tasks may not function properly.
     * 
     * <p>
     * NOTE: This method performs validation checks for the given model element, as well as all of its dependencies. For
     * EXAMPLE, in a model where <code>Payment</code> contains an element reference to <code>PaymentCard</code>, a call
     * to validate <code>Payment</code> may result in findings for <code>PaymentCard</code> since it is a dependency of
     ...
     * 
     * @param modelElement the model element to validate
     * @param validateDependencies flag indicating whether dependencies of the given model element should also be
    ...
    /**
     * Visitor that performs validation checks for the assigned model element and all of its dependencies to determine
     * whether any errors exist prior to producing EXAMPLE output.
     * 
     * @author S. Livezey
     */
