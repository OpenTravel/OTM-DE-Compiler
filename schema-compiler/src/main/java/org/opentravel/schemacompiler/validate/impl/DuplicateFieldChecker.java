...
/**
 * Checks a facet or VWA for any attributes, elements, or indicators with duplicate
 * names.  Note that these checks DO NOT include elements that are members of a substitution
 * group since those items will be validated by the <code>UPAViolationChecker</code>.
 * 
 * @author S. Livezey
 */
public class DuplicateFieldChecker {
	...
	/**
	 * Returns true if the name of the given attribute is a duplicate within its owning
	 * facet or VWA.
	 * 
	...
	/**
	 * Returns true if the name of the given indicator is a duplicate within its owning
	 * facet or VWA.
	 * 
