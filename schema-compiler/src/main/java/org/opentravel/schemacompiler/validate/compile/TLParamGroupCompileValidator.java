...
public class TLParamGroupCompileValidator extends TLParamGroupBaseValidator {
    ...
    protected ValidationFindings validateFields(TLParamGroup target) {
        ...
        builder.setProperty( "name", target.getOwner().getParamGroups() ).setFindingType( FindingType.ERROR )
    ...
    /**
     * Returns true if the given facet reference is declared or inherited by the business object provided.
     * 
    ...
    /**
     * Returns the next-higher facet owner extension from the one provided. If the given owner does not have an
     * extension, this method will return null.
     * 
