...
/**
 * Static utility methods used for the validation of <code>TLModel</code> elements prior to library save operations.
 * 
 * @author S. Livezey
 */
public class TLModelSaveValidator {
     ...
     */
    private TLModelSaveValidator() {}

    /**
     * Utility method that validates all elements of the given model using the default rule set for library saves.
     * 
