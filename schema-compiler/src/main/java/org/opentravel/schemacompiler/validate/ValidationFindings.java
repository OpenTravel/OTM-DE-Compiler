...
/**
 * Encapsulates the findings (errors and warnings) discovered during validation. NOTE: This implementation is not
 * currently thread-safe.
 * 
 * <p>
 * NOTE: By default, the error/warning messages displayed by the compiler are obtained from the
 * 'compiler-messages.properties' resource bundle. If an alternative set of messages is needed (including support for
 * non-english messages), the defaults can be overridden by updating the compiler's application context file.
 * 
 * @author S. Livezey
 */
public class ValidationFindings {
    ...
    /**
     * Returns true if one or more findings of the indicated type have been added to this collection.
     * 
     * @param type the type of finding to check for
     * @return boolean
     */
    ...
    /**
     * Returns true if one or more findings of the indicated type have been added for the given source object.
     * 
     * @param source the source object to check
     * @param type the type of finding to check for
     * @return boolean
     ...
     * 
     * @param type the type of finding for which to return a count
     * @return int
     */
    ...
    /**
     * Returns the number findings of the indicated type in this collection for the given source object.
     * 
     * @param source the source object to check
     * @param type the type of finding to check for
     * @return int
    ...
    /**
     * Adds a copy of the given finding to this collection. If a duplicate message key has already been added for the
     * source object (regardless of its type), the new finding will be ignored.
     * 
     * @param finding the validation finding to add
     */
    public void addFinding(ValidationFinding finding) {
        if (finding != null) {
            addFinding( finding.getType(), finding.getSource(), finding.getMessageKey(), finding.getMessageParams() );
        }
    }

    /**
     * Adds a new finding of the specified type to this collection. If a duplicate message key has already been added
     * for the source object (regardless of its type), the new finding will be ignored.
     * 
     ...
     */
    public void addFinding(FindingType type, Validatable source, String messageKey, Object... messageParams) {
        if (type == null) {
     ...
     * 
     * @param findings the collection of findings to add (may be null)
     */
    ...
    /**
     * Returns the individual validation findings associated with the specified source object in a list.
     * 
     * @param source the source object to filter on
     * @return List&lt;ValidationFinding&gt;
     */
    ...
    /**
     * Returns the individual validation findings associated with the indicated <code>FindingType</code> in a list.
     * 
     * @param type the type of finding to filter on
     * @return List&lt;ValidationFinding&gt;
     */
    ...
    /**
     * Returns the individual validation findings the indicated <code>FindingType</code> for the specified source object
     * in a list.
     * 
     * @param source the source object to filter on
     * @param type the type of finding to filter on
     ...
     * 
     * <p>
     * If a different message format is desired, the compiler's message resource bundle can override the default format
     * by defining the following keys:
     * <ul>
     * <li><code>ValidationFindings.IdentityMessageFormat</code>: Overrides the "identified" message format.</li>
     * <li><code>ValidationFindings.BareMessageFormat</code>: Overrides the "bare" message format.</li>
     * <li><code>ValidationFindings.MessageOnlyFormat</code>: Overrides the "message-only" message format.</li>
     * </ul>
     * 
     ...
     * <p>
     * See the
     * {@link org.opentravel.schemacompiler.validate.ValidationFindings#getAllValidationMessages(FindingMessageFormat)}
    ...
    /**
     * Returns human-readable validation messages of the indicated <code>FindingType</code> for the specified source
     * object.
     * 
     * <p>
     * See the
     ...
     * @return String[]
     */
    public String[] getValidationMessages(Validatable source, FindingType type, FindingMessageFormat format) {
        List<String> messageList = new ArrayList<>();
