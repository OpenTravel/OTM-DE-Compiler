 ...
 * 
 * <p>NOTE: By default, the error/warning messages displayed by the compiler are obtained from
 * the 'compiler-messages.properties' resource bundle.  If an alternative set of messages is needed
...
public class ValidationFindings implements Serializable {
	...
	/**
	 * Returns true if one or more findings have been added for the given source
	 * object.
	 * 
	...
	/**
	 * Returns true if one or more findings of the indicated type have been added for the
	 * given source object.
	 * 
	 * @param source  the source object to check
	 * @param type  the type of finding to check for
	...
	/**
	 * Returns the number findings of the indicated type in this collection for the
	 * given source object.
	 * 
	 * @param source  the source object to check
	 * @param type  the type of finding to check for
	...
	/**
	 * Adds a copy of the given finding to this collection.  If a duplicate message key has
	 * already been added for the source object (regardless of its type), the new finding
	 * will be ignored.
	 * 
	...
	/**
	 * Adds a new finding of the specified type to this collection.  If a duplicate message key
	 * has already been added for the source object (regardless of its type), the new finding
	 * will be ignored.
	 * 
	...
	public void addFinding(FindingType type, Validatable source, String messageKey, Object... messageParams) {
		...
		if ((messageKey == null) || (messageKey.length() == 0)) {
			throw new NullPointerException("The message key for validation findings cannot be a null or empty string.");
		}
	...
	/**
	 * Returns the individual validation findings associated with the indicated <code>FindingType</code>
	 * in a list.
	 * 
	...
	/**
	 * Returns the individual validation findings the indicated <code>FindingType</code>
	 * for the specified source object in a list.
	 * 
	 * @param source  the source object to filter on
	 * @param type  the type of finding to filter on
	 * @return List<ValidationFinding>
	 ...
	 * 
	 * <p>If a different message format is desired, the compiler's message resource bundle can override
	 ...
	 * 
	 * See the {@link org.opentravel.schemacompiler.validate.ValidationFindings#getAllValidationmessages(ResourceBundle, boolean)}
	 ...
	 * 
	 * @param type  the type of finding to filter on
	 * @param bundle  the resource bundle used to obtain user-readable messages
	 * @param format  the message format to use when rendering text for this finding
	 * @return String[]
	 */
	...
	/**
	 * Returns human-readable validation messages of the indicated <code>FindingType</code>
