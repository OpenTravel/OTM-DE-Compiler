...
public class TLContextualFacetCompileValidator extends TLContextualFacetBaseValidator {
	...
	/**
	 * Returns the list of all facets of the same type from the owner of the given facet.  The
	 * list that is returned may contain the target facet that is passed to this method.
	 * 
	 * @param target  the contextual facet being validated
