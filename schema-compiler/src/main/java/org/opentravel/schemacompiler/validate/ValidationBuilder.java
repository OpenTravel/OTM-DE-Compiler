...
/**
 * Builder used to perform the most basic validation tasks. Sub-classes may extend this builder to incorporate
 * additional validation functions. When new methods are added, it is recommended that the builder pattern is followed
 * to ensure easy usage and code readability within the <code>Validator</code> classes.
 * 
 * @author S. Livezey
 */
public abstract class ValidationBuilder<T extends ValidationBuilder<T>> {
    ...
    /**
     * Constructor that assigns a pefix that will be pre-pended to each finding message key generated by this builder.
     * 
     * @param messagePrefix the prefix string to append
     */
    ...
    /**
     * Abstract class that returns the generic reference to this object. This approach allows the parent builder class
     * to cast its return types to that of the child class, thus keeping the builder pattern intact.
     * 
     * @return T
     */
    ...
    /**
     * Assigns the target object instance to be validated. When a new target object is assigned, the current property
     * name and value for this builder is cleared.
     * 
    ...
    /**
     * Specifies the type of finding(s) to add when an assertion fails. The default type of finding is
     * <code>ERROR</code>.
     * 
     * @param findingType the finding type to assign
     * @return T
     */
    ...
    /**
     * Specifies the number of decimal digits to examine during floating-point numeric comparisons and assertions. The
     * default comparison unit is two decimal digits.
     * 
     * @param significantDigitsForDecimalComparisons the number of significant digits to assign
     */
    public void setSignificantDigitsForDecimalComparisons(int significantDigitsForDecimalComparisons) {
        if (significantDigitsForDecimalComparisons < 0) {
            throw new IllegalArgumentException( "The number of significant digits cannot be less than zero." );
        }
        multiplierForDecimalComparisons = Math.pow( 10, significantDigitsForDecimalComparisons );
    }

    /**
     * Specifies the significant unit of time to use during date/time comparisons. Valid values for this method include:
     * <ul>
     ...
     * 
     * @param calendarUnitsForDateComparisons the unit of calendar time to assign
     */
    ...
    /**
     * Returns the validation findings that have been constructed from the checks performed since this
     * <code>ValidationBuilder</code> was initialized. If no findings have been discovered, this method will return a
     * null value.
     * 
    ...
    /**
     * Allows validators to manually add findings that were discovered during validation checks performed outside of
     * this builder's organic validation methods.
     * 
     * @param findingType the type of finding to add
     * @param propertyName the name of the property to which the finding applies
     * @param code the finding code to use when constructing the message key
     * @param messageParams the error message parameters
     * @return T
     */
    public T addFinding(FindingType findingType, String propertyName, String code, Object... messageParams) {
     ...
     * 
     * @param findings the validation findings to add
     * @return T
     */
    ...
    /**
     * Adds a validation finding if the current property (trimmed) string value is neither null nor blank.
     * 
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a string
     */
     ...
     * 
     * @param limit the comparison limit for the value
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a numeric value
     */
    ...
    /**
     * Adds a validation finding if the current property is not greater than or equal to the specified limit.
     * 
     * @param limit the comparison limit for the value
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a numeric value
    ...
    /**
     * Adds a validation finding if the current property is not less than or equal to the specified limit.
     * 
     * @param limit the comparison limit for the value
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a numeric value
     ...
     * Adds a validation finding if the current property is not equal to the specified limit.
     * 
     * @param obj the comparison object for the value
     * @return T
     */
    ...
    /**
     * Adds a validation finding if the string value contains fewer characters than the specified minimum length.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
    ...
    /**
     * Adds a validation finding if the string value does not contain the exact number of characters specified.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
     * @param exactLength the expected exact length of the string
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a string
     */
    ...
    /**
     * Adds a validation finding if the string values does not match the regular expression provided.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
    ...
    /**
     * Adds a validation finding if the collection value contains fewer elements than the specified minimum size.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
     ...
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a collection
     */
    ...
    /**
     * Adds a validation finding if the collection value contains more elements than the specified maximum size.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
    ...
    /**
     * Adds a validation finding if the collection value does not contain the exact number of elements specified.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
     * @param exactSize the expected exact length of the collection
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a collection
     */
    ...
    /**
     * Adds a validation finding if the collection property value contains one or more elements that share the same name
     * as that of the current target object. Duplicity is determined by comparing the identity names of each member
     * element as determined by the identity resolver instance provided.
     * 
     * <p>
     * NOTE: The collection property value is expected to contain a copy of the current target value, so there is no
     * need to exclude it from the collection that assigned as the current property value.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
     * @param identityResolver used to identify the identity names for members of the current collection value
     * @param <E> the type of entity to check for duplicates
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a collection
     */
    ...
    public <E> T assertNoDuplicates(IdentityResolver<E> identityResolver) {
        try {
            ...
            throw new IllegalArgumentException( "Unexpected exception during duplicate element validation.", e );
        }
        return getThis();
    }
     ...
     * @param limit the comparison limit for the value
     * @return T
     * @throws IllegalArgumentException thrown if the current property value is not a date value
     */
    ...
    /**
     * Adds a validation finding if the date value occurs on or before the date limit value provided.
     * 
     * <p>
     * Null values checked by this method <i>will not</i> produce an error.
     * 
    ...
    protected String propertyValueAsString() {
        if ((propertyValue == null) || (propertyValue instanceof String)) {
            ...
            throw new IllegalArgumentException( "The requested assertion only applies to string values." );
        }
    }
    ...
    protected long propertyValueAsLong() {
        ...
        if (propertyValue == null) {
            ...
            throw new IllegalArgumentException( "The requested assertion only applies to numeric values." );
        }
        return theValue;
    }
    ...
    protected <E> Collection<E> propertyValueAsCollection() {
        if ((propertyValue == null) || (propertyValue instanceof Collection)) {
            ...
            throw new IllegalArgumentException( "The requested assertion only applies to collection values." );
        }
    }
    ...
    protected Date propertyValueAsDate() {
        if ((propertyValue == null) || (propertyValue instanceof Date)) {
            ...
            throw new IllegalArgumentException( "The requested assertion only applies to date values." );
        }
    }
    ...
    /**
     * Rounds the given double value to the nearest significant decimal place. The unit of measure assigned by the
     * {@link #setSignificantDigitsForDecimalComparisons(int)} is used to determine the significant timeframe for the
     * comparison.
     * 
     * @param aDouble the floating-point value to round
     * @return double
     */
    protected double roundDouble(double aDouble) {
        return ((double) Math.round( aDouble * multiplierForDecimalComparisons )) / multiplierForDecimalComparisons;
    }

    /**
     * Rounds dates to the nearest indicated significant unit for comparison purposes. The unit of measure assigned by
     * the {@link #setCalendarUnitsForDateComparisons(int)} is used to determine the significant timeframe for the
     * comparison.
     * 
     * @param aDate the date value to round
     * @return java.util.Date
     */
    ...
    /**
     * Returns a <code>Pattern</code> using the regular expression provided. Patterns are cached to improve performance.
     * 
