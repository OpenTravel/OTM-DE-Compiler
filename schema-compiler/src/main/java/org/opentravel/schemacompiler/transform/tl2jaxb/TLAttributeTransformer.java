...
/**
 * Handles the transformation of objects from the <code>TLAttribute</code> type to the <code>Attribute</code> type.
 * 
 * @author S. Livezey
 */
public class TLAttributeTransformer extends BaseTransformer<TLAttribute,Attribute,SymbolResolverTransformerContext> {
    ...
    public Attribute transform(TLAttribute source) {
        ...
        if (source.getType() != null) {
            attribute.setType( context.getSymbolResolver().buildEntityName( attributeType.getNamespace(),
