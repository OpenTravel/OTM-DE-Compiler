...
/**
 * Static utility methods to construct symbol tables using either JAXB libraries or 'TLModel'
 * instances.
 * 
 * @author S. Livezey
 */
public class SymbolTableFactory {
     ...
     * 
     * @param populators
     *            the collection of symbol table populators
     */
     ...
     * 
     * @param sourceEntity
     *            the source entity for which to create a symbol table
     * @return SymbolTable
     */
    ...
    public <T> void appendToSymbolTable(T sourceEntity, SymbolTable symbols) {
        if (sourceEntity != null) {
            SymbolTablePopulator<T> populator = (SymbolTablePopulator<T>) populatorMap
                    .get(sourceEntity.getClass());
    ...
    /**
     * Attempts to resolve the local name of the source object. If the name cannot be resolved, null
     * will be returned.
     * 
     * @param sourceObject
     ...
     * 
     * @param model
     *            the model for which to contstruct a symbol table
     * @return SymbolTable
     */
