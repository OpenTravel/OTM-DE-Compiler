...
/**
 * Visitor that attempts to resolve contextual facet owner references discovered in a model after new libraries are
 * loaded.
 */
class ContextualFacetResolutionVisitor extends ModelElementVisitorAdapter {
    ...
    /**
     * Visits and resolves the contextual facets owners within the given model. This is necessary as a first-pass during
     * model resolution since the qualified name of the contextual facets is composed of the owner name. Therefore, it
     * is necessary to resolve the facet owners and rebuid the symbol table prior to resolving other entity references.
     * 
    ...
    /**
     * Attempts to resolve the given facet's owner reference. If the reference was resolved successfully, this method
     * will return true.
     * 
