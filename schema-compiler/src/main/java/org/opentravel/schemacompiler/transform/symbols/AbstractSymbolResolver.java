...
public abstract class AbstractSymbolResolver implements SymbolResolver {
     ...
     * 
     * @param namespace
     *            the namespace of the operation entity
     * @param localName
     *            the local name of the operation entity (independent of namespace)
     * @return Object
     */
     ...
     * @param symbols
     *            the symbol table from which to resolve the anonymous entity
     * @return Object
     */
    ...
    /**
     * @see org.opentravel.schemacompiler.transform.SymbolResolver#buildEntityName(java.lang.String,
     *      java.lang.String)
     */
    @Override
    public String buildEntityName(String namespace, String localName) {
        ...
        if (localName != null) {
            String prefix = (prefixResolver == null) ? null : prefixResolver
