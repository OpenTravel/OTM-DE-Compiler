...
/**
 * Handles the transformation of objects from the <code>TLBusinessObject</code> type to the <code>BusinessObject</code>
 * type.
 * 
 * @author S. Livezey
 */
public class TLBusinessObjectTransformer extends TLComplexTypeTransformer<TLBusinessObject,BusinessObject> {
    ...
    public BusinessObject transform(TLBusinessObject source) {
        ...
        ObjectTransformer<TLContextualFacet,FacetContextual,
            SymbolResolverTransformerContext> facetContextualTransformer =
