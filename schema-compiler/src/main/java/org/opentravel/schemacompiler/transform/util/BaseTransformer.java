 ...
 * @author S. Livezey
 */
public abstract class BaseTransformer<S, T, C extends ObjectTransformerContext> implements
    ...
    /**
     * Trims each string value in the list provided and returns a list of the updated values. Any
     * empty or null strings from the given list are omitted from the resulting one.
     * 
     * @param strList
    ...
    /**
     * Concatenates a list of strings into a single string. The original string values are separated
     * by new-line characters.
     * 
     * @param strList
     *            the list of string values to concatenate
     * @return String
     */
    ...
    /**
     * In situations where a 'patchLevel' non-null/non-zero value is defined for a library, the
     * patch level will be incorporated into the namespace URI. If the patch level value is null or
     * zero, this method will return the original namespace.
     * 
     * @param namespace
     *            the namespace URI to adjust
     * @param patchLevel
     *            the patch level of the library version identifier
     * @param versionScheme
     *            the version scheme identifier to use for the namespace modification
     * @return String
     */
    protected String getAdjustedNamespaceURI(String namespace, String patchLevel,
