...
public class LibraryTransformer extends BaseTransformer<Library,TLLibrary,DefaultTransformerContext> {
	 ...
	 * 
	 * @param library  the library instance to process
	 */
	...
	private class ContextVisitor extends ModelElementVisitorAdapter {
		...
		/**
		 * Adds the given context ID to the set of contexts that have been collected during navingation.
		 * 
		 * @param contextId  the context ID to add
		 */
