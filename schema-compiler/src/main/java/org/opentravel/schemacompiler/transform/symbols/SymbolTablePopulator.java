...
/**
 * Interface to be implemented by components that are cabable of creating named entries in
 * a <code>SymbolTable</code>.
 * 
...
public interface SymbolTablePopulator<S> {
	...
	/**
	 * Adds new symbols to the given symbol table using information and/or sub-components from
	 * the source entity provided.
	 * 
	 ...
	 * by this populator instance, null will be returned.
	 * 
