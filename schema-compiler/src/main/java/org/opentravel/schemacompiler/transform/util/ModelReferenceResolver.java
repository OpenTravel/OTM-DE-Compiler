...
public final class ModelReferenceResolver {
    ...
    /**
     * Attempts to resolve any references to the obsolete built-in library that is now managed
     * in the OpenTravel repository.  If any missing references are detected, the managed library
     * is loaded and references are resolved from the managed built-in.
     * 
     * @param model
     */
    ...
    /**
     * Overrides the type of the <code>ObsoleteBuiltInVisitor</code> class to use during
     * reference resolution processing.
     * 
     * @param obsoleteBuiltInVisitorType  the visitor type to use during resolution processing
     */
    public static void setObsoleteBuiltInVisitorType(Class<? extends ObsoleteBuiltInVisitor> obsoleteBuiltInVisitorType) {
