...
/**
 * Simple simple table implementation that associates named entities within a namespace and the objects that are
 * referenced by those names.
 * 
 * <p>
 * NOTE: For OTM models, symbol names for service operations are considered a special case since they are not eligible
 * for type assignments as model attributes or properties. For this reason, operation objects are maintained in a
 * separate "symbol space" from the other symbols maintained in the table.
 * 
 * @author S. Livezey
 */
public final class SymbolTable {
     ...
     * 
     * @param namespace the namespace of the entity to retrieve
     * @param localName the local name of the entity to retrieve (independent of namespace)
     * @return Object
     */
    ...
    /**
     * Returns the operation entity with the specified name or null if such an entity has not been defined.
     * 
     * @param namespace the namespace of the operation entity to retrieve
     * @param localName the local name of the operation entity to retrieve (independent of namespace)
     * @return Object
     */
    public Object getOperationEntity(String namespace, String localName) {
        return getEntity( namespace,
            ((localName == null) ? OPERATION_SYMBOL_PREFIX : OPERATION_SYMBOL_PREFIX + localName.trim()) );
    }

    /**
     * Returns the namespace assigned to the given entity or null if a namespace has not been assigned.
     * 
     * @param entity the entity for which to retrieve the namespace assignment
     * @return String
     */
    ...
    /**
     * Returns the local names associated with the specified namespace in this symbol table. If the namespace is not
     * recognized, an empty collection will be returned.
     * 
     * @param namespace the namespace for which to return local names
     * @return Collection&lt;String&gt;
     */
    ...
    /**
     * Adds an entry for the given entity to this symbol table. If an entity with the specified name has already been
     * defined, the name association will be replaced with the given entity.
     * 
     * @param namespace the namespace of the entity to add
     * @param localName the local name of the entity to add (independent of namespace)
    ...
    /**
     * Adds an operation entry for the given entity to this symbol table. If an entity with the specified name has
     * already been defined, the name association will be replaced with the given entity.
     * 
     * @param namespace the namespace of the operation entity to add
     * @param localName the local name of the operation entity to add (independent of namespace)
     * @param entity the operation entity to add
     */
     ...
     * 
     * @param factory the derived entity factory to register
     */
