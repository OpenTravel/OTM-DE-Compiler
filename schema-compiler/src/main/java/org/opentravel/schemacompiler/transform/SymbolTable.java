...
/**
 * Simple simple table implementation that associates named entities within a namespace
 * and the objects that are referenced by those names.
 * 
 * <p>NOTE: For OTM models, symbol names for service operations are considered a special case
 * since they are not eligible for type assignments as model attributes or properties.  For this
 * reason, operation objects are maintained in a separate "symbol space" from the other symbols
...
public final class SymbolTable {
	...
	/**
	 * Returns the entity with the specified name or null if such an entity has not been
	 * defined.
	 * 
	...
	/**
	 * Returns the operation entity with the specified name or null if such an entity has not
	 * been defined.
	 * 
	...
	public Object getOperationEntity(String namespace, String localName) {
		return getEntity( namespace, ((localName == null) ? OPERATION_SYMBOL_PREFIX : OPERATION_SYMBOL_PREFIX + localName.trim()) );
	}
	
	/**
	 * Returns the namespace assigned to the given entity or null if a namespace has not
	 * been assigned.
	 * 
	...
	/**
	 * Returns the local names associated with the specified namespace in this symbol table.  If
	 * the namespace is not recognized, an empty collection will be returned.
	 * 
	...
	/**
	 * Adds an entry for the given entity to this symbol table.  If an entity with the specified
	 * name has already been defined, the name association will be replaced with the given entity.
	 * 
	...
	public void addOperationEntity(String namespace, String localName, Object entity) {
		String opLocalName = ((localName == null) ? OPERATION_SYMBOL_PREFIX : OPERATION_SYMBOL_PREFIX + localName.trim());
