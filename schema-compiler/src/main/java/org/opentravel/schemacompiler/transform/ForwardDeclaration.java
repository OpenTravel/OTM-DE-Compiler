...
public final class ForwardDeclaration {
	 ...
	 * 
	 * @param namespace  the namespace of the forward-declared entity to be resolved
	 * @param localName  the local name of the forward-declared entity to be resolved
	 */
	 ...
	 * 
	 * @param symbolTable  the symbol table to use for entity resolution
	 * @return Object
	 */
