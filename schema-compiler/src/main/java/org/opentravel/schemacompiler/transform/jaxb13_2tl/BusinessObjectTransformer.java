 ...
 * @author S. Livezey
 */
public class BusinessObjectTransformer extends
        ComplexTypeTransformer<BusinessObject, TLBusinessObject> {
     ...
     *            the business object that will receive the aliases
     * @param facet
     *            the model facet that corresponds to the JAXB facet where the alias names
     *            originated
     * @param aliasNames
     *            the list of facet alias names to migrate
     */
    private void buildFacetAliases(TLBusinessObject businessObject, TLFacet facet,
            List<String> aliasNames) {
        String facetSuffix = facet.getFacetType().getIdentityName(facet.getContext(),
                facet.getLabel());
