...
public interface RepositoryItem {
    ...
    /**
     * Returns a reference to the repository that owns this item. If this item's state is <code>UNMANAGED</code>, this
    ...
    /**
     * Returns the base namespace (without the version component of the URI path) that is assigned to the library
     * instance that is represented by this item.
     * 
     * @return String
     */
    ...
    /**
     * Returns the filename of the library that is represented by this item without any absolute or relative path
     * information.
     * 
     * @return String
     */
    ...
    /**
     * Returns a URI for this repository item. By default, the item's namespace is not encoded with the URI that is
     * returned.
     * 
     * @return URI
     */
    ...
    /**
     * Returns a URI for this repository item. If the 'fullyQualified' flag is true, the item's namespace will encoded
