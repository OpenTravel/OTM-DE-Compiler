...
/**
 * Interface that defines the interaction model between a local OTA2.0 project and a single repository instance.
 * 
 * @author S. Livezey
 */
public interface Repository {
     ...
     * 
     * <p>
     * NOTE: The resulting list of strings do not contain full namespace URI paths. Instead, only the path names of the
    ...
    /**
     * Returns a list of all namespaces for the libraries stored and managed in the remote repository. Each of the
     * namespaces that are returned include the trailing version component of the URI path.
     * 
     * @return List&lt;String&gt;
     * @throws RepositoryException thrown if the remote repository cannot be accessed
     */
    ...
    /**
     * Returns a list of each <code>RepositoryItem</code> assigned to the specified base namespace. If multiple versions
     * of a <code>RepositoryItem</code> are present, only the latest version will be returned when the
     * 'latestVersionsOnly' flag is true. If the 'includeDraftVersions' flag is false, only <code>FINAL</code> versions
     * will be considered durng the search.
     * 
     ...
     * Returns a list of each <code>RepositoryItem</code> assigned to the specified base namespace. If multiple versions
     * of a <code>RepositoryItem</code> are present, only the latest version will be returned when the
     * 'latestVersionsOnly' flag is true. If the 'includeStatus' is non-null, only versions with the specified status or
     * later will be considered durng the search.
     * 
     * <p>
     * NOTE: Only repository items of type <code>LIBRARY</code> will be returned by this method. To filter on or include
     * other types of repository items, use the
    ...
    /**
     * Returns a list of each <code>RepositoryItem</code> of the specified type assigned to the specified base
     * namespace. If multiple versions of a <code>RepositoryItem</code> are present, only the latest version will be
     * returned when the 'latestVersionsOnly' flag is true. If the 'includeStatus' is non-null, only versions with the
     * specified status or later will be considered durng the search. If the 'itemType' parameter is null, all item
     * types matching the other criteria will be returned.
     * 
     * @param baseNamespace the base namespace that does not include the trailing version component of the URI path
     * @param includeStatus indicates the latest library status to include in the results (null = all statuses)
     * @param latestVersionsOnly flag indicating whether the results should include all matching versions or just the
     *        latest version of each library
     * @param itemType the type of repository item to include in the resulting list
     * @return List&lt;RepositoryItem&gt;
     * @throws RepositoryException thrown if the remote repository cannot be accessed
     */
    public List<RepositoryItem> listItems(String baseNamespace, TLLibraryStatus includeStatus,
    ...
    /**
     * Searches the contents of the repository using the free-text keywords provided. If multiple versions of a
     * <code>RepositoryItem</code> match the query, only the latest version will be returned when the
     * 'latestVersionsOnly' flag is true. If the 'includeDraftVersions' flag is false, only <code>FINAL</code> versions
     * will be considered durng the search.
     * 
     ...
     * @param latestVersionsOnly flag indicating whether the results should include all matching versions or just the
     *        latest version of each library
     * @param includeDraftVersions flag indicating whether versions in <code>DRAFT</code> status should be considered by
     *        the search
     * @return List&lt;RepositoryItem&gt;
     * @throws RepositoryException thrown if the remote repository cannot be accessed
     ...
     * 
     * @param item the repository item for which to retrieve the version history
     * @return List&lt;RepositoryItem&gt;
     * @throws RepositoryException thrown if the remote repository cannot be accessed
     */
    ...
    /**
     * Returns the meta-data record for the repository item with the specified namespace, filename, and version.
     * 
     * @param baseNamespace the base namespace of the repository item
     * @param filename the filename of the repository item
     * @param versionIdentifier the version identifier of the repository item
     * @return RepositoryItem
     * @throws RepositoryException thrown if the meta-data record does not exist or cannot be retrieved
     */
    public RepositoryItem getRepositoryItem(String baseNamespace, String filename, String versionIdentifier)
        throws RepositoryException;

    /**
     * Returns the meta-data record for a repository item using the URI provided. This method requires that the URI
     * contains the encoded namespace value for the repository item (normally optional per the OTM repository URI
     * specification).
     * 
     * @param itemUri the fully-qualified URI of the repository item (encoded namespace value is required)
     * @return RepositoryItem
     * @throws RepositoryException thrown if the meta-data record does not exist or cannot be retrieved
     * @throws URISyntaxException thrown if the given URI is not a valid OTM repository URI (including the namespace)
     */
    public RepositoryItem getRepositoryItem(String itemUri) throws RepositoryException, URISyntaxException;

    /**
     * Returns the meta-data record for a repository item using the URI and namespace provided. If the item URI
     * specifies a namespace value (optional per the OTM repository URI specification), that namespace will be ignored
     * in favor of the 'itemNamespace' value provided.
     * 
     * <p>
     ...
     * 
     * <ul>
     * <li><u>repository-id</u> - the ID of the repository to which the item is published (required)</li>
     * <li><u>item-namespace</u> - the repository-managed namespace to which the item is assigned (optional); since this
     * component is a URI, this value must be URL encoded to include it within the repository URI path</li>
     * <li><u>otm-filename</u> - the filename assigned to the item in the OTM repository</li>
     * <li><u>version-scheme-id</u> - the version scheme assigned to the item; if the default value of "OTA2" is
     * assigned, this component of the URI path is optional</li>
     * </ul>
     * 
     * @param itemUri the fully-qualified URI of the repository item (encoded namespace value is required)
     * @param itemNamespace the assigned namespace of the OTM repository item
     * @return RepositoryItem
     * @throws RepositoryException thrown if the meta-data record does not exist or cannot be retrieved
     * @throws URISyntaxException thrown if the given URI is not a valid OTM repository URI
     */
    ...
    /**
     * Returns a <code>LibraryInputSource</code> that can be used to download a historical commit for the given
     * repository item. The content that is returned will be the latest commit that is on or before the effective date
     * specified. If the effective date provided is null, the latest commit for the item will be returned.
     * 
     ...
     * @throws RepositoryException thrown if the remote repository cannot be accessed or the effective date is prior to
     *         the item's first commit
     */
    ...
    /**
     * Returns the list of repository items that are locked by the current user of this repository. If access to this
     * repository is based on anonymous credentials, this method will always return an empty list.
     * 
     * <p>
     * If this repository is the local <code>RepositoryManager</code>, this method will only return locked items from
     * the user's local repository. Use the <code>RemoteRepository</code> handles to retrieve locked items from remote
     * repositories.
     * 
     * @return List&lt;RepositoryItem&gt;
     ...
     * 
     * @param rootNamespace the base namespace to be created
     * @throws RepositoryException thrown if the repository cannot be accessed or the namespace is is nested under an
     *         existing root namespace
     */
     ...
     * @throws RepositoryException thrown if the repository cannot be accessed or the root namespace cannot be deleted
     */
     ...
     * @throws RepositoryException thrown if the repository cannot be accessed or the namespace is not the child of an
     *         existing root namespace
     */
     ...
     * @throws RepositoryException thrown if the repository cannot be accessed or the namespace cannot be deleted
     */
    public void deleteNamespace(String baseNamespace) throws RepositoryException;

    /**
     * Publishes a file for the first time to this repository. Once published, this repository will be considered as the
     * owner and manager of the file's content.
     * 
     * @param unmanagedContent input stream for the unmanaged content to publish
     * @param filename the filename of the unmanaged content to publish
     * @param libraryName the name of the unmanaged library to publish
     * @param namespace the full namespace (including version-specific path information) with which the file content is
     *        to be associated
     * @param versionIdentifier the version identifier of the repository item
     * @param versionScheme the version scheme of the item to be published (may be null)
     * @param initialStatus the initial status of the item in the repository
     * @return RepositoryItem
     * @throws RepositoryException thrown if the publication of the file fails
     */
     ...
     * data obtained from the input stream for the work-in-process content.
     * 
    ...
    /**
     * Unlocks the specified repository item using the credentials for its owning repository. If the 'commitWIP'
     * parameter is true, the work-in-process conent of the will be committed to the remote repository before the
     * existing lock is released. If the flag is false, any changes in the item's WIP content will be discarded.
     * 
     * @param item the repository item to lock
     * @param commitWip flag indicating that the current WIP content changes should be committed prior to releasing the
     *        lock
    ...
    /**
     * Promotes a <code>RepositoryItem</code> from its current lifecycle status to the next available one.
     * 
     * @param item the repository item to promote
    ...
    /**
     * Demotes a <code>RepositoryItem</code> from its current lifecycle status to the previous one. This operation can
     * only be performed if the local user has administrative permissions to modify the requested item.
     * 
     * @param item the repository item to demote
     * @throws RepositoryException thrown if an error occurs while accessing the remote repository
     */
     ...
     * must have administrative permissions to modify the requested item.
     * 
    ...
    /**
     * Recalculates the CRC of a <code>RepositoryItem</code> that is in a non-<code>DRAFT</code> status.
     * 
     * @param item the repository item whose CRC is to be recalculated
     * @throws RepositoryException thrown if an error occurs while accessing the remote repository
     */
    public void recalculateCrc(RepositoryItem item) throws RepositoryException;

    /**
     * Deletes a <code>RepositoryItem</code> from the repository. This operation can only be performed if the local user
     * has administrative permissions to modify the requested item.
     * 
     * @param item the repository item to delete
     * @throws RepositoryException thrown if an error occurs while accessing the remote repository
     */
