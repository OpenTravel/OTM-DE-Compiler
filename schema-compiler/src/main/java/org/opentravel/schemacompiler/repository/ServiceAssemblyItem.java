 ...
 * 
 * <p>Assembly items consist of a <code>RepositoryItem</code> for the
 * corresponding OTM release, plus the qualified name of an OTM resource
 * that is the primary API.  If a resource name is not supplied, all
 * resources contained within the corresponding release will be included
 * in the model.
 */
