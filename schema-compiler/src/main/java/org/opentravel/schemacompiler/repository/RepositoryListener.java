...
/**
 * Interface to be implemented by any component wishing to be notified of local events
 * performed by a <code>RepositoryManager</code> instance.  The methods of this interface
 * will only be invoked if the corresponding repository action was successful. 
 */
public interface RepositoryListener {
    ...
    /**
     * Called when a repository item has been promoted from its current lifecycle status to the next
     * available one.
     * 
