...
/**
 * Specifies a single library member of an OTM release. All release members are required to be managed in an OTM
 * repository. In addition to specifying the library itself, each release member can specify an effective date based on
 * the library's commit history in the repository.
 */
