...
public class ReleaseCompileOptions implements CompileAllTaskOptions {
    ...
    public ReleaseCompileOptions(Map<String,String> p) {
        ...
        if ((bindingStyle == null) || !CompilerExtensionRegistry.getAvailableExtensionIds().contains( bindingStyle )) {
    ...
    /**
     * Parses the given boolean string or returns false if the given string is null or not a boolean value.
     * 
    ...
    /**
     * Parses the given integer value or returns null if the given string does not represent a valid integer.
     * 
