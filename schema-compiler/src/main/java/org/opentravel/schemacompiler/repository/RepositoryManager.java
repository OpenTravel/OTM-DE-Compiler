...
public class RepositoryManager implements Repository {
     ...
     * 
     * <p>
     * NOTE: The remote repository must be available for this method to function properly. If the repository's web
     ...
     * can be accessed by the local user.
     * 
     ...
     * @param latestVersionsOnly flag indicating whether the list only contains the latest version of each library
     ...
     * of the local repository, this method will return null.
     * 
     ...
     * lock is released. If the stream parameter is null, any changes in the item's WIP content will be discarded.
     * 
     ...
     * update is performed regardless of the update policy for the repository that owns and manages the item.
     * 
     * <p>
    ...
    public void saveLocalRepositoryMetadata() throws RepositoryException {
        ...
        try {
            ...
            for (RemoteRepositoryClient remoteRepository : remoteRepositories) {
                ...
                jaxbRepository.setPassword( ENCRYPTED_PREFIX + remoteRepository.getEncryptedPassword() );
     ...
     */
    private void commitOrRollback(boolean success, ListenerNotification notification) throws RepositoryException {
