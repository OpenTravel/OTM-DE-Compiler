...
/**
 * Search result from a remote repository that encapsulates an OTM entity that
...
public class EntitySearchResult extends RepositorySearchResult {
	...
	/**
	 * Returns the named entity associated with this search result item from the given
	 * model.  If no matching entity exists in the model provided, this method will
	 * return null.
	 * 
