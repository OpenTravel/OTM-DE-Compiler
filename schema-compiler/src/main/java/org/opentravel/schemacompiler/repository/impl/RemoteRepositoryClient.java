...
public class RemoteRepositoryClient implements RemoteRepository {
    ...
    private static final String NAMESPACE_CHILDREN_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/namespace-children";
    ...
    private static final String CREATE_ROOT_NAMESPACE_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/create-root-namespace";
    private static final String DELETE_ROOT_NAMESPACE_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/delete-root-namespace";
    ...
    private static final String USER_AUTHORIZATION_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/user-authorization";
    ...
    private static final String ENTITY_WHERE_USED_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/entity-where-used";
    private static final String ENTITY_WHERE_EXTENDED_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/entity-where-extended";
    private static final String HISTORICAL_CONTENT_ENDPOINT = RemoteRepositoryUtils.SERVICE_CONTEXT + "/historical-content";
    ...
    public List<RepositoryItem> listItems(String baseNamespace, TLLibraryStatus includeStatus,
        ...
        try {
            ...
            HttpPost request = newPostRequest( LIST_ITEMS2_ENDPOINT,
                    paramList.toArray( new HttpGetParam[paramList.size()] ) );
            Marshaller marshaller = RepositoryFileManager.getSharedJaxbContext().createMarshaller();
    ...
    public List<RepositorySearchResult> search(String freeTextQuery, TLLibraryStatus includeStatus,
        ...
        try {
            ...
            HttpGet request = newGetRequest( SEARCH2_ENDPOINT,
                    paramList.toArray( new HttpGetParam[paramList.size()] ) );
            HttpResponse response = remoteUtils.executeWithAuthentication( request );
            Unmarshaller unmarshaller = RepositoryFileManager.getSharedJaxbContext().createUnmarshaller();
    ...
    public boolean downloadContent(String baseNamespace, String filename, String versionIdentifier, boolean forceUpdate)
        ...
        try {
            ...
            localLastUpdated = new Date( 0L ); // make sure the local date is earlier than anything we will get from the
                                               // repository
        }
