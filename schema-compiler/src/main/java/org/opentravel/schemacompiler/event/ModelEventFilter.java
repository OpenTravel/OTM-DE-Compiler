...
/**
 * Base class for event filters that can limit the number and/or type of messages that are forwarded to an underlying
 * listener.
 * 
 ...
 * @author S. Livezey
 */
public abstract class ModelEventFilter<E extends ModelEvent<S>, S> implements ModelEventListener<E,S> {
    ...
    /**
     * Returns true if the event is considered allowable by this filter and should be forwarded to the underlying
     * listener.
     * 
