...
public class TLDocumentation extends TLModelElement implements LibraryElement {
    ...
    private DocumentationItemListManager deprecationManager = new DocumentationItemListManager( this,
        ModelEventType.DOC_DEPRECATION_ADDED, ModelEventType.DOC_DEPRECATION_REMOVED );
    ...
    private DocumentationItemListManager implementerManager = new DocumentationItemListManager( this,
        ModelEventType.DOC_IMPLEMENTER_ADDED, ModelEventType.DOC_IMPLEMENTER_REMOVED );
    ...
    private AdditionalDocumentationItemListManager otherDocManager = new AdditionalDocumentationItemListManager( this,
        ModelEventType.DOC_OTHER_DOCS_ADDED, ModelEventType.DOC_OTHER_DOCS_REMOVED );
    ...
    public boolean isEmpty() {
        return ((description == null) || (description.length() == 0)) && deprecationManager.getChildren().isEmpty()
            && referenceManager.getChildren().isEmpty() && implementerManager.getChildren().isEmpty()
            && moreInfoManager.getChildren().isEmpty() && otherDocManager.getChildren().isEmpty();
    }
    ...
    /**
     * Adjusts the encoding of the given string to remove any platform-dependent line feed characters from its content.
     * 
     * @param str the string whose encoding is to be adjusted
     * @return String
     */
     ...
     * 
     * @param deprecation the deprecation string value to add
     */
     ...
     * Adds a deprecation to the current list.
     * 
     * @param index the index at which the given documentation item should be added
     * @param deprecation the deprecation string value to add
     ...
     * 
     * @param deprecation the deprecation string value to remove
     */
    ...
    /**
     * Moves this deprecation up by one position in the list. If the deprecation is not owned by this object or it is
     * already at the front of the list, this method has no effect.
     * 
     * @param deprecation the deprecation to move
     */
    ...
    /**
     * Moves this deprecation down by one position in the list. If the deprecation is not owned by this object or it is
     ...
     * 
     * @param reference the string value to add
     */
     ...
     * 
     * @param reference the string value to remove
     */
    ...
    /**
     * Moves this reference up by one position in the list. If the reference is not owned by this object or it is
     * already at the front of the list, this method has no effect.
     * 
     * @param reference the reference to move
     */
    ...
    /**
     * Moves this reference down by one position in the list. If the reference is not owned by this object or it is
     * already at the end of the list, this method has no effect.
     * 
     * @param reference the reference to move
     */
     ...
     * 
     * @param implementer the implementer to add
     */
     ...
     * 
     * @param implementer the implementer to remove
     */
    ...
    /**
     * Moves this implementer up by one position in the list. If the implementer is not owned by this object or it is
     * already at the front of the list, this method has no effect.
     * 
     * @param implementer the implementer to move
     */
    ...
    /**
     * Moves this implementer down by one position in the list. If the implementer is not owned by this object or it is
     * already at the end of the list, this method has no effect.
     * 
     * @param implementer the implementer to move
     */
     ...
     * 
     * @param moreInfo the string value to add
     */
     ...
     * 
     * @param moreInfo the string value to remove
     */
    ...
    /**
     * Moves this more-info up by one position in the list. If the more-info is not owned by this object or it is
     * already at the front of the list, this method has no effect.
     * 
     * @param moreInfo the more-info to move
     */
    ...
    /**
     * Moves this more-info down by one position in the list. If the more-info is not owned by this object or it is
     * already at the end of the list, this method has no effect.
     * 
     * @param moreInfo the more-info to move
     */
     ...
     * 
     * @param contextId the context ID of the other-doc item to return
     ...
     * 
     * @param otherDoc the string value to add
     */
     ...
     * 
     * @param otherDoc the string value to remove
     */
    ...
    /**
     * Moves this other-doc up by one position in the list. If the other-doc is not owned by this object or it is
     * already at the front of the list, this method has no effect.
     * 
     * @param otherDoc the other-doc to move
     */
    ...
    /**
     * Moves this other-doc down by one position in the list. If the other-doc is not owned by this object or it is
     * already at the end of the list, this method has no effect.
     * 
     * @param otherDoc the other-doc to move
     */
