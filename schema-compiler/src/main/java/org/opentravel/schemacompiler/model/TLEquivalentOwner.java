...
public interface TLEquivalentOwner extends LibraryElement {
     ...
     * 
     * @param context
     *            the context of the equivalent to return
     * @return TLEquivalent
     */
     ...
     * 
     * @param index
     *            the index at which the given equivalent should be added
     * @param equivalent
     *            the equivalent value to add
     ...
     * 
     * @param equivalent
     *            the equivalent value to remove
     */
     ...
     * 
     * @param equivalent
     *            the equivalent to move
     */
    public void moveUp(TLEquivalent equivalent);

    /**
     * Moves this equivalent down by one position in the list. If the equivalent is not owned by
