...
/**
 * Base class that encapsulates the ownership of a list of child entities, including the supporting methods used to
 * manipulate the list of children. This class is intended to be utilized as an internal component of the model and
 * should not be called or referenced beyond that scope.
 * 
...
abstract class ChildEntityListManager<C, O> {
    ...
    /**
     * Constructor that specifies the owner of the unerlying list, as well as the types of ownership events that will be
     * published when a child entity is added or removed.
     * 
    ...
    /**
     * Called when the given child entity (assumed to be managed by this list) has been renamed.
     * 
    ...
    public void removeChild(C child) {
        if (children.contains( child )) {
            ...
            publishEvent( owner,
                new ModelEventBuilder( removeEventType, owner ).setAffectedItem( child ).buildEvent() );
    ...
    /**
     * Removes all children from the current list. Events will be emitted for each child that is removed.
     */
    ...
    /**
     * Moves this child up by one position in the list. If the child is not owned by this object or it is already at the
    ...
    /**
     * Moves this child down by one position in the list. If the child is not owned by this object or it is already at
