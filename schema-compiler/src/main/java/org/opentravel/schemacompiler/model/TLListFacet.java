...
/**
 * Facet that provides a named entity reference for a list whose type is determined by the existence of another
 * <code>TLFacet</code> entity.
 * 
 * <p>
 * NOTE: The aliases of a <code>TLListFacet</code> are not intended to be manipulated by external components or
 * services. Instead, they are synchronized with the aliases of the facet from which the facet list is derived. Any
 * direct manipulation is likely to result in synchronization problems between the two lists.
 * 
 * @author S. Livezey
 */
public class TLListFacet extends TLAbstractFacet implements TLAttributeType, TLAliasOwner {
    ...
    /**
     * List manager that synchronizes the list of derived aliases with those of the corresponding 'itemFacet'.
     * 
     * @author S. Livezey
     */
