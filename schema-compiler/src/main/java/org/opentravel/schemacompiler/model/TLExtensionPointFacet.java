 ...
 * @author S. Livezey
 */
public class TLExtensionPointFacet extends LibraryMember implements LibraryElement,
    ...
    /**
     * Returns the version identifier of the library that owns this extension point facet.
     * 
     * @return String
     */
