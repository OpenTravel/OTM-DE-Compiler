 ...
 * @author S. Livezey
 */
public class TLOperation extends TLModelElement implements NamedEntity, Versioned,
		TLFacetOwner, TLExtensionOwner, TLDocumentationOwner, TLEquivalentOwner {
	...
	/**
	 * Moves this operation up by one position in the list of operations maintained by its
	 * owner.  If the owner is null, or this operation is already at the front of the list, this
	...
	/**
	 * Moves this operation down by one position in the list of operations maintained by its
	 * owner.  If the owner is null, or this operation is already at the end of the list, this
	 * method has no effect.
	 */
