...
public class TLBusinessObject extends TLComplexTypeBase implements TLFacetOwner, TLAliasOwner {
	...
	private ContextualFacetListManager customFacetManager = new ContextualFacetListManager( this, TLFacetType.CUSTOM,
			ModelEventType.CUSTOM_FACET_ADDED, ModelEventType.CUSTOM_FACET_REMOVED );
	private ContextualFacetListManager queryFacetManager = new ContextualFacetListManager( this, TLFacetType.QUERY,
			ModelEventType.QUERY_FACET_ADDED, ModelEventType.QUERY_FACET_REMOVED );
	private ContextualFacetListManager updateFacetManager = new ContextualFacetListManager( this, TLFacetType.UPDATE,
			ModelEventType.UPDATE_FACET_ADDED, ModelEventType.UPDATE_FACET_REMOVED );
	...
	/**
	 * Removes the given contextual facet from this library and adds it to the new
	 * owning library provided.
	 * 
	 ...
	 * 
	 * @param idFacet the field value to assign
	 */
	...
	/**
	 * In cases where multiple custom facets of the same name are defined for a business object, this method provides a
	 * means of retrieving based on the name and owning library of the facet.
	 * 
	 * <p>
	 * NOTE: Under normal circumstances, this situation only arises after a new library version has been created which
	 * contains non-local contextual facets.
	 * 
	...
	/**
	 * Moves this custom facet up by one position in the list. If the custom facet is not owned by this object or it is
	...
	/**
	 * Moves this custom facet down by one position in the list. If the custom facet is not owned by this object or it
	...
	/**
	 * In cases where multiple query facets of the same name are defined for a business object, this method provides a
	 * means of retrieving based on the name and owning library of the facet.
	 * 
	 * <p>
	 * NOTE: Under normal circumstances, this situation only arises after a new library version has been created which
	...
	/**
	 * Moves this query facet up by one position in the list. If the query facet is not owned by this object or it is
	 * already at the front of the list, this method has no effect.
	 * 
	...
	/**
	 * Moves this query facet down by one position in the list. If the query facet is not owned by this object or it is
	...
	/**
	 * In cases where multiple update facets of the same name are defined for a business object, this method provides a
	 * means of retrieving based on the name and owning library of the facet.
	 * 
	 * <p>
	 * NOTE: Under normal circumstances, this situation only arises after a new library version has been created which
	...
	/**
	 * Moves this update facet up by one position in the list. If the update facet is not owned by this object or it is
	 * already at the front of the list, this method has no effect.
	 * 
	...
	/**
	 * Moves this update facet down by one position in the list. If the update facet is not owned by this object or it
	 * is already at the end of the list, this method has no effect.
	 * 
