...
public enum TLLibraryStatus {
    ...
    /**
     * Indicates that the contents of a library is under review and pending finalization, and may be modified only by
     * certain repository users.
     */
    ...
    /**
     * Returns the <code>TLLibraryStatus</code> that corresponds to the given repository status value.
     * 
    ...
    /**
     * Returns the next available status in the lifecycle. The OBSOLETE status will return null since it is the last
     * stage in the status lifecycle.
     * 
     * @return TLLibraryStatus
     */
    ...
    /**
     * Returns the previous status in the lifecycle. The DRAFT status will return null since it is the first stage in
