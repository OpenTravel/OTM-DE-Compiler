...
public class TLEnumValue extends TLModelElement implements TLDocumentationOwner, TLEquivalentOwner {
	...
	/**
	 * Moves this value up by one position in the list of values maintained by its
	 * owner.  If the owner is null, or this value is already at the front of the list, this
	...
	/**
	 * Moves this value down by one position in the list of values maintained by its
	 * owner.  If the owner is null, or this value is already at the end of the list, this
	 * method has no effect.
	 */
