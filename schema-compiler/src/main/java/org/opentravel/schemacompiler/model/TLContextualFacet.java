...
/**
 * Contextual facet definition for complex types that may or may not reside within the same library (or namespace) as
 * their facet owners.
 */
public class TLContextualFacet extends TLFacet implements LibraryMember, TLFacetOwner {

    private ContextualFacetListManager childFacetManager = new ContextualFacetListManager( this, null,
        ModelEventType.CHILD_FACET_ADDED, ModelEventType.CHILD_FACET_REMOVED );
    ...
    /**
     * Returns true if this facet's owner resides within the same library to which this facet is assigned.
     * 
     * @return boolean
     */
    ...
    /**
     * Recursive method that calculates the local name of a facet while avoiding infinite loops caused by circular
     * references.
     * 
     ...
     * 
     * <p>
     * NOTE: This field is intended for internal use by the OTM compiler and should not be used by external
     * applications. Normally, the namespace of a contextual facet is provided by its owning library; this field is only
     * used when the contextual facet is stored as a standalone XML document in the OTM repository search index.
     * 
     * @return String
     */
    ...
    /**
     * In cases where multiple child facets of the same name are defined for a contextual facet, this method provides a
     * means of retrieving based on the name and owning library of the child facet.
     * 
     * <p>
    ...
    protected static class ContextualFacetListManager extends ChildEntityListManager<TLContextualFacet,TLFacetOwner> {
         ...
         * @param childFacetType the type of the child facets being managed
         ...
         */
        public ContextualFacetListManager(TLFacetOwner owner, TLFacetType childFacetType, ModelEventType addEventType,
