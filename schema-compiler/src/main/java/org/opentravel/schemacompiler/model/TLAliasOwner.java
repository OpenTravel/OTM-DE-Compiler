...
/**
 * Interface to be implemented by all model components that can be represented by alternate
...
public interface TLAliasOwner extends NamedEntity {
	...
	/**
	 * Moves this alias up by one position in the list.  If the alias is not owned by this
	...
	/**
	 * Moves this alias down by one position in the list.  If the alias is not owned by this
