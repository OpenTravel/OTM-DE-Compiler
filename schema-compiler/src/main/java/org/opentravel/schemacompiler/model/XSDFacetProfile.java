...
public enum XSDFacetProfile {
	...
	FP_FloatingPoint(false, false, false, true, true, true, false, false, true, true, true, true),
	FP_Integer(false, false, false, true, true, true, true, true, true, true, true, true),
	...
	private static final Set<String> stringTypes = new HashSet<String>( Arrays.asList(new String[] {
			"string", "hexBinary", "base64Binary", "anyURI", "QName", "NOTATION", "normalizedString",
			"token", "language", "NMTOKEN", "NMTOKENS", "Name", "NCName", "ID", "IDREF", "IDREFS",
			"ENTITY", "ENTITIES"
		}) );;
	private static final Set<String> booleanTypes = new HashSet<String>( Arrays.asList(new String[] {
			"boolean"
		}) );;
	private static final Set<String> decimalTypes = new HashSet<String>( Arrays.asList(new String[] {
			"decimal"
		}) );;
	private static final Set<String> floatingPointTypes = new HashSet<String>( Arrays.asList(new String[] {
			"float", "double"
		}) );;
	...
	private static final Set<String> dateTimeTypes = new HashSet<String>( Arrays.asList(new String[] {
			"dateTime", "date", "time", "duration", "gYear", "gYearMonth", "gMonthDay", "gMonth", "gDay"
		}) );;
	...
	private XSDFacetProfile(boolean length, boolean minLength, boolean maxLength, boolean pattern,
			boolean enumeration, boolean whiteSpace, boolean totalDigits, boolean fractionDigits, boolean minInclusive,
			boolean maxInclusive, boolean minExclusive, boolean maxExclusive) {
