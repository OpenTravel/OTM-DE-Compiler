...
/**
 * Model element that specifies the request and response for a <code>TLResource</code> operation.
 * 
 * @author S. Livezey
 */
public class TLAction extends TLModelElement implements LibraryElement, TLDocumentationOwner {
    ...
    /**
     * Moves this response up by one position in the list. If the response is not owned by this object or it is already
     * at the front of the list, this method has no effect.
     * 
    ...
    /**
     * Moves this response down by one position in the list. If the response is not owned by this object or it is
     ...
     * @author S. Livezey
     */
    protected static class ActionListManager extends ChildEntityListManager<TLAction,TLResource> {
