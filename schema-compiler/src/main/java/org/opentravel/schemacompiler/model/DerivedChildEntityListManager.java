...
public abstract class DerivedChildEntityListManager<E, D> {
    ...
    /**
     * Constructor that specifies the <code>ChildEntityListManager</code> that will be used to manage the list of
     * derived entities.
     * 
    ...
    /**
     * Returns the name of a derived entity whose existence is derived from the original entity whose name is specified
     * in the string parameter passed to this method.
     * 
    ...
    /**
     * When the name of a child entity is updated that is under the control of this manager, this method will ensure
     * that all derived entities are kept in-sync with the original entity's name.
     * 
    ...
    /**
     * Moves the derived child entity that corresponds to the original one provided up one position in the list of
     * derived children.
     * 
    ...
    /**
     * Moves the derived child entity that corresponds to the original one provided down one position in the list of
     * derived children.
     * 
     * @param originalChild the original child entity that was moved
     */
    ...
    /**
     * Sorts the list of derived children in the same order as the corresponding list of original child entities
     * provided.
     * 
     * @param originalEntityList the list of original child entities from which the order of the derived entities is to
     *        be derived
     */
    ...
    /**
     * Comparator used to sort the list of derived entities in the same order as their corresponding position(s) in the
     * list of original entities.
     * 
     * @author S. Livezey
     */
    private class DerivedEntityComparator implements Comparator<D> {
        ...
        /**
         * Constructor used to initialize the comparator with the relative positions of the original entities in the
         * list provided.
         * 
        ...
        public int compare(D entity1, D entity2) {
            Integer entity1Position =
                derivedEntityPositions.containsKey( entity1 ) ? derivedEntityPositions.get( entity1 ) : -1;
            Integer entity2Position =
                derivedEntityPositions.containsKey( entity2 ) ? derivedEntityPositions.get( entity2 ) : -1;
