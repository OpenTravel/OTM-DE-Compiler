...
public class BuiltInLibrary extends AbstractLibrary {
    ...
    public BuiltInLibrary(QName qualifiedName, URL libraryUrl, List<LibraryMember> members) {
        this( qualifiedName, libraryUrl, members, null,
     ...
     * @param libraryUrl the URL of the library
     * @param members the member types of the library
     * @param importList the list of imports for the library
     * @param schemaDeclaration the schema declaration from which the library was loaded
    ...
    /**
     * @see org.opentravel.schemacompiler.model.AbstractLibrary#sortIncludes(java.util.Comparator)
     */
    @Override
