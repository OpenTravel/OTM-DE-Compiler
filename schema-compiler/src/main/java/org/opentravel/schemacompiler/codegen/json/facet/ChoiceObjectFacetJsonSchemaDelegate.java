 ...
 */
public abstract class ChoiceObjectFacetJsonSchemaDelegate extends TLFacetJsonSchemaDelegate {
     ...
     */
    public ChoiceObjectFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
