...
/**
 * Performs the translation from <code>TLActionResponse</code> objects to the JAXB nodes used to
 * produce the schema output.
 */
public class TLActionResponseJsonCodegenTransformer extends TLBaseActionJsonCodegenTransformer<TLActionResponse> {
	
	/**
	 * @see org.opentravel.schemacompiler.transform.ObjectTransformer#transform(java.lang.Object)
	 */
	@Override
	public JsonSchemaNamedReference transform(TLActionResponse source) {
