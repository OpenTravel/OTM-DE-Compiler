 ...
 */
public class ChoiceObjectChoiceFacetJsonSchemaDelegate extends ChoiceObjectFacetJsonSchemaDelegate {
     ...
     */
    public ChoiceObjectChoiceFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
