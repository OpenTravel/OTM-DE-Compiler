...
/**
 * Collection of generated artifacts that can be segregated by object type and correlated according to the OTM entity
...
public class CorrelatedCodegenArtifacts {
    ...
    /**
     * Adds all of the given artifacts and associates them with the given named entity.
     * 
    ...
    /**
     * Adds all of the given correlated artifacts to this collection. The entities in the given collection will be
     * assumed to have been added after all of the entities in this collection.
     * 
    ...
    /**
     * Returns the list of named entities for which artifacts were added to this collection. Entities are returned in
    ...
    /**
     * Returns the collection of artifacts that were associated with the given named entity.
     * 
    ...
    public CodegenArtifacts getArtifacts(NamedEntity entity) {
        return entityArtifactMap.containsKey( entity ) ? entityArtifactMap.get( entity ) : new CodegenArtifacts();
    }

    /**
     * Returns a consolidated list of all artifacts that have been correlated in the order of the enities with which
     * they are associated.
     * 
     * @return CodegenArtifacts
     */
