 ...
 */
public class BusinessObjectSummaryFacetJsonSchemaDelegate extends BusinessObjectFacetJsonSchemaDelegate {
     ...
     */
    public BusinessObjectSummaryFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
