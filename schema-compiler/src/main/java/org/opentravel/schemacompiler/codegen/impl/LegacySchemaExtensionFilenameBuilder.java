...
/**
 * Filename builder used to generate filenames for legacy schema extension files produced during the code generation
 * process.
 * 
...
public class LegacySchemaExtensionFilenameBuilder<T> implements CodeGenerationFilenameBuilder<T> {
    ...
    /**
     * Constructor that specifies the builder to use when generating the base filename from which the extension schema's
