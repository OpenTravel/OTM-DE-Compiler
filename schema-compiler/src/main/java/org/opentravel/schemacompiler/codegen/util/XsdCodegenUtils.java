...
public class XsdCodegenUtils {
	...
	public static QName getSubstitutionGroupElementName(NamedEntity modelEntity) {
		...
		boolean isTopLevelFacetOwner = (nonAliasEntity instanceof TLBusinessObject)
				|| (nonAliasEntity instanceof TLCoreObject) || (nonAliasEntity instanceof TLChoiceObject)
	 ...
	 * @param preferredTypeName  the preferred name for the type that should be returned if another one cannot be identified
	 * @return String
	 */
