...
/**
 * Interface for components that can add additional message components and binding information to
 * a WSDL document during code generation.
 * 
 * @author S. Livezey
 */
public interface CodeGenerationWsdlBindings {
	 ...
	 * list typically contains the faults and message headers that are included in the WSDL definition.
	 * 
	...
	/**
	 * Returns the list of dependent schemas that should be added to the list of imports and prefix mappings
	 * for XML schemas and WSDL documents.
	 * 
	 * @return Collection<SchemaDeclaration>
	 */
	...
	/**
	 * Creates a binding element for the WSDL document using information from the port-type
	 * element provided.  If no binding is required for the WSDL document, this method may return
	 * null.
	 * 
	...
	/**
	 * Creates a service element for the WSDL document based on information from the binding
	 * element provided.  If no service endpoint definition is required for the WSDL document,
	...
	/**
	 * Adds any XML attributes and/or element that are required by the base payload type of
	 * the OTM facet.
	 * 
