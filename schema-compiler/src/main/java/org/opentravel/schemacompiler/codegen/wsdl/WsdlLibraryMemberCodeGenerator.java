...
/**
 * Code generator implementation used to generate WSDL documents from <code>TLService</code>
 * meta-model components.
 * 
 * <p>
 * The following context variable(s) are required when invoking this code generation module:
 * <ul>
 * <li><code>schemacompiler.OutputFolder</code> - the folder where generated WSDL files should be
 * stored</li>
 * </ul>
 * 
 * @author S. Livezey
