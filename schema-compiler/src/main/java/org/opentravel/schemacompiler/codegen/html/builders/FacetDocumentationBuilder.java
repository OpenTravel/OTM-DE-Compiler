 ...
 *
 */
public class FacetDocumentationBuilder extends AttributeOwnerDocumentationBuilder<TLFacet>
    implements AliasOwnerDocumentationBuilder {
    ...
    /**
     * @param t the facet for which to create a builder
     */
    public FacetDocumentationBuilder(TLFacet t) {
        ...
        if (superFacet != null && superFacet.declaresContent()) {
            superType = DocumentationBuilderFactory.getInstance().getDocumentationBuilder( superFacet );
        }
