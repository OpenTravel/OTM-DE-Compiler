...
public class TLServiceCodegenTransformer extends AbstractWsdlTransformer<TLService, JAXBElement<?>> {
    ...
    public JAXBElement<?> transform(TLService source) {
        ...
        addBindingAndService(definitions, portType,
                operationArtifacts.getArtifactsOfType(TMessage.class), context.getCodegenContext());
     ...
     */
    private class ProjectLibraryMemberTrimmedFilenameBuilder implements
            CodeGenerationFilenameBuilder<LibraryMember> {
