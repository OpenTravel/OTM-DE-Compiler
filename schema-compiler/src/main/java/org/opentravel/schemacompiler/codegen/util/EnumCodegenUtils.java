...
/**
 * Static utility methods used during the generation of code output for open and closed enumerations.
 * 
 * @author S. Livezey
 */
public class EnumCodegenUtils {
    ...
    /**
     * Returns the list of declared and inherited enumeration values for the given entity.
     * 
    ...
    /**
     * Returns the list of inherited enumeration values for the given entity. If the 'includeDeclaredValues' is true,
     * all valid enumeration values will be returned (declared and inherited). If false, only those values inherited
     * from parent enum(s) will be returned.
     * 
     * @param enumEntity the enumeration entity for which to return values
    ...
    /**
     * Returns the hierarchy of enumeration extensions starting from the root entity and ending with the one passed to
     * this method.
     * 
    ...
    /**
     * Returns the enumeration entity that is extended by the given one, or null if the given entity does not extend
     * another.
     * 
