 ...
 */
public class CoreObjectDetailFacetJsonSchemaDelegate extends CoreObjectFacetJsonSchemaDelegate {
     ...
     */
    public CoreObjectDetailFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
