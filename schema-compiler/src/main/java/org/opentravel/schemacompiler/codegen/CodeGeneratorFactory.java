...
/**
 * Factory used to instantiate <code>CodeGenerator</code> instances used to generate output for a
...
public final class CodeGeneratorFactory {
     ...
     * 
     * @param factoryName
     *            the bean name of the code generation factory in the application context
     * @return CodeGeneratorFactory
     */
     ...
     *             thrown if the requested target format is not supported
     * @throws CodeGenerationException
     *             thrown if an instance of the code generator cannot be created
     */
    ...
    public <S> CodeGenerator<S> newCodeGenerator(String targetFormat, Class<S> sourceType)
        ...
        if (targetFormat == null) {
            ...
            if ((targetFormat.length() == 0) || hasWhitespace) {
                throw new IllegalArgumentException("The requeste target format is not valid: '"
                        + targetFormat + "'");
            }
        }
        ...
        if (mapping != null) {
            Class<? extends CodeGenerator<S>> codegenClass = (Class<? extends CodeGenerator<S>>) mapping
                    .getCodeGenerator();
    ...
    /**
     * Assings the source-type/target-format mappings for all code generators supported by this
     * factory instance.
     * 
     * @param mappings
     *            the code generation mappings to assign
     */
     ...
     *            the code generation factories whose mappings are to be included in this instance
     */
