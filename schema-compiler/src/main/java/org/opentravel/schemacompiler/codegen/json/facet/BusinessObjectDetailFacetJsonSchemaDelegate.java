 ...
 */
public class BusinessObjectDetailFacetJsonSchemaDelegate extends BusinessObjectFacetJsonSchemaDelegate {
     ...
     */
    public BusinessObjectDetailFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
