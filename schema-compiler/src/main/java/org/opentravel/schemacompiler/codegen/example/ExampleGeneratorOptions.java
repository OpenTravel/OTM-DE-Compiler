...
public class ExampleGeneratorOptions {
	...
	public static enum DetailLevel { MINIMUM, MAXIMUM };
	 ...
	 *
	 * @param exampleContext  the exampleContext value to assign
	 */
	...
	/**
	 * Returns the maximum number of times that an element should be recursively visited
	...
	/**
	 * Assigns the maximum number of times that an element should be recursively visited
	 * within a nested object structure.
	 *
