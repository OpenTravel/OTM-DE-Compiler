...
/**
 * Enumeration that specifies the type of a Swagger security scheme. The types that are defined for this enumeration are
 * the only values allowed by the Swagger specification.
 */
public enum SwaggerSecurityType {

    BASIC("basic"), API_KEY("apiKey"), OAUTH2("oauth2");
