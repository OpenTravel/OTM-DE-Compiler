 ...
 *
 */
public class NamedEntityWriter<T extends NamedEntityDocumentationBuilder<?>> extends SubWriterHolderWriter
    implements LibraryMemberWriter {
    ...
    /**
     * @param member the class being documented.
     ...
     */
    public NamedEntityWriter(T member, DocumentationBuilder prev, DocumentationBuilder next) throws IOException {
        super( Configuration.getInstance(), DirectoryManager.getDirectoryPath( member.getOwningLibrary() ),
            member.getName() + ".html", DirectoryManager.getRelativePath( member.getOwningLibrary() ) );
        this.member = member;
    ...
    protected Content getNavLinkLibrary() {
        Content linkContent = getHyperLink( LibraryWriter.OUTPUT_FILE_NAME, member.getOwningLibrary(), libraryLabel );
    ...
    public Content getNavLinkPrevious() {
        Content li;
        if (prev != null) {
            Content prevLink = new RawHtml( getLink( new LinkInfoImpl( LinkInfoImpl.CONTEXT_CLASS, prev, "",
    ...
    public Content getNavLinkNext() {
        Content li;
        if (next != null) {
            Content nextLink = new RawHtml( getLink( new LinkInfoImpl( LinkInfoImpl.CONTEXT_CLASS, next, "",
     ...
     * (non-Javadoc)
     * 
     * @see org.opentravel.schemacompiler.codegen.html.writers.LibraryMemberWriter #getHeader()
     */
    @Override
    public Content getHeader() {
        String namespace = (member.getNamespace() != null) ? member.getNamespace() : "";
        ...
        LinkInfoImpl linkInfo = new LinkInfoImpl( LinkInfoImpl.CONTEXT_CLASS_HEADER, member, false );
        // Let's not link to ourselves in the header.
        linkInfo.setLinkToSelf( false );
        Content headerContent = new StringContent( member.getDocType().toString() + " " + member.getName() );
        Content heading = HtmlTree.heading( HtmlConstants.CLASS_PAGE_HEADING, true, HtmlStyle.TITLE, headerContent );
     ...
     * (non-Javadoc)
     * 
     * @see org.opentravel.schemacompiler.codegen.html.writers.LibraryMemberWriter
     ...
     *
     * @param sup the class to print the helper for
    ...
    protected Content getTreeForClassHelper(DocumentationBuilder sup) {
        ...
        Content link = new RawHtml(
            getLink( new LinkInfoImpl( LinkInfoImpl.CONTEXT_CLASS_TREE_PARENT, sup, sup.getQualifiedName(), false ) ) );
     ...
     * (non-Javadoc)
     * 
     * @see org.opentravel.schemacompiler.codegen.html.writers.LibraryMemberWriter #getMemberInfoTreeHeader()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.opentravel.schemacompiler.codegen.html.writers.LibraryMemberWriter #getMemberDoc()
     */
    @Override
    public T getMember() {
        return member;
    ...
    protected DocumentationBuilder getParent(NamedEntityDocumentationBuilder<?> classDoc) {
