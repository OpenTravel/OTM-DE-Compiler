...
public class ResourceCodegenUtils {
        ...
        for (TLResource extendedResource : getInheritanceHierarchy( paramGroup.getOwner() )) {
            ...
            if (extendedGroup != null) {
                ...
                for (TLParameter param : extendedGroup.getParameters()) {
                    String paramName =
                        (param.getFieldRef() == null) ? param.getFieldRefName() : param.getFieldRef().getName();
     ...
     * @param facetList the full list of facets that have been added
     */
        ...
        if (referencedBO != null) {
            ...
            if ((repeatCount == 0) || (repeatCount == 1)) {
                if (actionFacet.getReferenceFacetName() != null) {
                    payloadType =
                        ResourceCodegenUtils.getReferencedFacet( referencedBO, actionFacet.getReferenceFacetName() );
                } else {
