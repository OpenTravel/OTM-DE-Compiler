...
public class TLDocumentationCodegenTransformer extends AbstractXsdTransformer<TLDocumentation,Annotation> {
	...
	private static List<String> standardSources = Arrays.asList(
			new String[] { DESCRIPTION_SOURCE, DEPRECATION_SOURCE, REFERENCE_SOURCE, IMPLEMENTER_SOURCE, MORE_INFO_SOURCE }
		);
