...
/**
 * Context that provides global information that may be required during the schema generation process.
 * 
 * @author S. Livezey
 */
public class CodeGenerationContext {
    ...
    /**
     * Context key indicating the amount of detail that should be provided during EXAMPLE generation (valid values are
     * "MINIMUM" and "MAXIMUM" - default is "MAXIMUM").
     */
    ...
    /**
     * Context key indicating the maximum number of times that repeating elements should be displayed in generated
     * EXAMPLE output.
     */
    ...
    /**
     * Context key indicating the relative path where schema files are located, relative to the EXAMPLE XML document
     * being generated.
     */
    ...
    /**
     * Returns a value from the context. If a value for the specified key is not defined, this method will return null.
     * 
    ...
    /**
     * Returns an integer value from the context. If the value for the specified key is not defined (or the value is not
     * an integer), this method will return zero.
     * 
     * @param key the key that identifies the desired value
     * @return int
     */
    ...
    /**
     * Returns an boolean value from the context. If the value for the specified key is not defined (or the value is not
     * a boolean), this method will return false.
     * 
     * @param key the key that identifies the desired value
     * @return boolean
     */
    ...
    /**
     * Assigns the given value to the specified key. If the value contains leading or trailing white space, it will be
     * trimmed before adding it to the context. A null or blank value will cause the key to be removed from the context.
     * 
