...
/**
 * Encapsulates a reference to another JSON schema. Reference may be either by-value (included directly in the parent
 * schema) or by-reference as a relative path.
 */
