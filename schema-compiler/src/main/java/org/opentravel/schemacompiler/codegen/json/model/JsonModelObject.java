...
/**
 * Interface that should be implemented by any JSON model object that has a
 * direct JSON content representation.
 */
public interface JsonModelObject {
	 ...
	 * @param json  the JSON object to which the property will be added
	 * @param propertyName  the name of the property to add
	 * @param propertyValue  the list of array values for the property to add
	 */
