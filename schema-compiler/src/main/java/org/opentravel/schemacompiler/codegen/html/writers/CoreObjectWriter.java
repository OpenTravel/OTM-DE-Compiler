...
public class CoreObjectWriter extends ComplexObjectWriter<CoreObjectDocumentationBuilder> {
    ...
    /**
     * @param coreObject the class being documented.
     ...
     */
    public CoreObjectWriter(CoreObjectDocumentationBuilder coreObject, DocumentationBuilder prev,
    ...
    private class RoleInfoWriter extends AbstractInfoWriter<CoreObjectDocumentationBuilder> {
        ...
        public RoleInfoWriter(SubWriterHolderWriter writer, CoreObjectDocumentationBuilder source) {
            super( writer, source );
        ...
        protected String getInfoTableSummary() {
            ...
            return config.getText( "doclet.Object_Table_Summary", config.getText( "doclet.Role_Summary" ),
        ...
        protected String[] getInfoTableHeader() {
            Configuration config = writer.newConfiguration();
            return new String[] {config.getText( "doclet.Role" ), config.getText( "doclet.Description" )};
        }
