...
/**
 * Class that defines the meta-model for a non-standard XML schema reference within an OpenAPI document.
 */
public class OpenApiXmlSchemaRef implements JsonModelObject {
     ...
     */
    public OpenApiXmlSchemaRef(String schemaPath) {
