...
public class HtmlDocletWriter extends HtmlDocWriter {
	...
	// this.configuration).build().length > 0)
...
//		head();
//
//		print("<!-- Generated by javadoc (build " + Configuration.BUILD_DATE
//				+ ") on ");
//		print(today());
//		println(" -->");
...
//	}
	...
	protected Content getNavLinkTree() {
		...
		// if (namespaces.size() == 1 && configuration.members().isEmpty()) {
		// treeLinkContent = getHyperLink(
		// pathString(namespaces.get(0), "package-tree.html"), "",
		// treeLabel, "", "");
		// } else {
...
//				+ AllObjectsFrameWriter.OUTPUT_FILE_NAME_NOFRAMES, "",
//				allMembersLabel, "", "");
...
//	}
	...
	// public void printSrcLink(DocumentationBuilder<?> d, String label) {
	// if (d == null) {
	// return;
	// }
	//
	// String href = relativePath + DocletConstants.SOURCE_OUTPUT_DIR_NAME
	// + DirectoryManager.getDirectoryPath(d.getNamespace())
	// + d.getName() + ".html#"
	...
	// */
	// public void addSrcLink(ProgramElementDoc doc, Content label,
	// Content htmltree) {
	// if (doc == null) {
	// return;
	// }
	...
	// + cd.name() + ".html#"
	// + SourceToHTMLConverter.getAnchorName(doc);
	...
	public String getLink(LinkInfoImpl linkInfo) {
		...
		try {
			...
			System.out.println(linkInfo.label);
		}
