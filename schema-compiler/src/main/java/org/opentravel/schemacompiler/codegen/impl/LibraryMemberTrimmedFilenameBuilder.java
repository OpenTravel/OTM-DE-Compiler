 ...
 * XML schema files associated with <code>AbstractLibrary</code> instances for a specific service.
 * 
...
public class LibraryMemberTrimmedFilenameBuilder<M extends LibraryMember> implements CodeGenerationFilenameBuilder<M> {
     ...
     * 
     * @param libraryMember the service affiliation for all generated schema files
     * @param includeVersionInfo flag indicating whether a version identifier should be included in the filenames
