...
/**
 * Service to be implemented by components that can generate file names for the target model
 * element(s) of a code generation service.
 * 
 * @param <T>
...
public interface CodeGenerationFilenameBuilder<T> {
     ...
     * 
     * @param item
     *            the model element for which to return a filename
     * @param fileExtension
     *            the extension of the filename to be created
     * @return String
     */
