...
/**
 * Supplies default SOAP binding information for WSDL documents. Sub-classes may override with client-specific bindings,
 * message headers, etc. required by a particular service implementation.
 * 
 * @author S. Livezey
 */
public class DefaultSoapBindings implements CodeGenerationWsdlBindings {
    ...
    protected static org.xmlsoap.schemas.wsdl.soap.ObjectFactory soapObjectFactory =
        new org.xmlsoap.schemas.wsdl.soap.ObjectFactory();
    ...
    /**
     * Appends the <code>SchemaDeclaration</code> associated with the given dependency to the list provided (if it has
     ...
     *      org.opentravel.schemacompiler.model.OperationType, org.opentravel.schemacompiler.model.TLFacetType)
     */
    @Override
    ...
    /**
     * Returns the qualified name of the fault that should be applied to the specified port-type operation. By default,
     * this method returns the standard fault element from the SOAP envelope schema. Sub-classes may override to specify
     * an alternate fault element.
     * 
     ...
     * 
     * @param portTypeOperation the operation being converted
     ...
     */
    protected TBindingOperation createBindingOperation(TOperation portTypeOperation, List<TMessage> wsdlMessages,
        ...
        for (JAXBElement<? extends TExtensibleAttributesDocumented> jaxbElement : portTypeOperation.getRest()) {
            ...
            if (messageType.equals( "input" )) {
                ...
                && (bindingOperation.getFault().isEmpty() || lastMessageType.equals( "fault" ))) {
    ...
    /**
     * Returns the name of a binding for the given port-type name. By default, this method replaces the "PortType"
     * suffix with "Binding" (e.g. "XYZPortType" would be translated to "XYZBinding". Sub=classes may override to
     * implement an alternative naming convention.
     * 
    ...
    /**
     * Returns the name of the binding operation that will correspond to the port-type operation provided. By default,
     * the name of the binding operation is the same as that of the port- type operation. Sub-classes may override to
     * implement an alternative naming convention.
     * 
    ...
    /**
     * Returns the SOAP action attribute for the binding operation that will correspond to the port-type operation
     * provided. By default, the name of the SOAP action is the same as that of the port-type operation name.
     ...
     */
    protected void addSoapMessagePartBindings(TExtensibleDocumented messageBinding, TMessage wsdlMessage,
        String targetNamespace) {
    ...
    /**
     * Returns the name of a service for the given base service name. By default, this method replaces the "Binding"
     * suffix with "Service" (e.g. "XYZBinding" would be translated to "XYZService". Sub=classes may override to
     * implement an alternative naming convention.
     * 
    ...
    /**
     * Returns the name of a port for the given base service name. By default, this method replaces the "Binding" suffix
     * with "Port" (e.g. "XYZBinding" would be translated to "XYZPort". Sub=classes may override to implement an
    ...
    public void addPayloadExampleContent(Element exampleXml, Map<String,String> namespaceMappings,
        ...
        exampleXml.setAttribute( TIMESTAMP_ATTRIBUTE_NAME, DatatypeConverter.printDateTime( Calendar.getInstance() ) );
    }
     ...
     * 
     * @param operationFacet the operation facet for which to return the version
