...
public class DefaultSoapBindings implements CodeGenerationWsdlBindings {
    ...
    /**
     * Appends the <code>SchemaDeclaration</code> associated with the given dependency to the list
     * provided (if it has not already been added).
     * 
     * @param dependency
    ...
    /**
     * Returns the qualified name of the fault that should be applied to the specified port-type
     * operation. By default, this method returns the standard fault element from the SOAP envelope
     * schema. Sub-classes may override to specify an alternate fault element.
     * 
     * @param operation
     ...
     * @return QName
     */
    protected QName getFaultType(TOperation operation, OperationType operationType,
            TLFacetType messageType) {
    ...
    public TBinding createBinding(TPortType portType, String targetNamespace,
        ...
        for (TOperation portTypeOperation : portType.getOperation()) {
            binding.getOperation().add(
                    createBindingOperation(portTypeOperation, wsdlMessages, targetNamespace));
        }
        return binding;
    }
     ...
     */
    protected TBindingOperation createBindingOperation(TOperation portTypeOperation,
            List<TMessage> wsdlMessages, String targetNamespace) {
     ...
     * the "PortType" suffix with "Binding" (e.g. "XYZPortType" would be translated to "XYZBinding".
     ...
     * provided. By default, the name of the binding operation is the same as that of the port- type
     * operation. Sub-classes may override to implement an alternative naming convention.
     * 
     ...
     * port-type operation provided. By default, the name of the SOAP action is the same as that of
     * the port-type operation name. Sub-classes may override to implement an alternative naming
     * convention.
     * 
     * @param portTypeOperation
     *            the port-type operation for which a binding will be created
    ...
    /**
     * Adds SOAP binding elements to the 'messageBinding' for each message-part of the 'wsdlMessage'
     * provided.
     * 
     ...
     */
    protected void addSoapMessagePartBindings(TExtensibleDocumented messageBinding,
            TMessage wsdlMessage, String targetNamespace) {
    ...
    /**
     * Returns the name of a service for the given base service name. By default, this method
     * replaces the "Binding" suffix with "Service" (e.g. "XYZBinding" would be translated to
     * "XYZService". Sub=classes may override to implement an alternative naming convention.
     * 
     * @param bindingName
     ...
     * the "Binding" suffix with "Port" (e.g. "XYZBinding" would be translated to "XYZPort".
     * Sub=classes may override to implement an alternative naming convention.
     * 
     * @param bindingName
    ...
    public void addPayloadExampleContent(Element exampleXml, Map<String,String> namespaceMappings, TLFacet operationFacet) {
        ...
        exampleXml.setAttribute("timeStamp",
