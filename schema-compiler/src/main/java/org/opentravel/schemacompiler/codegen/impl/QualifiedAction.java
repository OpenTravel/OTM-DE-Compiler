...
/**
 * Represents the pairing of zero or more <code>TLResourceParentRefs</code> and a <code>TLAction</code> for the purposes
 * of generating an API specification.
 */
public class QualifiedAction {
    ...
    /**
     * Full constructor. The list of parent reference supplied to this method should be ordered from the most immediate
     * parent resource reference to the most distant.
     * 
     ...
     * 
     * <p>
     * It should be noted that this action ID (for the <code>QualifiedAction</code>) may be different from that of the
     * <code>TLAction</code> ID. This is because the qualified action's identifier is a function of both the
     * <code>TLAction</code> and the parent references that comprise the qualified action.
     *
     * @return String
     */
    ...
    /**
     * Returns the path template for this qualified action. If a parent resource reference is present, the resulting
     * path will include the path of the parent.
     * 
     * @return String
     */
    public String getPathTemplate() {
        ...
        for (TLResourceParentRef parentRef : parentRefs) {
            ...
            for (String pathParam : pathParams) {
                parentPath =
                    parentPath.replaceAll( "\\{" + pathParam + "\\}", "\\{" + parentPrefix + pathParam + "\\}" );
            }
    ...
    /**
     * Returns the full list of parameters associated with this qualified action, including the path parameters
     * inherited from parent references.
     * 
