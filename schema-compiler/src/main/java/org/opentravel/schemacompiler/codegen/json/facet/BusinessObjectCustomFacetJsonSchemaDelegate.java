 ...
 */
public class BusinessObjectCustomFacetJsonSchemaDelegate extends BusinessObjectFacetJsonSchemaDelegate {
     ...
     */
    public BusinessObjectCustomFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
