 ...
 */
public class ChoiceObjectSharedFacetJsonSchemaDelegate extends ChoiceObjectFacetJsonSchemaDelegate {
     ...
     */
    public ChoiceObjectSharedFacetJsonSchemaDelegate(TLFacet sourceFacet) {
        super(sourceFacet);
    }
