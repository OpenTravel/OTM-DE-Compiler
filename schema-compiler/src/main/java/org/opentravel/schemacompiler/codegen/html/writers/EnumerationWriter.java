...
public class EnumerationWriter extends NamedEntityWriter<EnumerationDocumentationBuilder> {
    ...
    /**
     * @param member builder for the enumeration to be written
     * @param prev the previous documentation builder
     * @param next the next documentation builder
     * @throws IOException thrown if the documentation output cannot be written
     */
    public EnumerationWriter(EnumerationDocumentationBuilder member, DocumentationBuilder prev,
    ...
    private class ValueInfoWriter extends AbstractInfoWriter<EnumerationDocumentationBuilder> {
        ...
        public ValueInfoWriter(SubWriterHolderWriter writer, EnumerationDocumentationBuilder source) {
            super( writer, source );
        ...
        protected String getInfoTableSummary() {
            ...
            return config.getText( "doclet.Enum_Value_Table_Summary", config.getText( "doclet.Value_Summary" ),
         ...
         * (non-Javadoc)
         * 
         * @see org.opentravel.schemacompiler.codegen.html.writers.AbstractInfoWriter #getInfoTableHeader()
         */
        @Override
