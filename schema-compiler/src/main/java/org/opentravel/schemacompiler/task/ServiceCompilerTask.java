...
public class ServiceCompilerTask extends AbstractSchemaCompilerTask
     ...
     *             thrown if an error occurs due to an unrecognized version scheme
     */
     ...
     * 
     * @param service
     *            the service instance to analyze
     * @return boolean
     * @throws SchemaCompilerException
     *             thrown if an error occurs due to an unrecognized version scheme
     */
    private boolean isLatestServiceVersion(TLService service) throws SchemaCompilerException {
        try {
            ...
            List<TLLibrary> laterMinorVersions = new MinorVersionHelper()
                    .getLaterMinorVersions(owningLibrary);
     ...
     * 
     * @param service
     *            the service for which to return the major version
     * @return String
     * @throws SchemaCompilerException
     *             thrown if an error occurs due to an unrecognized version scheme
     */
