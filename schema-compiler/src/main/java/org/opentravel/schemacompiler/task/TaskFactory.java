...
public class TaskFactory {
    ...
    /**
     * Retrieves a pre-configured task from the application context using the simple name of the given class. The type
     * of the task that is registered in the Spring application context must match that of the requested class.
     * 
     * @param taskClass the type of task to retrieve
     * @param <T> the expected type of the task to be returned
     * @return T
     */
