...
public class TLOperationCodegenTransformer extends AbstractWsdlTransformer<TLOperation,CodegenArtifacts> {
	...
	public CodegenArtifacts transform(TLOperation source) {
		...
		artifacts.addArtifact(
				createPortTypeOperation(source, requestMessage, responseMessage, notifMessage, faultMessages)
			);
	 ...
	 * @param responseMessage  the response message for the operation
	 * @param notifMessage  the notification message for the operation
	 * @param faultMessages  the fault messages for the operation
	 * @return TOperation
	 */
	private TOperation createPortTypeOperation(TLOperation sourceOperation, TMessage requestMessage,
			TMessage responseMessage, TMessage notifMessage, List<TMessage> faultMessages) {
