 ...
 */
package com.sabre.schemacompiler.saver.impl;
...
import com.sabre.schemacompiler.saver.LibrarySaveHandler;
import com.sabre.schemacompiler.util.URLUtils;
import com.sabre.schemacompiler.validate.FindingType;
import com.sabre.schemacompiler.validate.ValidationFindings;
import com.sabre.schemacompiler.xml.LibraryLineBreakProcessor;
...
public class LibraryFileSaveHandler implements LibrarySaveHandler {
	...
	private static final String VALIDATION_MESSAGE_KEY = "com.sabre.schemacompiler.TLLibrary.jaxbValidationWarning";
	private static final String LIBRARY_SCHEMA_LOCATION_DECL =
			SchemaDeclarations.OTA2_LIBRARY_SCHEMA_1_4.getNamespace() + " " + SchemaDeclarations.OTA2_LIBRARY_SCHEMA_1_4.getFilename();
	
	private static final Map<String,String> preferredPrefixMappings;
	private static final String[] schemaDeclarations = new String[] {
		XMLConstants.W3C_XML_SCHEMA_NS_URI, XMLConstants.W3C_XML_SCHEMA_INSTANCE_NS_URI, SchemaDeclarations.OTA2_LIBRARY_SCHEMA_1_4.getNamespace()
	};
	...
	/**
	 * @see com.sabre.schemacompiler.saver.LibrarySaveHandler#canSave(java.net.URL)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.saver.LibrarySaveHandler#validateLibraryContent(org.opentravel.ns.ota2.librarymodel_v01_03.Library)
	 */
	@Override
	public ValidationFindings validateLibraryContent(Library library) {
		...
		try {
			...
			findings.addFinding(FindingType.WARNING, new LibraryValidationSource(library), VALIDATION_MESSAGE_KEY, getExceptionMessage(e));
		}
		return findings;
	}

	/**
	 * @see com.sabre.schemacompiler.saver.LibrarySaveHandler#saveLibraryContent(java.net.URL, org.opentravel.ns.ota2.librarymodel_v01_03.Library)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.saver.LibrarySaveHandler#isCreateBackupFile()
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.saver.LibrarySaveHandler#setCreateBackupFile(boolean)
	 */
	@Override
	...
	/**
	 * If the indicated 'libraryFile' already exists, the existing file will be renamed with
	 * a ".bak" extension.  If a backup file already exists, it will be deleted.  If a backup file
	 * is created by this method, it will be returned to the caller.  If no backup is required,
	...
	/**
	 * Returns a file handle for the URL provided.  If the URL does not represent a location on
	 * the local host's file system, an <code>IllegalArgumentException</code> will be thrown by
	 * this method.
	 * 
