...
/**
 * Handles the resolution of file hints for OTM import declarations.  In some cases, the file
 * paths contain white-space characters.  This class attempts to resolve the naming conflicts
 * to return a list of valid file-hint paths.
 * 
 * @author S. Livezey
 */
public class FileHintUtils {
	 ...
	 * any of the hints represent files that do not exist, they are combined with adjacent hints in an
	 * attempt to resolve white-space character issues.
	 * 
	...
	public static List<String> resolveHints(String hints, URL libraryUrl) {
		return (hints == null) ? new ArrayList<String>() : resolveHints(hints.trim().split("\\s+"), libraryUrl);
	}
	 ...
	 */
	public static List<String> resolveHints(String[] hints, URL libraryUrl) {
		return (hints == null) ? new ArrayList<String>() : resolveHints(Arrays.asList(hints), libraryUrl);
	}
