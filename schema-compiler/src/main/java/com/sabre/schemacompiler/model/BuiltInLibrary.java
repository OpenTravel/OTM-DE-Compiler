...
public class BuiltInLibrary extends AbstractLibrary {
	...
	public static enum BuiltInType { XSD_BUILTIN, TLLIBRARY_BUILTIN, SCHEMA_FOR_SCHEMAS_BUILTIN };
	 ...
	 * @param prefix  the preferred prefix for the built-in library
	...
	public BuiltInLibrary(String namespace, String name, String prefix, URL libraryUrl, List<LibraryMember> members,
		...
		if (members != null) {
			...
			if ((namespace != null) && namespace.equals(XMLConstants.W3C_XML_SCHEMA_NS_URI)) {
				builtInType = BuiltInType.SCHEMA_FOR_SCHEMAS_BUILTIN; // special case: schema-for-schemas
				
			} else if (hasTLLibraryMembers && hasXsdMembers) {
				throw new IllegalArgumentException("Error: Built-in libraries cannot be a mix of XSD and OTA2 member types.");
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#isValidMember(com.sabre.schemacompiler.model.LibraryMember)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#setLibraryUrl(java.net.URL)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#setName(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#setNamespace(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#getIncludes()
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#addInclude(com.sabre.schemacompiler.model.TLInclude)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#addInclude(int, com.sabre.schemacompiler.model.TLInclude)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#removeInclude(com.sabre.schemacompiler.model.TLInclude)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#moveUp(com.sabre.schemacompiler.model.TLInclude)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#moveDown(com.sabre.schemacompiler.model.TLInclude)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#sortIndicators(java.util.Comparator)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#addNamespaceImport(com.sabre.schemacompiler.model.TLNamespaceImport)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#addNamespaceImport(int, com.sabre.schemacompiler.model.TLNamespaceImport)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#addNamespaceImport(java.lang.String, java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#removeNamespaceImport(com.sabre.schemacompiler.model.TLNamespaceImport)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#removeNamespaceImport(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#moveUp(com.sabre.schemacompiler.model.TLNamespaceImport)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#moveDown(com.sabre.schemacompiler.model.TLNamespaceImport)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#sortNamespaceImports(java.util.Comparator)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#addNamedMember(com.sabre.schemacompiler.model.AbstractLibraryMember)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.model.AbstractLibrary#removeNamedMember(com.sabre.schemacompiler.model.AbstractLibraryMember)
	 */
	@Override
