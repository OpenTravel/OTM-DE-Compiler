...
import com.sabre.schemacompiler.model.TLAdditionalDocumentationItem.AdditionalDocumentationItemListManager;
import com.sabre.schemacompiler.model.TLDocumentationItem.DocumentationItemListManager;
...
public class TLDocumentation extends TLModelElement implements LibraryElement {
	...
	private DocumentationItemListManager deprecationManager =
			new DocumentationItemListManager(this, ModelEventType.DOC_DEPRECATION_ADDED, ModelEventType.DOC_DEPRECATION_REMOVED);
	private DocumentationItemListManager referenceManager =
			new DocumentationItemListManager(this, ModelEventType.DOC_REFERENCE_ADDED, ModelEventType.DOC_REFERENCE_REMOVED);
	private DocumentationItemListManager implementerManager =
			new DocumentationItemListManager(this, ModelEventType.DOC_IMPLEMENTER_ADDED, ModelEventType.DOC_IMPLEMENTER_REMOVED);
	private DocumentationItemListManager moreInfoManager =
			new DocumentationItemListManager(this, ModelEventType.DOC_MORE_INFO_ADDED, ModelEventType.DOC_MORE_INFO_REMOVED);
	private AdditionalDocumentationItemListManager otherDocManager =
			new AdditionalDocumentationItemListManager(this, ModelEventType.DOC_OTHER_DOCS_ADDED, ModelEventType.DOC_OTHER_DOCS_REMOVED);
	...
	/**
	 * Adjusts the encoding of the given string to remove any platform-dependent line feed characters
	 * from its content.
	 * 
	...
	/**
	 * Moves this deprecation up by one position in the list.  If the deprecation is not owned by this
	...
	/**
	 * Moves this deprecation down by one position in the list.  If the deprecation is not owned by this
	...
	/**
	 * Moves this implementer up by one position in the list.  If the implementer is not owned by this
	 * object or it is already at the front of the list, this method has no effect.
	 * 
	...
	/**
	 * Moves this implementer down by one position in the list.  If the implementer is not owned by this
	 * object or it is already at the end of the list, this method has no effect.
	 * 
	 * @param implementer  the implementer to move
	 */
