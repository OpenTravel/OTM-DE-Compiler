...
import com.sabre.schemacompiler.model.TLFacet.FacetListManager;
 ...
 * @author S. Livezey
 */
public class TLBusinessObject extends TLComplexTypeBase implements Versioned, TLFacetOwner, TLAliasOwner {
	...
	/**
	 * Moves this custom facet up by one position in the list.  If the custom facet is not owned by this
	...
	/**
	 * Moves this custom facet down by one position in the list.  If the custom facet is not owned by this
	...
	/**
	 * Moves this query facet up by one position in the list.  If the query facet is not owned by this
	 * object or it is already at the front of the list, this method has no effect.
	 * 
	...
	/**
	 * Moves this query facet down by one position in the list.  If the query facet is not owned by this
	 * object or it is already at the end of the list, this method has no effect.
	 * 
	 * @param queryFacet  the query facet to move
	 */
