...
import com.sabre.schemacompiler.model.TLRole.RoleListManager;

/**
 * The role enumeration is a specialized open enumeration composed of the roles defined for
 * a core object.
 * 
 * @author S. Livezey
 */
public class TLRoleEnumeration extends TLModelElement implements TLAttributeType {
	...
	/**
	 * Moves this role up by one position in the list.  If the role is not owned by this
	...
	/**
	 * Moves this role down by one position in the list.  If the role is not owned by this
