...
/**
 * Container that maintains a set of local <code>RepositoryItem</code> artifacts.  <code>RepositoryItems</code>
 * managed by a model project represent unmanaged files that have not yet been shared via a remote repository,
 * work-in-process (WIP) items that have been locked for editing by the local user, or unlocked items from
 * remote repositories that have been included for reference only.
 * 
 * @author S. Livezey
 */
public class Project {
	 ...
	 * 
	 * @param model  the shared model instance
	 */
	...
	public void setDefaultContextId(String defaultContextId) {
		boolean isEqual = (this.defaultContextId == null) ? (defaultContextId == null) : this.defaultContextId.equals(defaultContextId);
	...
	/**
	 * Broadcasts an event to all listeners that a new <code>ProjectItem</code> has been added to this
	 * project.
	 */
	...
	/**
	 * Broadcasts an event to all listeners that a <code>ProjectItem</code> has been removed from this
	 * project.
	 */
