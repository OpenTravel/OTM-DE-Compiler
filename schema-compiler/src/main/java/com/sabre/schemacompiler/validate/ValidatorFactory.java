...
import com.sabre.schemacompiler.validate.impl.CompositeValidator;
...
public class ValidatorFactory {
	...
	public <T extends Validatable> Validator<T> getValidatorForClass(Class<T> targetClass) {
		List<Class<Validator<T>>> validatorClasses = (ruleSet == null) ?
				new ArrayList<Class<Validator<T>>>() : ruleSet.getValidatorClasses(targetClass);
	...
	/**
	 * Creates a new instance of the specified validator class.  If the class cannot be instantiated, an
	 * error will be logged and this method will return null.
	 * 
