...
/**
 * Builder used to perform the most basic validation tasks.  Sub-classes may extend this builder
 * to incorporate additional validation functions.  When new methods are added, it is recommended
 * that the builder pattern is followed to ensure easy usage and code readability within the
...
public abstract class ValidationBuilder<T extends ValidationBuilder<T>> {
	...
	/**
	 * Constructor that assigns a pefix that will be pre-pended to each finding message
	 * key generated by this builder.
	 * 
	 * @param prefix  the prefix string to append
	 */
	...
	/**
	 * Abstract class that returns the generic reference to this object.  This approach allows the parent
	 * builder class to cast its return types to that of the child class, thus keeping the builder pattern
	 * intact.
	 * 
	 * @return T
	 */
	...
	/**
	 * Assigns the target object instance to be validated.  When a new target object is assigned,
	 * the current property name and value for this builder is cleared.
	 * 
	...
	/**
	 * Specifies the type of finding(s) to add when an assertion fails.  The default
	 * type of finding is <code>ERROR</code>.
	 * 
	...
	/**
	 * Specifies the significant unit of time to use during date/time comparisons.  Valid values
	 ...
	 * </ul>
	 * 
	 * <p>The default comparison unit is <code>DAY_OF_YEAR</code>.
	 * 
	...
	/**
	 * Returns the validation findings that have been constructed from the checks performed
	 * since this <code>ValidationBuilder</code> was initialized.  If no findings have been
	 * discovered, this method will return a null value.
	 * 
	...
	/**
	 * Allows validators to manually add findings that were discovered during validation
	 * checks performed outside of this builder's organic validation methods.
	 * 
	...
	/**
	 * Adds all of the findings in the given collection to the list being compiled by this
	 * buider.
	 * 
	...
	/**
	 * Adds a validation finding if the current property (trimmed) string value
	...
	/**
	 * Adds a validation finding if the string value contains fewer characters than the
	...
	/**
	 * Adds a validation finding if the string value is longer than the specified
	 * maximum length.
	 * 
	 * <p>Null values checked by this method <i>will not</i> produce an error.
	 * 
	...
	/**
	 * Adds a validation finding if the string value does not contain the exact
	...
	/**
	 * Adds a validation finding if the collection value contains fewer elements than the
	...
	/**
	 * Adds a validation finding if the collection value contains more elements than the
	...
	/**
	 * Adds a validation finding if the collection value does not contain the exact
	 ...
	 * share the same name as that of the current target object. Duplicity is determined by comparing the
	 * identity names of each member element as determined by the identity resolver instance provided.
	 * 
	 * <p>NOTE: The collection property value is expected to contain a copy of the current target value, so
	 * there is no need to exclude it from the collection that assigned as the current property value.
	 * 
	 * <p>Null values checked by this method <i>will not</i> produce an error.
	 * 
	...
	/**
	 * Adds a validation finding if the date value occurs on or after the date limit
	 * value provided.
	 * 
	 * <p>Null values checked by this method <i>will not</i> produce an error.
	 * 
	...
	/**
	 * Adds a validation finding if the date value occurs after the date limit
	 * value provided.
	 * 
	 * <p>Null values checked by this method <i>will not</i> produce an error.
	 * 
	...
	/**
	 * Adds a validation finding if the date value occurs on or before the date limit
	 * value provided.
	 * 
	 * <p>Null values checked by this method <i>will not</i> produce an error.
	 * 
	...
	/**
	 * Rounds the given double value to the nearest significant decimal place.  The unit
	 * of measure assigned by the {@link #setSignificantDigitsForDecimalComparisons(int)} is used
	 * to determine the significant timeframe for the comparison.
	 * 
	 * @param a_double  the floating-point value to round
	 * @return double
	 */
	protected double roundDouble(double a_double) {
		return ((double) Math.round(a_double * multiplierForDecimalComparisons)) / multiplierForDecimalComparisons;
	}
	
	/**
	 * Rounds dates to the nearest indicated significant unit for comparison purposes.  The
	 * unit of measure assigned by the {@link #setCalendarUnitsForDateComparisons(int)} is
	 * used to determine the significant timeframe for the comparison.
	 * 
	 * @param a_date  the date value to round
	 * @return java.util.Date
	 */
	...
	/**
	 * Returns a <code>Pattern</code> using the regular expression provided.  Patterns
