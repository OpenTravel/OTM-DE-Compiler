...
/**
 * Handles the resolution of qualified entity names into reference to the objects
 * described by those names.
 * 
 * @author S. Livezey
 */
public interface SymbolResolver {
	...
	/**
	 * Resolves the given entity name into an object reference.  The entity name may either be a simple
	 * name (that assumes the local namespace), or a prefixed name.
	 * 
	 * @param typename  the entity name to resolve
	 * @return Object
	 */
	 ...
	 * 
	 * <p>NOTE: An entity with the specified qualified name is not required to exist for this method
	 * to succeed.
	 * 
