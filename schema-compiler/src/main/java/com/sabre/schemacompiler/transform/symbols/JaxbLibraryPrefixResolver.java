...
public class JaxbLibraryPrefixResolver implements PrefixResolver {
	...
	/**
	 * @see com.sabre.schemacompiler.transform.PrefixResolver#getLocalNamespace()
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.transform.PrefixResolver#resolveNamespaceFromPrefix(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.transform.PrefixResolver#getPrefixForNamespace(java.lang.String)
	 */
	@Override
