...
public class TestURLUtils {
	...
	public void testGetResolvedUrl() throws Exception {
		...
		assertEquals("file:////my/folder/location/test.xml", URLUtils.getResolvedURL("test.xml", baseUrl).toExternalForm());
		assertEquals("file:////my/folder/location/test.xml", URLUtils.getResolvedURL("./test.xml", baseUrl).toExternalForm());
		assertEquals("file:////my/folder/test.xml", URLUtils.getResolvedURL("../test.xml", baseUrl).toExternalForm());
		assertEquals("file:////my/testfolder/test.xml", URLUtils.getResolvedURL("../../testfolder/test.xml", baseUrl).toExternalForm());
	}
	...
	public void testGetParentUrl() throws Exception {
		...
		assertEquals("http://www.sabre-holdings.com", URLUtils.getParentURL(baseUrl).toExternalForm());
		assertEquals("http://www.sabre-holdings.com", URLUtils.getParentURL(baseUrlWithSlash).toExternalForm());
		assertEquals("http://www.sabre-holdings.com", URLUtils.getParentURL(baseUrlWithSingleFolder).toExternalForm());
	}
	...
	public void testRelativeUrl() throws Exception {
		...
		assertEquals("myFolder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:////usr/local/someFolder/someFile.txt"),
				new URL("file:////usr/local/someFolder/myFolder/myFile.txt"), true));
		
		assertEquals("../../home/slivezey/myFolder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:////usr/local/someFolder/someFile.txt"),
				new URL("file:////usr/home/slivezey/myFolder/myFile.txt"), true));
		
		assertEquals("myFile.txt", URLUtils.getRelativeURL(
				new URL("file:////usr/local/someFolder/someFile.txt"),
				new URL("file:////usr/local/someFolder/myFile.txt"), true));
		
		assertEquals("subFolder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:////usr/local/someFolder/someFile.txt"),
				new URL("file:////usr/local/someFolder/subFolder/myFile.txt"), true));
		
		// Windows-style file URL's
		assertEquals("../../home/slivezey/myFolder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:/c|/usr/local/someFolder/someFile.txt"),
				new URL("file:/c|/usr/home/slivezey/myFolder/myFile.txt"), true));
		
		assertEquals("subFolder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:/c|/usr/local/someFolder/someFile.txt"),
				new URL("file:/c|/usr/local/someFolder/subFolder/myFile.txt"), true));
		
		// Internet-style URL's
		assertEquals("../my-folder/myFile.txt", URLUtils.getRelativeURL(
				new URL("http://www.sabre.com/some-folder"),
				new URL("http://www.sabre.com/my-folder/myFile.txt"), false));
		
		// Special Case: Mis-matches URL authority
		assertEquals("http://www.sabre.com/my-folder/myFile.txt", URLUtils.getRelativeURL(
				new URL("http://www.sabre-holdings.com/some-folder"),
				new URL("http://www.sabre.com/my-folder/myFile.txt"), false));
		
		// Special Case: Mis-matches URL protocol
		assertEquals("http://www.sabre.com/my-folder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:////some-folder/someFile.txt"),
				new URL("http://www.sabre.com/my-folder/myFile.txt"), true));
		...
		assertEquals("file:/d|/usr/local/someFolder/subFolder/myFile.txt", URLUtils.getRelativeURL(
				new URL("file:/c|/usr/local/someFolder/someFile.txt"),
				new URL("file:/d|/usr/local/someFolder/subFolder/myFile.txt"), true));
	}
