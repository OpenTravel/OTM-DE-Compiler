...
public class TestVersionScheme {
	...
	public void testGetBaseNamespace_OTA2() throws Exception {
		...
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package", scheme.getBaseNamespace(namespace2));
	}
	...
	public void testSetVersionIdentifier_OTA2() throws Exception {
		...
		assertEquals("http://www.OpenTravel.org/ns/OTA2/Common_v02_05", scheme.setVersionIdentifier(namespace1, "2.5"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package_v9_3_1", scheme.setVersionIdentifier(namespace2, "9.3.1"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5", scheme.setVersionIdentifier(namespace3, "5"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5", scheme.setVersionIdentifier(namespace3, "5.0"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5", scheme.setVersionIdentifier(namespace3, "5.0.0"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package-v5_12_132", scheme.setVersionIdentifier(namespace4, "5.12.132"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_12_132", scheme.setVersionIdentifier(namespace5, "5.12.132"));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_12_132", scheme.setVersionIdentifier(namespace6, "5.12.132"));
	}
	...
	public void testVersionChain_PaddedUriVersionNumbers() throws Exception {
		...
		assertEquals(6, versionChain.size());
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02_03", versionChain.get(0));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02_02", versionChain.get(1));
		assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02_01", versionChain.get(2));
	...
	public void testDefaultFileHint() throws Exception {
		...
		assertEquals( "TestLibrary_5_2_3.otm", scheme.getDefaultFileHint("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02_03", "TestLibrary") );
		assertEquals( "TestLibrary_5_2_0.otm", scheme.getDefaultFileHint("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02", "TestLibrary") );
		assertEquals( "TestLibrary_5_0_0.otm", scheme.getDefaultFileHint("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05", "TestLibrary") );
		assertEquals( "Test_Library_5_0_0.otm", scheme.getDefaultFileHint("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05", "Test Library") );
	}
