...
import com.sabre.schemacompiler.transform.jaxb13_2tl.LibraryTransformer;
...
public class TestFacetTransformers extends Abstract_1_3_TestTransformers {
	...
	public void testFacetTransformerAttributes() throws Exception {
		...
		assertEquals(LibraryTransformer.DEFAULT_CONTEXT_ID, facet.getAttributes().get(2).getExamples().get(0).getContext());
	...
	public void testFacetTransformerProperties() throws Exception {
		...
		assertEquals(LibraryTransformer.DEFAULT_CONTEXT_ID, facet.getElements().get(2).getExamples().get(0).getContext());
		...
		assertEquals("SampleBusinessObject_Detail", facet.getElements().get(5).getType().getLocalName());
	}
	...
	public void testFacetContextualTransformer() throws Exception {
		...
		assertEquals("SampleBusinessObject_Alias1_SampleCustomFacet", facet.getAliases().get(0).getName());
		assertEquals("SampleBusinessObject_Alias2_SampleCustomFacet", facet.getAliases().get(1).getName());
		assertEquals("SampleCustomFacet_Alias_SampleCustomFacet", facet.getAliases().get(2).getName());
		assertEquals("SampleCustomFacet2_Alias_SampleCustomFacet", facet.getAliases().get(3).getName());
	...
	public void testTLFacetTransformerAttributes() throws Exception {
		...
		assertEquals(LibraryTransformer.DEFAULT_CONTEXT_ID, facet.getAttribute().get(2).getExample().get(0).getContext());
	...
	public void testTLFacetTransformerProperties() throws Exception {
		...
		assertEquals(LibraryTransformer.DEFAULT_CONTEXT_ID, facet.getElement().get(2).getExample().get(0).getContext());
