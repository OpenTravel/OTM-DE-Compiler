 ...
 * @author S. Livezey
 */
public class TestCoreObjectTransformers extends Abstract_1_3_TestTransformers {
	
	@Test
	public void testCoreObjectTransformerNoBaseType() throws Exception {
		TLCoreObject type = getCoreObject(PACKAGE_2_NAMESPACE, "library_1_p2", "NoSimpleBaseTypeCore");
	...
	public void testCoreObjectTransformerBuiltInBaseType() throws Exception {
		...
		assertEquals("role_1", type.getRoleEnumeration().getRoles().get(0).getName());
		assertEquals("role_2", type.getRoleEnumeration().getRoles().get(1).getName());
		...
		assertEquals(LibraryTransformer.DEFAULT_CONTEXT_ID, type.getSimpleFacet().getExamples().get(0).getContext());
		...
		assertEquals("SimpleFacet-equivalent", type.getSimpleFacet().getEquivalents().get(0).getDescription());
		...
		assertEquals(XMLConstants.W3C_XML_SCHEMA_NS_URI, type.getSimpleFacet().getSimpleType().getNamespace());
	...
	public void testTLCoreObjectTransformerNoBaseType() throws Exception {
		CoreObject type = transformCoreObject(PACKAGE_2_NAMESPACE, "library_1_p2", "NoSimpleBaseTypeCore");
	...
	public void testTLCoreObjectTransformerBuiltInBaseType() throws Exception {
		...
		assertEquals(LibraryTransformer.DEFAULT_CONTEXT_ID, type.getSimple().getExample().get(0).getContext());
