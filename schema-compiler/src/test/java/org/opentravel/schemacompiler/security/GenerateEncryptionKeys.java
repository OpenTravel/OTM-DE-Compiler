 ...
 * 
 * <p>
 * NOTE: This code has been included for completeness, but generation of new keys should not be done except in extreme
 * circumstances. The effect of replacing the existing public/private key files is that current user credentials used
 * for remote repository access will become unreadable. If this occurs, users will need to re-enter their passwords for
 * all repositories to which they have non- anonymous access.
 * 
 * @author S. Livezey
 */
public class GenerateEncryptionKeys {
    ...
    public static void generateKeyFiles() throws Exception {
        File publicKeyFile =
            new File( System.getProperty( "user.dir" ), "/src/main/resources" + PasswordHelper.PUBLIC_KEYFILE );
        File privateKeyFile =
            new File( System.getProperty( "user.dir" ), "/src/main/resources" + PasswordHelper.PRIVATE_KEYFILE );
        ...
        System.out
            .println( "Private Key: " + privateKeySpec.getModulus() + " / " + privateKeySpec.getPrivateExponent() );
