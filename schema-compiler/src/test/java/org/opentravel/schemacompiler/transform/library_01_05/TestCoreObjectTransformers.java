...
/**
 * Verifies the operation of the transformers that handle conversions to and from <code>TLCoreObject</code> objects.
 * 
 * @author S. Livezey
 */
public class TestCoreObjectTransformers extends Abstract_1_5_TestTransformers {
