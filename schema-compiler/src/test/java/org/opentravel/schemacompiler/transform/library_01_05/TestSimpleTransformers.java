...
import org.opentravel.schemacompiler.transform.jaxb15_2tl.LibraryTransformer;
import org.opentravel.schemacompiler.transform.symbols.SymbolResolverTransformerContext;

import javax.xml.XMLConstants;

/**
 * Verifies the operation of the transformers that handle conversions to and from <code>TLSimple</code> objects.
 * 
 * @author S. Livezey
 */
public class TestSimpleTransformers extends Abstract_1_5_TestTransformers {
    ...
    public void testSimpleTransformerExtendBuiltInType() throws Exception {
        ...
        assertEquals( "default", type.getEquivalents().get( 0 ).getContext() );
    ...
    public void testTLSimpleTransformerExtendBuiltInType() throws Exception {
        ...
        assertEquals( "default", type.getEquivalent().get( 0 ).getContext() );
