...
/**
 * Verifies the operation of the transformers that handle conversions to and from <code>TLValueWithAttributes</code>
 * objects.
 * 
 * @author S. Livezey
 */
public class TestValueWithAttributesTransformers extends Abstract_1_5_TestTransformers {

    @Test
    public void testValueWithAttributesTransformer() throws Exception {
        TLValueWithAttributes type =
            getValueWithAttributesType( PACKAGE_2_NAMESPACE, "library_1_p2", "SampleValueWithAttributes" );
    ...
    public void testTLValueWithAttributesTransformer() throws Exception {
        ValueWithAttributes type =
            transformValueWithAttributesType( PACKAGE_2_NAMESPACE, "library_1_p2", "SampleValueWithAttributes" );
    ...
    private TLValueWithAttributes getValueWithAttributesType(String namespace, String libraryName, String typeName)
        throws Exception {
    ...
    private ValueWithAttributes transformValueWithAttributesType(String namespace, String libraryName, String typeName)
        throws Exception {
