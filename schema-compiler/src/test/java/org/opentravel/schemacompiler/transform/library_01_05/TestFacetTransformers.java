...
/**
 * Verifies the operation of the transformers that handle conversions to and from <code>TLFacet</code> and
 * <code>TLFacetContextual</code> objects.
 * 
 * @author S. Livezey
 */
public class TestFacetTransformers extends Abstract_1_5_TestTransformers {

    @Test
    public void testFacetTransformer() throws Exception {
        TLFacet facet = getCoreObject( PACKAGE_2_NAMESPACE, "library_1_p2", "SampleCore" ).getSummaryFacet();
    ...
    public void testFacetTransformerIndicators() throws Exception {
        ...
        assertEquals( "indicator2-equivalent",
            facet.getIndicators().get( 1 ).getEquivalents().get( 0 ).getDescription() );
    }
    ...
    public void testFacetTransformerAttributes() throws Exception {
        ...
        assertEquals( 5, facet.getAttributes().size() );
        ...
        assertEquals( "test", facet.getAttributes().get( 2 ).getExamples().get( 0 ).getContext() );
        ...
        assertEquals( "attr4-equivalent", facet.getAttributes().get( 3 ).getEquivalents().get( 0 ).getDescription() );
        ...
        assertEquals( XMLConstants.W3C_XML_SCHEMA_NS_URI, facet.getAttributes().get( 3 ).getType().getNamespace() );
        assertEquals( "int", facet.getAttributes().get( 3 ).getType().getLocalName() );

        assertEquals( "messageId", facet.getAttributes().get( 4 ).getName() );
        assertNotNull( facet.getAttributes().get( 4 ).getExamples() );
        assertEquals( 0, facet.getAttributes().get( 4 ).getExamples().size() );
        assertNotNull( facet.getAttributes().get( 4 ).getEquivalents() );
        assertEquals( 0, facet.getAttributes().get( 4 ).getEquivalents().size() );
        assertEquals( "xsd:ID", facet.getAttributes().get( 4 ).getTypeName() );
        assertEquals( XSDSimpleType.class, facet.getAttributes().get( 4 ).getType().getClass() );
        assertEquals( XMLConstants.W3C_XML_SCHEMA_NS_URI, facet.getAttributes().get( 4 ).getType().getNamespace() );
        assertEquals( "ID", facet.getAttributes().get( 4 ).getType().getLocalName() );
    }
    ...
    public void testFacetTransformerProperties() throws Exception {
        ...
        assertEquals( "test", facet.getElements().get( 2 ).getExamples().get( 0 ).getContext() );
        ...
        assertEquals( "element4-equivalent", facet.getElements().get( 3 ).getEquivalents().get( 0 ).getDescription() );
        ...
        assertEquals( XMLConstants.W3C_XML_SCHEMA_NS_URI, facet.getElements().get( 3 ).getType().getNamespace() );
        ...
        assertEquals( "SampleBusinessObject_Alias1_Detail", facet.getElements().get( 5 ).getTypeName() );
    ...
    public void testFacetContextualTransformer() throws Exception {
        List<TLContextualFacet> facetList =
            getBusinessObject( PACKAGE_2_NAMESPACE, "library_1_p2", "SampleBusinessObject" ).getCustomFacets();
    ...
    public void testTLFacetTransformer() throws Exception {
        Facet facet = transformCoreObject( PACKAGE_2_NAMESPACE, "library_1_p2", "SampleCore" ).getSummary();
    ...
    public void testTLFacetTransformerIndicators() throws Exception {
        ...
        assertEquals( "indicator2-equivalent", facet.getIndicator().get( 1 ).getEquivalent().get( 0 ).getValue() );
    }
    ...
    public void testTLFacetTransformerAttributes() throws Exception {
        ...
        assertEquals( 5, facet.getAttribute().size() );
        ...
        assertEquals( "test", facet.getAttribute().get( 2 ).getExample().get( 0 ).getContext() );
        ...
        assertEquals( "attr4-equivalent", facet.getAttribute().get( 3 ).getEquivalent().get( 0 ).getValue() );
        assertNull( facet.getAttribute().get( 3 ).isMandatory() );
        assertEquals( "xsd:int", facet.getAttribute().get( 3 ).getType() );

        assertEquals( "messageId", facet.getAttribute().get( 4 ).getName() );
        assertNull( facet.getAttribute().get( 4 ).getDocumentation() );
        assertEquals( 0, facet.getAttribute().get( 4 ).getExample().size() );
        assertEquals( 0, facet.getAttribute().get( 4 ).getEquivalent().size() );
        assertNull( facet.getAttribute().get( 4 ).isMandatory() );
        assertEquals( "xsd:ID", facet.getAttribute().get( 4 ).getType() );
    }
    ...
    public void testTLFacetTransformerProperties() throws Exception {
        ...
        assertEquals( "test", facet.getElement().get( 2 ).getExample().get( 0 ).getContext() );
        ...
        assertEquals( "element4-equivalent", facet.getElement().get( 3 ).getEquivalent().get( 0 ).getValue() );
    ...
    public void testTLFacetContextualTransformer() throws Exception {
        List<FacetContextual> facetList =
            transformBusinessObject( PACKAGE_2_NAMESPACE, "library_1_p2", "SampleBusinessObject" ).getCustom();
    ...
    private TLCoreObject getCoreObject(String namespace, String libraryName, String typeName) throws Exception {
        TLLibrary library = getLibrary( namespace, libraryName );

        return (library == null) ? null : library.getCoreObjectType( typeName );
    }

    private CoreObject transformCoreObject(String namespace, String libraryName, String typeName) throws Exception {
        ...
        ObjectTransformer<TLCoreObject,CoreObject,SymbolResolverTransformerContext> transformer =
            factory.getTransformer( origType, CoreObject.class );
