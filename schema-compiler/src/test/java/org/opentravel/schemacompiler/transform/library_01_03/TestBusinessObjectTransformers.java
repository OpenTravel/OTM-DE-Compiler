 ...
 * @author S. Livezey
 */
public class TestBusinessObjectTransformers extends Abstract_1_3_TestTransformers {
	...
	public void testBusinessObjectTransformerAllFacetsPopulated() throws Exception {
		...
		assertEquals(4, type.getAliases().size());
		...
		assertEquals("SampleCustomFacet_Alias", type.getAliases().get(2).getName());
		assertEquals("SampleCustomFacet2_Alias", type.getAliases().get(3).getName());
		...
		assertEquals(1, type.getQueryFacets().size());
	...
	public void testTLBusinessObjectTransformerAllFacetsPopulated() throws Exception {
		...
		assertEquals("SampleCustomFacet_Alias", type.getAliases().get(2));
		assertEquals("SampleCustomFacet2_Alias", type.getAliases().get(3));
		assertNotNull(type.getDocumentation());
		assertNotNull(type.getID());
		assertNotNull(type.getSummary());
		assertNotNull(type.getDetail());
		assertEquals(1, type.getQuery().size());
