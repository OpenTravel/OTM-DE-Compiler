...
/**
 * Verifies the operation of the transformers that handle conversions to <code>XSDLibrary</code> objects.
 * 
 * @author S. Livezey
 */
public class TestXSDLibraryTransformer extends AbstractXSDTestTransformers {
    ...
    public void testXSDLibraryTransformer() throws Exception {
        ...
        assertEquals( "legacy_schema_3.xsd", library.getNamespaceImports().get( 0 ).getFileHints().get( 0 ) );
    }
