 ...
 * @author S. Livezey
 */
public class TestServiceTransformers extends Abstract_1_6_TestTransformers {
    ...
    public void testServiceTransformer() throws Exception {
        ...
        assertEquals("RequestResponseOperation-equivalent", service.getOperations().get(0)
                .getEquivalents().get(0).getDescription());
        ...
        assertEquals("NotificationOperation-equivalent", service.getOperations().get(1)
                .getEquivalents().get(0).getDescription());
    ...
    public void testTLServiceTransformer() throws Exception {
        ...
        assertEquals("RequestResponseOperation-equivalent", service.getOperation().get(0)
                .getEquivalent().get(0).getValue());
        ...
        assertEquals("NotificationOperation-equivalent", service.getOperation().get(1)
                .getEquivalent().get(0).getValue());
    ...
    private Service transformService(String namespace, String libraryName) throws Exception {
        ...
        ObjectTransformer<TLService, Service, SymbolResolverTransformerContext> transformer = factory
                .getTransformer(origService, Service.class);
