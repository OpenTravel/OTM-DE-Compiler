...
public class TestFacetTransformers extends Abstract_1_4_TestTransformers {
	...
	public void testFacetTransformerIndicators() throws Exception {
		...
		assertEquals("indicator2-equivalent", facet.getIndicators().get(1).getEquivalents().get(0).getDescription());
	}
	...
	public void testFacetContextualTransformer() throws Exception {
		List<TLFacet> facetList = getBusinessObject(PACKAGE_2_NAMESPACE, "library_1_p2", "SampleBusinessObject").getCustomFacets();
	...
	public void testTLFacetContextualTransformer() throws Exception {
		List<FacetContextual> facetList = transformBusinessObject(PACKAGE_2_NAMESPACE, "library_1_p2", "SampleBusinessObject").getCustom();
