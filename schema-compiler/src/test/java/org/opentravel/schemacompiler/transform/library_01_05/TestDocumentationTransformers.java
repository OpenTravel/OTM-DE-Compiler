...
/**
 * Verifies the operation of the transformers that handle conversions to and from <code>TLDocumentation</code> objects.
 * 
 * @author S. Livezey
 */
public class TestDocumentationTransformers extends Abstract_1_5_TestTransformers {

    @Test
    public void testDocumentationTransformer() throws Exception {
        TLDocumentation doc =
            getSimpleType( PACKAGE_2_NAMESPACE, "library_2_p2", "SampleDocumentation" ).getDocumentation();
        ...
        assertEquals( "http://www.OpenTravel.org/ns/OTA2/SampleDocumentation/reference/1",
            doc.getReferences().get( 0 ).getText() );
        assertEquals( "http://www.OpenTravel.org/ns/OTA2/SampleDocumentation/reference/2",
            doc.getReferences().get( 1 ).getText() );
        assertEquals( 2, doc.getImplementers().size() );
        assertEquals( "SampleDocumentation-implementer-line_1", doc.getImplementers().get( 0 ).getText() );
        assertEquals( "SampleDocumentation-implementer-line_2", doc.getImplementers().get( 1 ).getText() );
        assertEquals( 2, doc.getMoreInfos().size() );
        assertEquals( "http://www.OpenTravel.org/ns/OTA2/SampleDocumentation/moreInfo/1",
            doc.getMoreInfos().get( 0 ).getText() );
        assertEquals( "http://www.OpenTravel.org/ns/OTA2/SampleDocumentation/moreInfo/2",
            doc.getMoreInfos().get( 1 ).getText() );
    ...
    public void testTLDocumentationTransformer() throws Exception {
        Documentation doc =
            transformSimpleType( PACKAGE_2_NAMESPACE, "library_2_p2", "SampleDocumentation" ).getDocumentation();
        ...
        assertEquals( "http://www.OpenTravel.org/ns/OTA2/SampleDocumentation/reference/1",
            doc.getReference().get( 0 ) );
        assertEquals( "http://www.OpenTravel.org/ns/OTA2/SampleDocumentation/reference/2",
            doc.getReference().get( 1 ) );
        assertEquals( 2, doc.getImplementer().size() );
        assertEquals( 0, doc.getDeveloper().size() );
        assertEquals( "SampleDocumentation-implementer-line_1", doc.getImplementer().get( 0 ).getValue() );
        assertEquals( "SampleDocumentation-implementer-line_2", doc.getImplementer().get( 1 ).getValue() );
