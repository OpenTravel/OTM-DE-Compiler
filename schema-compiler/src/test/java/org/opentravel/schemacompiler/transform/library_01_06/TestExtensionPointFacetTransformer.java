 ...
 * @author S. Livezey
 */
public class TestExtensionPointFacetTransformer extends Abstract_1_6_TestTransformers {

    @Test
    public void testExtensionPointFacetTransformer() throws Exception {
        TLExtensionPointFacet facet = getExtensionPointFacet(PACKAGE_EXT_NAMESPACE,
                "library_3_ext", "ExtensionPoint_CompoundBusinessObject_Summary");
        ...
        assertEquals("CompoundBusinessObject_Summary", facet.getExtension().getExtendsEntity()
                .getLocalName());
        ...
        assertEquals(XMLConstants.W3C_XML_SCHEMA_NS_URI, facet.getAttributes().get(0).getType()
                .getNamespace());
        ...
        assertEquals(XMLConstants.W3C_XML_SCHEMA_NS_URI, facet.getAttributes().get(1).getType()
                .getNamespace());
    ...
    public void testTLExtensionPointFacetTransformer() throws Exception {
        ExtensionPointFacet facet = transformExtensionPointFacet(PACKAGE_EXT_NAMESPACE,
                "library_3_ext", "ExtensionPoint_CompoundBusinessObject_Summary");
    ...
    private ExtensionPointFacet transformExtensionPointFacet(String namespace, String libraryName,
            String extensionPointName) throws Exception {
        TLExtensionPointFacet origExtensionPoint = getExtensionPointFacet(namespace, libraryName,
                extensionPointName);
        ...
        ObjectTransformer<TLExtensionPointFacet, ExtensionPointFacet, SymbolResolverTransformerContext> transformer = factory
                .getTransformer(origExtensionPoint, ExtensionPointFacet.class);
