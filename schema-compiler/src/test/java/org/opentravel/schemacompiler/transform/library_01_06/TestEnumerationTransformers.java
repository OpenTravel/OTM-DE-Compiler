...
/**
 * Verifies the operation of the transformers that handle conversions to and from enumeration library objects.
 * 
 * @author S. Livezey
 */
public class TestEnumerationTransformers extends Abstract_1_6_TestTransformers {
    ...
    public void testTLClosedEnumerationTransformer() throws Exception {
        EnumerationClosed enumType =
            transformClosedEnumeration( PACKAGE_2_NAMESPACE, "library_2_p2", "SampleEnum_Closed" );
    ...
    private TLClosedEnumeration getClosedEnumeration(String namespace, String libraryName, String enumName)
        throws Exception {
    ...
    private EnumerationClosed transformClosedEnumeration(String namespace, String libraryName, String enumName)
        throws Exception {
    ...
    private TLOpenEnumeration getOpenEnumeration(String namespace, String libraryName, String enumName)
        throws Exception {
        TLLibrary library = getLibrary( namespace, libraryName );
    ...
    private EnumerationOpen transformOpenEnumeration(String namespace, String libraryName, String enumName)
        throws Exception {
