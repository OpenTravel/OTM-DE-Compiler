...
public class TestTLResource extends AbstractModelTest {
    ...
    public void testParentRefFunctions() throws Exception {
        ...
        TLParamGroup paramGroup1 =
            addParamGroup( "TestParamGroup1", parentResource1.getBusinessObjectRef().getIdFacet(), parentResource1 );
        TLResource parentResource2 = addResource( "ParentResource2", library1 );
        TLParamGroup paramGroup2 =
            addParamGroup( "TestParamGroup2", parentResource2.getBusinessObjectRef().getIdFacet(), parentResource2 );
        TLResource resource = addResource( "TestResource", library1 );
        ...
        resource.sortParentRefs(
            (p1, p2) -> p1.getParentResource().getName().compareTo( p2.getParentResource().getName() ) );
        assertArrayEquals( new String[] {"ParentResource1", "ParentResource2"},
            getNames( resource.getParentRefs(), p -> p.getParentResource().getName() ) );
    ...
    public void testParamGroupFunctions() throws Exception {
        TLResource resource = addResource( "TestResource", library1 );
        TLParamGroup paramGroup1 =
            addParamGroup( "ParamGroup1", resource.getBusinessObjectRef().getIdFacet(), resource );
        TLParamGroup paramGroup2 =
            addParamGroup( "ParamGroup2", resource.getBusinessObjectRef().getIdFacet(), resource );

        assertArrayEquals( new String[] {"ParamGroup1", "ParamGroup2"},
            getNames( resource.getParamGroups(), p -> p.getName() ) );

        resource.moveDown( paramGroup1 );
        assertArrayEquals( new String[] {"ParamGroup2", "ParamGroup1"},
            getNames( resource.getParamGroups(), p -> p.getName() ) );
    ...
    public void testActionFacetFunctions() throws Exception {
        TLResource resource = addResource( "TestResource", library1 );
        TLActionFacet actionFacet1 =
            addActionFacet( "ActionFacet1", TLReferenceType.OPTIONAL, "Summary", 0, null, resource );
        TLActionFacet actionFacet2 =
            addActionFacet( "ActionFacet2", TLReferenceType.REQUIRED, "Summary", 0, null, resource );

        assertArrayEquals( new String[] {"ActionFacet1", "ActionFacet2"},
            getNames( resource.getActionFacets(), p -> p.getName() ) );

        resource.moveDown( actionFacet1 );
        assertArrayEquals( new String[] {"ActionFacet2", "ActionFacet1"},
            getNames( resource.getActionFacets(), p -> p.getName() ) );
    ...
    public void testActionFunctions() throws Exception {
        ...
        assertArrayEquals( new String[] {"Action1", "Action2"},
            getNames( resource.getActions(), a -> a.getActionId() ) );

        resource.moveDown( action1 );
        assertArrayEquals( new String[] {"Action2", "Action1"},
            getNames( resource.getActions(), a -> a.getActionId() ) );
