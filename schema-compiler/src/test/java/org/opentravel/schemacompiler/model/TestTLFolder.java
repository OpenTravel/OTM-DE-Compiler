...
public class TestTLFolder extends AbstractModelTest {
    ...
    public void testFolderStructure() throws Exception {
        ...
        testNegativeCase( parentFolder1, f -> childFolder1.setName( childFolder2.getName() ),
        ...
        testNegativeCase( parentFolder1, f -> childFolder1.addFolder( library2Folder ),
            IllegalArgumentException.class );
        testNegativeCase( parentFolder1, f -> parentFolder1.addFolder( duplicateChild ),
            IllegalArgumentException.class );

        testNegativeCase( parentFolder1, f -> childFolder1.addEntity( null ), IllegalArgumentException.class );
        testNegativeCase( parentFolder1, f -> childFolder1.addEntity( new TLService() ),
            IllegalArgumentException.class );
