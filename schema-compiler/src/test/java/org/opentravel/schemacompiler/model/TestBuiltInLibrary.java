...
public class TestBuiltInLibrary extends AbstractModelTest {
    ...
    public void testUnsupportedOperations() throws Exception {
        ...
        testNegativeCase( library, l -> library.addNamespaceImport( null, null, null ),
            UnsupportedOperationException.class );
        testNegativeCase( library, l -> library.removeNamespaceImport( (TLNamespaceImport) null ),
            UnsupportedOperationException.class );
        testNegativeCase( library, l -> library.removeNamespaceImport( (String) null ),
            UnsupportedOperationException.class );
        testNegativeCase( library, l -> library.moveUp( (TLNamespaceImport) null ),
            UnsupportedOperationException.class );
        testNegativeCase( library, l -> library.moveDown( (TLNamespaceImport) null ),
            UnsupportedOperationException.class );
