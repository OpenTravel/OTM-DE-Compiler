...
/**
 * Validates the operation of the <code>ChildEntityListManagerComponent</code> using a list of
 * <code>TLAlias</code> elements as the underlying child implementation.
 * 
 * @author S. Livezey
 */
public class TestChildEntityListManager {
    ...
    public void testAddChildAtIndex() throws Exception {
        ...
        assertAliasNames(detailAliases, "CoreAlias_1_Detail", "CoreAlias_3_Detail",
                "CoreAlias_2_Detail");
