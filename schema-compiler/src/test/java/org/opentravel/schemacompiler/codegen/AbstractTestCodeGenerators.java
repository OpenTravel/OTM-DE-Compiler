...
public abstract class AbstractTestCodeGenerators {
    ...
    protected CodeGenerationContext getContext() {
        ...
        context.setValue(CodeGenerationContext.CK_OUTPUT_FOLDER, System.getProperty("user.dir")
                + "/target/codegen-output");
        context.setValue(CodeGenerationContext.CK_SERVICE_ENDPOINT_URL,
                "http://www.OpenTravel.org/services");
        return context;
    }
