...
public class TestResourceFilenameBuilders {
	...
	private TLModel createTestModel(boolean includeDuplicateLibraryNames,
			boolean includeDuplicateResourceNames) throws Exception {
	...
	private TLLibrary createLibrary(String namespace, String name, String prefix, 
