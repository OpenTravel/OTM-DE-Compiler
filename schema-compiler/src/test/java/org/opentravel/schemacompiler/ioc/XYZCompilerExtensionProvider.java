...
/**
 * Implementation of the <code>CompilerExtensionProvider</code> service that provides extensions
 * used for unit/integration testing purposes.
 */
    ...
    static {
        try {
            ...
            registerBindingStyle(extensions, urlMap,
            		XYZ_COMPILER_EXTENSION_ID, 100,
                    "/test-context/xyzBaseCompilerExtensions.xml",
