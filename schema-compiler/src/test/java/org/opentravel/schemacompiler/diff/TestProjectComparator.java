...
/**
 * Verifies the operation of the <code>ProjectComparator</code> and its
...
public class TestProjectComparator extends AbstractDiffTest {
    ...
    protected Project loadProject(String projectPath) throws Exception {
        return projectManager.loadProject( new File(
                SchemaCompilerTestUtils.getBaseLibraryLocation() + projectPath ) );
    }
