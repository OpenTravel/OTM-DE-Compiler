...
public class TestValidationFindings {
    ...
    private static final String TEST_WARNING_KEY =
        "org.opentravel.schemacompiler.TLBusinessObject.name.PATTERN_MISMATCH";
    ...
    public void testGetValidationMessages() throws Exception {
        ...
        String[] errorMessages =
            findings.getValidationMessages( FindingType.ERROR, FindingMessageFormat.IDENTIFIED_FORMAT );
        String[] sourceMessages = findings.getValidationMessages( testSource, FindingMessageFormat.IDENTIFIED_FORMAT );
        String[] sourceErrorMessages =
            findings.getValidationMessages( testSource, FindingType.ERROR, FindingMessageFormat.IDENTIFIED_FORMAT );
