...
public class TestTLContextualFacetCompileValidator extends AbstractValidatorTest {
    ...
    public void testMultipleIdDeclarations() throws Exception {
        TLContextualFacet facet =
            getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestChoice_ChoiceB", TLContextualFacet.class );
    ...
    public void testInvalidFacetType() throws Exception {
        TLContextualFacet choiceFacet =
            getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestChoice_ChoiceB", TLContextualFacet.class );
        TLContextualFacet childFacet =
            getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestChoice_ChoiceA_Child", TLContextualFacet.class );
        TLContextualFacet boFacet =
            getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestBusinessObject_Query_TestQuery", TLContextualFacet.class );
    ...
    public void testCircularFacetReference() throws Exception {
        TLContextualFacet choiceFacet =
            getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestChoice_ChoiceA", TLContextualFacet.class );
        TLContextualFacet childFacet =
            getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestChoice_ChoiceA_Child", TLContextualFacet.class );
