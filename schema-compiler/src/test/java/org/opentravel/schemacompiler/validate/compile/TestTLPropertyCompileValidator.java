...
public class TestTLPropertyCompileValidator extends AbstractValidatorTest {
    ...
    public void testInvalidReferenceName() throws Exception {
        TLProperty element = getMember( TLIBRARY_ERROR1_V1, "TestCore|@FACET:SUMMARY|TestBusinessObject", TLProperty.class );
    ...
    public void testInvalidIdLocation() throws Exception {
        ...
        TLProperty choiceElement = getMember( TLIBRARY_ERROR1_V1, "@CONTEXTUAL:TestChoice_ChoiceA|choiceAId", TLProperty.class );
        TLProperty boElement = getMember( TLIBRARY_ERROR1_V1, "TestBusinessObject|@FACET:DETAIL|detailId", TLProperty.class );
    ...
    public void testIllegalListFacetReference() throws Exception {
        TLProperty element = getMember( TLIBRARY_ERROR1_V1, "TestCore|@FACET:SUMMARY|TargetCoreDetail", TLProperty.class );
        Set<String> messageKeys = getFindingMessageKeys( element );
    ...
    public void testIllegalRequiredMinorVersionElement() throws Exception {
        TLProperty element = getMember( TLIBRARY_ERROR1_V1_1, "TestCore|@FACET:SUMMARY|TestEclipse2", TLProperty.class );
        Set<String> messageKeys = getFindingMessageKeys( element );
