...
public class TestTLExampleCompileValidator extends AbstractValidatorTest {
    ...
    public void testIllegalExampleContext() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "ExampleCore|@FACET:SUMMARY|attrInvalidContext", TLAttribute.class );
    ...
    public void testInvalidDate() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "ExampleCore|@FACET:SUMMARY|attrInvalidDate", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute.getExamples().get( 0 ) );
    ...
    public void testInvalidTime() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "ExampleCore|@FACET:SUMMARY|attrInvalidTime", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute.getExamples().get( 0 ) );
    ...
    public void testInvalidDateTime() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "ExampleCore|@FACET:SUMMARY|attrInvalidDateTime", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute.getExamples().get( 0 ) );
