...
public class TestTLAttributeCompileValidator extends AbstractValidatorTest {
    ...
    public void testEmptyFacetReference() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "TestBusinessObject|@FACET:DETAIL|testCoreSimple", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute );
    ...
    public void testIllegalListFacetRepeat() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "TestCore|@FACET:SUMMARY|cwrRepeatRef", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute );
    ...
    public void testIllegalOpenEnumAttribute() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "TestCore|@FACET:SUMMARY|openEnumAttr", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute );
    ...
    public void testBooleanAttribute() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "TestCore|@FACET:SUMMARY|booleanAttr", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute );
    ...
    public void testIllegalSimpleCoreAttribute() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1, "TargetCore|@FACET:DETAIL|nonSimpleCoreAttr", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute );
    ...
    public void testIllegalRequiredMinorVersionAttribute() throws Exception {
        TLAttribute attribute =
            getMember( TLIBRARY_ERROR1_V1_1, "TestCore|@FACET:SUMMARY|testEclipseAttr1", TLAttribute.class );
        Set<String> messageKeys = getFindingMessageKeys( attribute );
