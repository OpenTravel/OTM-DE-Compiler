...
/**
 * Base class for all validator tests that pre-loads a model containing known
 * errors to be used for verification.
 */
public abstract class AbstractValidatorTest {
    
    private static boolean DEBUG = false;
    
    protected static final QName TLIBRARY_ERROR1_V1   = new QName( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package-error1/v1", "library_error1" );
    protected static final QName TLIBRARY_ERROR1_V1_1 = new QName( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package-error1/v1_1", "library_error1" );
    ...
    public static void setupModel() throws Exception {
        LibraryInputSource<InputStream> libraryInput = new LibraryStreamInputSource(
                new File( SchemaCompilerTestUtils.getBaseLibraryLocation() + "/test-package-errors/library_error1_v1_1.xml" ) );
