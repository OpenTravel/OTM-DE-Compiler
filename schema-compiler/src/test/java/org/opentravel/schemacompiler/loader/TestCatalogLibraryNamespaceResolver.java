...
public class TestCatalogLibraryNamespaceResolver {
    ...
    public void testNamespaceUrlLookup() throws Exception {
        ...
        assertTrue( namespace1Urls
            .contains( URLUtils.toURL( new File( catalogFolder, "/test-package_v1/library_1_p1.xml" ) ) ) );
        assertTrue( namespace1Urls
            .contains( URLUtils.toURL( new File( catalogFolder, "/test-package_v1/library_2_p1.xml" ) ) ) );

        assertTrue( namespace2Urls
            .contains( URLUtils.toURL( new File( catalogFolder, "/test-package_v2/library_1_p2.xml" ) ) ) );
        assertTrue( namespace2Urls
            .contains( URLUtils.toURL( new File( catalogFolder, "/test-package_v2/library_2_p2.xml" ) ) ) );
