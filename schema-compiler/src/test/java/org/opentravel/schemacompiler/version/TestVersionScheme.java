...
public class TestVersionScheme {
    ...
    public void testGetBaseNamespace_OTA2() throws Exception {
        VersionScheme scheme = VersionSchemeFactory.getInstance().getVersionScheme(
        ...
        assertEquals("http://www.OpenTravel.org/ns/OTA2/Common",
                scheme.getBaseNamespace(namespace1));
    ...
    public void testVersionChain_MinorVersion() throws Exception {
        ...
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_2",
                versionChain.get(0));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_1",
                versionChain.get(1));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5",
                versionChain.get(2));
    }
    ...
    public void testVersionChain_PatchVersion() throws Exception {
        ...
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_2_3",
                versionChain.get(0));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_2_2",
                versionChain.get(1));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_2_1",
                versionChain.get(2));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_2",
                versionChain.get(3));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v5_1",
    ...
    public void testVersionChain_PaddedUriVersionNumbers() throws Exception {
        ...
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02_01",
                versionChain.get(2));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02",
                versionChain.get(3));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_01",
                versionChain.get(4));
        assertEquals("http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05",
                versionChain.get(5));
    }
    ...
    public void testDefaultFileHint() throws Exception {
        ...
        assertEquals("TestLibrary_5_2_3.otm", scheme.getDefaultFileHint(
                "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02_03",
                "TestLibrary"));
        assertEquals("TestLibrary_5_2_0.otm", scheme.getDefaultFileHint(
                "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05_02",
                "TestLibrary"));
        assertEquals("TestLibrary_5_0_0.otm", scheme.getDefaultFileHint(
                "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05", "TestLibrary"));
        assertEquals("Test_Library_5_0_0.otm",
                scheme.getDefaultFileHint(
                        "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/test-package/v05",
                        "Test Library"));
    }
