...
public class TestMajorVersionHelper extends AbstractVersionHelperTests {
    ...
    public void testNewMajorLibraryVersion_fromMajorVersion() throws Exception {
        ...
        assertEquals(majorVersionLibrary.getBaseNamespace(),
                newMajorVersionLibrary.getBaseNamespace());
    ...
    public void testNewMajorLibraryVersion_fromMinorVersion() throws Exception {
        TLModel model = loadTestModel(FILE_VERSION_1_2_2, FILE_VERSION_1_0_1);
        TLLibrary minorVersionLibrary = (TLLibrary) model.getLibrary(NS_VERSION_1_1,
                TEST_LIBRARY_NAME);
        File newVersionLibraryFile = purgeExistingFile(new File(System.getProperty("user.dir"),
                "/target/test-save-location/library_v02_00.otm"));
        MajorVersionHelper helper = new MajorVersionHelper();
    ...
    public void testNewMajorLibraryVersion_fromPatchVersion() throws Exception {
        ...
        TLLibrary newMajorVersionLibrary = helper.createNewMajorVersion(patchVersionLibrary,
                newVersionLibraryFile);

        assertNotNull(newMajorVersionLibrary);
        assertEquals("2.0.0", newMajorVersionLibrary.getVersion());
        assertEquals(patchVersionLibrary.getName(), newMajorVersionLibrary.getName());
        assertEquals(patchVersionLibrary.getBaseNamespace(),
                newMajorVersionLibrary.getBaseNamespace());
    ...
    private void validateLibraryContents(TLLibrary newMajorVersionLibrary) throws Exception {
        ...
        TLValueWithAttributes lookupVWA = newMajorVersionLibrary
        ...
        assertContainsAttributes(lookupBO.getSummaryFacet(), "extBOAttribute121",
                "extBOAttribute122");
        ...
        assertContainsAttributes(lookupCore.getSummaryFacet(), "extCoreAttribute121",
                "extCoreAttribute122");
        ...
        assertContainsAttributes(lookupOp.getRequest(), "extOperationAttribute121",
                "extOperationAttribute122");
        assertContainsElements(lookupOp.getRequest(), "RequestValue1", "RequestValue11",
                "RequestValue12");

        // Validate the 'LaterMinorVersion...' grouping
        TLBusinessObject laterMinorVersionBO = newMajorVersionLibrary
                .getBusinessObjectType("LaterMinorVersionBO");
        TLCoreObject laterMinorVersionCore = newMajorVersionLibrary
                .getCoreObjectType("LaterMinorVersionCore");
        TLValueWithAttributes laterMinorVersionVWA = newMajorVersionLibrary
                .getValueWithAttributesType("LaterMinorVersionVWA");
        TLOperation laterMinorVersionOp = newMajorVersionLibrary.getService().getOperation(
        ...
        TLBusinessObject minorVersionTestBO = newMajorVersionLibrary
                .getBusinessObjectType("MinorVersionTestBO");
        TLCoreObject minorVersionTestCore = newMajorVersionLibrary
                .getCoreObjectType("MinorVersionTestCore");
        TLValueWithAttributes minorVersionTestVWA = newMajorVersionLibrary
                .getValueWithAttributesType("MinorVersionTestVWA");
        TLOperation minorVersionTestOp = newMajorVersionLibrary.getService().getOperation(
        ...
        TLOperation patchTestOp = newMajorVersionLibrary.getService().getOperation(
                "PatchTestOperation");
