...
public class TestNonLocalContextualFacets extends AbstractVersionHelperTests {
    ...
    public void testNonLocalContextualFacetRollups() throws Exception {
        ...
        File newVersionFacet1LibraryFile = purgeExistingFile(
            new File( System.getProperty( "user.dir" ), "/target/test-save-location/facets1_v02_00.otm" ) );
        File newVersionFacet2LibraryFile = purgeExistingFile(
            new File( System.getProperty( "user.dir" ), "/target/test-save-location/facets2_v02_00.otm" ) );
        ...
        TLLibrary newVersionFacet1Library =
            helper.createNewMajorVersion( origFacet1Library, newVersionFacet1LibraryFile );
        TLLibrary newVersionFacet2Library =
            helper.createNewMajorVersion( origFacet2Library, newVersionFacet2LibraryFile );
        ...
        TLContextualFacet origChoiceANonLocal1 =
            getChildFacet( origChoiceA, "LookupChoice_ChoiceA_NonLocal1", origFacet1Library );
        TLContextualFacet origChoiceBNonLocal2 =
            getChildFacet( origChoiceB, "LookupChoice_ChoiceB_NonLocal2", origFacet1Library );
        TLContextualFacet newChoiceANonLocal1 =
            getChildFacet( origChoiceA, "LookupChoice_ChoiceA_NonLocal1", newVersionFacet1Library );
        TLContextualFacet newChoiceBNonLocal2 =
            getChildFacet( origChoiceB, "LookupChoice_ChoiceB_NonLocal2", newVersionFacet1Library );
        ...
        TLContextualFacet origChoiceANonLocal1a =
            getChildFacet( origChoiceANonLocal1, "LookupChoice_ChoiceA_NonLocal1_NonLocal1a", origFacet2Library );
        TLContextualFacet origChoiceBNonLocal2a =
            getChildFacet( origChoiceBNonLocal2, "LookupChoice_ChoiceB_NonLocal2_NonLocal2a", origFacet2Library );
        TLContextualFacet newChoiceANonLocal1a =
            getChildFacet( origChoiceANonLocal1, "LookupChoice_ChoiceA_NonLocal1_NonLocal1a", newVersionFacet2Library );
        TLContextualFacet newChoiceBNonLocal2a =
            getChildFacet( origChoiceBNonLocal2, "LookupChoice_ChoiceB_NonLocal2_NonLocal2a", newVersionFacet2Library );
