...
public class TestMinorVersionHelper extends AbstractVersionHelperTests {
    ...
    public void testGetPriorVersionExtension() throws Exception {
        ...
        TLClosedEnumeration currentVersionClosedEnum =
            minorVersionLibrary.getClosedEnumerationType( "LookupClosedEnum" );
    ...
    public void testGetEligibleMinorVersionTargets() throws Exception {
        TLModel model = loadTestModel( FILE_VERSION_1_2_2 );
        File libraryFile13 = purgeExistingFile(
            new File( System.getProperty( "user.dir" ), "/target/test-save-location/library_v01_03.otm" ) );
        MinorVersionHelper helper = new MinorVersionHelper();
        ...
        TLValueWithAttributes minorVersionVWA =
            minorVersionLibrary10.getValueWithAttributesType( "LaterMinorVersionVWA" );
        TLOperation minorVersionOp = minorVersionLibrary10.getService().getOperation( "LaterMinorVersionOperation" );
        TLOpenEnumeration minorVersionOpenEnum =
            minorVersionLibrary10.getOpenEnumerationType( "LaterMinorVersionOpenEnum" );
        TLClosedEnumeration minorVersionClosedEnum =
            minorVersionLibrary10.getClosedEnumerationType( "LaterMinorVersionClosedEnum" );
    ...
    public void testGetPreferredMinorVersionTarget() throws Exception {
        TLModel model = loadTestModel( FILE_VERSION_1_2_2 );
        File patchLibraryFile = purgeExistingFile(
            new File( System.getProperty( "user.dir" ), "/target/test-save-location/library_v01_03.otm" ) );
        MinorVersionHelper helper = new MinorVersionHelper();
    ...
    public void testNewMinorLibraryVersion() throws Exception {
        ...
        assertContainsAttributes( newMinorVersionChoice.getSharedFacet(), "extChoiceAttribute121",
            "extChoiceAttribute122" );
    ...
    public void testNewMinorVersion_noRollup() throws Exception {
        ...
        TLChoiceObject existingMinorVersionChoice =
            minorVersionLibrary11.getChoiceObjectType( "MinorVersionTestChoice" );
        TLValueWithAttributes existingMinorVersionVWA =
            minorVersionLibrary11.getValueWithAttributesType( "MinorVersionTestVWA" );
        TLOperation existingMinorVersionOp =
            minorVersionLibrary11.getService().getOperation( "MinorVersionTestOperation" );
        TLOpenEnumeration existingMinorVersionOpenEnum =
            minorVersionLibrary11.getOpenEnumerationType( "MinorVersionTestOpenEnum" );
        TLClosedEnumeration existingMinorVersionClosedEnum =
            minorVersionLibrary11.getClosedEnumerationType( "MinorVersionTestClosedEnum" );
        ...
        TLBusinessObject newMinorVersionBO =
            helper.createNewMinorVersion( existingMinorVersionBO, minorVersionLibrary12 );
        TLCoreObject newMinorVersionCore =
            helper.createNewMinorVersion( existingMinorVersionCore, minorVersionLibrary12 );
        TLChoiceObject newMinorVersionChoice =
            helper.createNewMinorVersion( existingMinorVersionChoice, minorVersionLibrary12 );
        TLValueWithAttributes newMinorVersionVWA =
            helper.createNewMinorVersion( existingMinorVersionVWA, minorVersionLibrary12 );
        TLOperation newMinorVersionOp = helper.createNewMinorVersion( existingMinorVersionOp, minorVersionLibrary12 );
        TLOpenEnumeration newMinorVersionOpenEnum =
            helper.createNewMinorVersion( existingMinorVersionOpenEnum, minorVersionLibrary12 );
        TLClosedEnumeration newMinorVersionClosedEnum =
            helper.createNewMinorVersion( existingMinorVersionClosedEnum, minorVersionLibrary12 );
        TLSimple newMinorVersionSimple =
            helper.createNewMinorVersion( existingMinorVersionSimple, minorVersionLibrary12 );
        TLResource newMinorVersionResource =
            helper.createNewMinorVersion( existingMinorVersionResource, minorVersionLibrary12 );
    ...
    public void testNewMinorVersion_laterMinorVersion_withRollup() throws Exception {
        ...
        TLValueWithAttributes firstMinorVersionVWA =
            minorVersionLibrary10.getValueWithAttributesType( "LaterMinorVersionVWA" );
        TLOperation firstMinorVersionOp =
            minorVersionLibrary10.getService().getOperation( "LaterMinorVersionOperation" );
        TLOpenEnumeration firstMinorVersionOpenEnum =
            minorVersionLibrary10.getOpenEnumerationType( "LaterMinorVersionOpenEnum" );
        TLClosedEnumeration firstMinorVersionClosedEnum =
            minorVersionLibrary10.getClosedEnumerationType( "LaterMinorVersionClosedEnum" );
        ...
        TLValueWithAttributes laterMinorVersionVWA =
            minorVersionLibrary12.getValueWithAttributesType( "LaterMinorVersionVWA" );
        TLOperation laterMinorVersionOp =
            minorVersionLibrary12.getService().getOperation( "LaterMinorVersionOperation" );
        TLOpenEnumeration laterMinorVersionOpenEnum =
            minorVersionLibrary12.getOpenEnumerationType( "LaterMinorVersionOpenEnum" );
        TLClosedEnumeration laterMinorVersionClosedEnum =
            minorVersionLibrary12.getClosedEnumerationType( "LaterMinorVersionClosedEnum" );
        ...
        TLChoiceObject newMinorVersionChoice =
            helper.createNewMinorVersion( firstMinorVersionChoice, minorVersionLibrary11 );
        TLValueWithAttributes newMinorVersionVWA =
            helper.createNewMinorVersion( firstMinorVersionVWA, minorVersionLibrary11 );
        TLOperation newMinorVersionOp = helper.createNewMinorVersion( firstMinorVersionOp, minorVersionLibrary11 );
        TLOpenEnumeration newMinorVersionOpenEnum =
            helper.createNewMinorVersion( firstMinorVersionOpenEnum, minorVersionLibrary11 );
        TLClosedEnumeration newMinorVersionClosedEnum =
            helper.createNewMinorVersion( firstMinorVersionClosedEnum, minorVersionLibrary11 );
        TLSimple newMinorVersionSimple = helper.createNewMinorVersion( firstMinorVersionSimple, minorVersionLibrary11 );
        TLResource newMinorVersionResource =
            helper.createNewMinorVersion( firstMinorVersionResource, minorVersionLibrary11 );
    ...
    public void patchRollupDuplicatedVWAType()
        ...
        // then
        ValidationFindings findings = TLModelCompileValidator.validateModelElement( majorV100, false );
        assertFalse( findings.hasFinding() );
    }
    ...
    public void testRollupPatchVersion() throws Exception {
        ...
        File newVersionLibraryFile = purgeExistingFile(
            new File( System.getProperty( "user.dir" ), "/target/test-save-location/library_v01_02.otm" ) );
        MinorVersionHelper helper = new MinorVersionHelper();
