...
public class TestEventPublication extends AbstractModelEventTests {
	...
	public void testPublishEvent_sameEvent_sameSourceObject() throws Exception {
		CapturingEventListener<ValueChangeEvent<TLLibrary,String>,TLLibrary> listener =
				new CapturingEventListener<ValueChangeEvent<TLLibrary,String>,TLLibrary>(ValueChangeEvent.class, TLLibrary.class);
		...
		try {
			...
			assertEquals(ModelEventType.COMMENTS_MODIFIED, listener.getCapturedEvents().get(0).getType());
	...
	public void testPublishEvent_sameEvent_subclassSourceObject() throws Exception {
		CapturingEventListener<ValueChangeEvent<AbstractLibrary,String>,AbstractLibrary> listener =
				new CapturingEventListener<ValueChangeEvent<AbstractLibrary,String>,AbstractLibrary>(ValueChangeEvent.class, AbstractLibrary.class);
		TLLibrary library = (TLLibrary) testModel.getLibrary(PACKAGE_2_NAMESPACE, "library_1_p2");
		String oldComments = library.getComments();
		String newComments = "library_1_p2:newComments";
	...
	public void testPublishEvent_subclassEvent_sameSourceObject() throws Exception {
		CapturingEventListener<ModelEvent<TLLibrary>,TLLibrary> listener =
				new CapturingEventListener<ModelEvent<TLLibrary>,TLLibrary>(ModelEvent.class, TLLibrary.class);
		TLLibrary library = (TLLibrary) testModel.getLibrary(PACKAGE_2_NAMESPACE, "library_1_p2");
		String oldComments = library.getComments();
		String newComments = "library_1_p2:newComments";
	...
	public void testPublishEvent_differentEvent_sameSourceObject() throws Exception {
		CapturingEventListener<OwnershipEvent<TLLibrary,String>,TLLibrary> listener =
				new CapturingEventListener<OwnershipEvent<TLLibrary,String>,TLLibrary>(OwnershipEvent.class, String.class);
		TLLibrary library = (TLLibrary) testModel.getLibrary(PACKAGE_2_NAMESPACE, "library_1_p2");
		String oldComments = library.getComments();
		String newComments = "library_1_p2:newComments";
		...
		try {
			testModel.addListener(listener);
			library.setComments(newComments);
			assertEquals(0, listener.getCapturedEvents().size()); // listener does not respond to this event
	...
	public void testPublishEvent_sameEvent_differentSourceObject() throws Exception {
		CapturingEventListener<ValueChangeEvent<TLSimple,String>,TLSimple> listener =
				new CapturingEventListener<ValueChangeEvent<TLSimple,String>,TLSimple>(ValueChangeEvent.class, TLSimple.class);
		TLLibrary library = (TLLibrary) testModel.getLibrary(PACKAGE_2_NAMESPACE, "library_1_p2");
		String oldComments = library.getComments();
		String newComments = "library_1_p2:newComments";
	...
	public void testEventFilter_constrainEventType() throws Exception {
		CapturingEventListener<ValueChangeEvent<TLSimple,String>,TLSimple> listener =
				new CapturingEventListener<ValueChangeEvent<TLSimple,String>,TLSimple>(ValueChangeEvent.class, TLSimple.class);
		DefaultModelEventFilter<ValueChangeEvent<TLSimple,String>,TLSimple> filteredListener =
				new DefaultModelEventFilter<ValueChangeEvent<TLSimple,String>,TLSimple>(listener);
		...
		try {
			...
			assertEquals(1, listener.getCapturedEvents().size()); // listener only responds to one of the two events
			assertEquals(ModelEventType.PATTERN_MODIFIED, listener.getCapturedEvents().get(0).getType());
	...
	public void testEventFilter_constrainSourceObjectType() throws Exception {
		CapturingEventListener<ValueChangeEvent<TLModelElement,String>,TLModelElement> listener =
				new CapturingEventListener<ValueChangeEvent<TLModelElement,String>,TLModelElement>(ValueChangeEvent.class, TLModelElement.class);
		DefaultModelEventFilter<ValueChangeEvent<TLModelElement,String>,TLModelElement> filteredListener =
				new DefaultModelEventFilter<ValueChangeEvent<TLModelElement,String>,TLModelElement>(listener);
