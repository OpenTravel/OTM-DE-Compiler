...
public class TestIntegrityCheckers extends AbstractModelEventTests {
    ...
    public void testTypeAssignmentChangeIntegrityChecker() throws Exception {
        ...
        TLLibrary library1p1 = (TLLibrary) testModel
                .getLibrary(PACKAGE_1_NAMESPACE, "library_1_p1");
        TLLibrary library1p2 = (TLLibrary) testModel
                .getLibrary(PACKAGE_2_NAMESPACE, "library_1_p2");
        TLLibrary library2p2 = (TLLibrary) testModel
                .getLibrary(PACKAGE_2_NAMESPACE, "library_2_p2");
        ...
        try {
            ...
            assertImportsNamespace(library2p2, PACKAGE_1_NAMESPACE,
                    "../test-package_v1/library_2_p1.xml");
            assertDoesNotImportFileHint(library2p2, PACKAGE_1_NAMESPACE,
    ...
    public void testNamespaceChangeIntegrityChecker() throws Exception {
        ModelEventListener<?, ?> listener = new ModelIntegrityChecker();
        TLLibrary library2p1 = (TLLibrary) testModel
                .getLibrary(PACKAGE_1_NAMESPACE, "library_2_p1");
        TLLibrary library2p2 = (TLLibrary) testModel
                .getLibrary(PACKAGE_2_NAMESPACE, "library_2_p2");
        try {
            testModel.addListener(listener);
