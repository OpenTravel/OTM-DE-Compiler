...
public class TestProjectManager {
    ...
    public void testAddProjectDependencyViaTypeAssignment() throws Exception {
        ...
        TLLibrary library2p2 = (TLLibrary) projectManager.getModel().getLibrary(
                PACKAGE_2_NAMESPACE, "library_2_p2");
        TLLibrary sampleLibrary = (TLLibrary) projectManager.getModel().getLibrary(
                PACKAGE_3_NAMESPACE, "sample_library");
