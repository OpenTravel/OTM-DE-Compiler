...
public class TestCliMain {
    ...
    private static final File baseOutputFolder = new File( System.getProperty( "user.dir" ), "/target/test-output" );
    ...
    protected String executeCli(File libraryFile, File outputFolder, String bindingStyle) throws Exception {
        ...
        cliMain.setOutput( streamOut );
        cliMain.execute(
            new String[] {"-d", outputFolder.getAbsolutePath(), "-b", bindingStyle, libraryFile.getAbsolutePath()} );
        streamOut.flush();
