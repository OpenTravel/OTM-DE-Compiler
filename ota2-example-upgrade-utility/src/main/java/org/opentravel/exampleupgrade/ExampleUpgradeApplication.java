 ...
 */
public class ExampleUpgradeApplication extends javafx.application.Application {
	...
	public void start(Stage primaryStage) {
		try {
			FXMLLoader loader = new FXMLLoader( ExampleUpgradeApplication.class.getResource(
					ExampleUpgradeController.FXML_FILE ) );
			Parent root = loader.load();
			ExampleUpgradeController controller = loader.getController();
			UserSettings userSettings = UserSettings.load();
			
			validateWindowLocation( userSettings );
			primaryStage.setTitle("OTM-DE Example Upgrade Utility");
