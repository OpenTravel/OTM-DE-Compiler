...
public class Utils {
	...
	protected static final Image infoIcon = new Image( Utils.class.getResourceAsStream( "/images/info.gif" ) );
	protected static final Image warningIcon = new Image( Utils.class.getResourceAsStream( "/images/warning.gif" ) );
	protected static final Image errorIcon = new Image( Utils.class.getResourceAsStream( "/images/error.gif" ) );
