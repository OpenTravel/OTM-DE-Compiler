 ...
 */
public class OTMReleaseApplication extends javafx.application.Application {
	...
	public void start(Stage primaryStage) {
		try {
			FXMLLoader loader = new FXMLLoader( OTMReleaseApplication.class.getResource(
					OTMReleaseController.FXML_FILE ) );
			Parent root = loader.load();
			OTMReleaseController controller = loader.getController();
			UserSettings userSettings = UserSettings.load();
			
			validateWindowLocation( userSettings );
			primaryStage.setTitle( "OTM Release Editor" );
