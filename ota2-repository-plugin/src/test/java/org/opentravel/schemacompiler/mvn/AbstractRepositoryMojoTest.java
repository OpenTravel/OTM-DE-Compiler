...
public abstract class AbstractRepositoryMojoTest {
    ...
    protected static final File testProjectsFolder =
        new File( System.getProperty( "user.dir" ), "/src/test/resources/test-projects" );
    protected static final File testModelsFolder =
        new File( System.getProperty( "user.dir" ), "/src/test/resources/test-models" );
    protected static final File testRepositoryFolder =
        new File( System.getProperty( "user.dir" ), "/src/test/resources/test-repository" );
    ...
    protected void validateSnapshotProject(File snapshotFolder) throws Exception {
        ...
        for (JAXBElement<? extends ProjectItemType> itemElement : project.getProjectItemBase()) {
            ...
            Assert.assertTrue( "Snapshot project contains one or more repository-managed libraries.",
