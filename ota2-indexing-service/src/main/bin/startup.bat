...
start /b javaw.exe -Dota2.index.manager.config="%MANAGER_CONFIG%" -Dota2.index.agent.config="%AGENT_CONFIG%" -Dlog4j.configuration="file:/%LOG4J_CONFIG%" %JMX_CONFIG% %PROXY_SETTINGS% -cp ./lib/* org.opentravel.schemacompiler.index.IndexProcessManager %*