...
public class RepositoryComponentFactory {
    ...
    /**
     * Returns the factory that is configured using the default application context file. The
     * default context XML is identified by looking in the following locations:
     * <ol>
     ...
     * <li>Next, the location identified by the system property "<code>ota2.repository.config</code>
     * " is checked</li>
     * <li>If neither of the previous locations contains a valid application context file, the
     * user's current working directory is checked for a file named "
     * <code>ota2-repository-config.xml</code>"</li>
     * </ol>
     * 
     * @return
     */
    ...
    /**
     * Resets the default singleton instance of this factory, allowing the JVM to reconfigure the
    ...
    /**
     * Returns the <code>RepositorySecurityManager</code> as defined in the service configuration
     * file.
     * 
    ...
    private static File findConfigurationFile() {
        ...
        if (System.getProperties().containsKey("catalina.base")) {
            configFile = new File(System.getProperty("catalina.base"), "/conf/"
                    + SERVICE_CONFIGURATION_FILENAME);
