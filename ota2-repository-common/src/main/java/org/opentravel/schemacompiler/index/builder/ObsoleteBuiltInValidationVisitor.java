...
/**
 * Extension of the <code>ObsoleteBuiltInVisitor</code> that loads the <code>OTA_SimpleTypes</code>
 * library from the local classpath rather than a remote repository.
 */
