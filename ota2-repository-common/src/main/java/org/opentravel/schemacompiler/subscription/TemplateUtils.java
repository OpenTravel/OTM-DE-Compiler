...
public class TemplateUtils {
	...
	/**
	 * Returns the display value by performing a resource bundle lookup of the given string.  If
	 * no such key exists in the resource bundle, the original string will be returned.
	 * 
