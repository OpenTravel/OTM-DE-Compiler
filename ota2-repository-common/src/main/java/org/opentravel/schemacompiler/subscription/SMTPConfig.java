...
public class SMTPConfig {
    ...
    /**
     * Returns the flag indicating whether SSL should be enabled when communicating with the SMTP host.
     *
     * @return boolean
     */
    ...
    /**
     * Assigns the flag indicating whether SSL should be enabled when communicating with the SMTP host.
     *
    ...
    /**
     * Returns the flag indicating whether TLS should be enabled when communicating with the SMTP host.
     *
     * @return boolean
     */
    ...
    /**
     * Assigns the flag indicating whether TLS should be enabled when communicating with the SMTP host.
     *
