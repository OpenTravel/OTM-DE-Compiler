...
/**
 * Navigator that traverses all of the library and namespace subscriptions defined
...
public class SubscriptionNavigator {
	...
	/**
	 * Constructor that specifies the <code>RepositoryManager</code> to use when navigating
    ...
    /**
     * If a subscription list with the given characteristics exists, load its contents and call
