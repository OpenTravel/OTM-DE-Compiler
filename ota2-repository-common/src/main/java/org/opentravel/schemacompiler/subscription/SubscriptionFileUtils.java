...
public class SubscriptionFileUtils {
     ...
     */
    public SubscriptionFileUtils(RepositoryManager manager) {
        this.manager = manager;
    }
    
    /**
     * Loads the subscription list for the specified base namespace.  If no subscriptions are
     * defined for the namespace, this method will return null.
     * 
    ...
    /**
     * Loads the subscription list for all versions of the specified repository item.  If no
     * such subscriptions are defined for the item, this method will return null.
     * 
    ...
    /**
     * Loads the subscription list for this specific version of the repository item.  If no
     * such subscriptions are defined for the item, this method will return null.
     * 
    ...
    /**
     * Saves the given subscription list to its appropriate file location and adds it to the
     * current change set of the file manager.
     * 
    ...
    public void saveSubscriptionList(SubscriptionList subscriptionList) throws IOException {
    	...
    	try {
        	...
        	File sFile = getSubscriptionListFile( target.getBaseNamespace(), target.getLibraryName(), target.getVersion() );
    ...
    static {
        try {
            ...
            InputStream schemaStream = SubscriptionFileUtils.class.getResourceAsStream( REPOSITORY_EXT_SCHEMA_LOCATION );
