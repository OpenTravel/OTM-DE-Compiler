...
public class ByteChunk {
     ...
     * 
     * If -1 or not set, the buffer will grow indefinitely. Can be smaller than the current buffer
     * size ( which will not shrink ). When the limit is reached, the buffer will be flushed ( if
     * out is set ) or throw exception.
     */
    ...
    /**
     * When the buffer is full, write the data to the output channel. Also used when large amount of
     * data is appended.
     * 
    ...
    /**
     * Send the buffer to the sink. Called by append() when the limit is reached. You can also call
     * it explicitly to force the data to be written.
     * 
     * @throws IOException
     */
    ...
    public String toStringInternal() {
        ...
        try {
            ...
            /*
             * Does not improve the speed too much on most systems, it's safer to use the
    ...
    /**
     * Returns the first instance of the given character in this ByteChunk starting at the specified
     * byte. If the character is not found, -1 is returned. <br/>
    ...
    /**
     * Returns the first instance of the given character in the given byte array between the
     * specified start and end. <br/>
     * NOTE: This only works for characters in the range 0-127.
     * 
     * @param bytes
    ...
    /**
     * Returns the first instance of the given byte in the byte array between the specified start
     * and end.
     * 
     * @param bytes
     *            The byte array to search
    ...
    /**
     * Returns the first instance of any of the given bytes in the byte array between the specified
     * start and end.
     * 
     * @param bytes
     *            The byte array to search
    ...
    /**
     * Returns the first instance of any byte that is not one of the given bytes in the byte array
    ...
    /**
     * Convert specified String to a byte array. This ONLY WORKS for ascii, UTF chars will be
     * truncated.
     * 
     * @param value
