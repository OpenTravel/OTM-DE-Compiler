...
/**
 * Base class that provides common methods for all <code>AuthenticationProvider</code> implementations.
 */
public abstract class AbstractAuthenticationProvider implements AuthenticationProvider {
    ...
    /**
     * Validates the given user account information. By default, this method simply enforces that the user ID field is a
     * valid non-null/blank value. Sub-classes may extend to add additional validation criteria.
     * 
    ...
    /**
     * Refreshes the user information from its original source. By default, this method does nothing; sub-classes may
     * override to refresh user account information from a database or remote directory.
     * 
    ...
    /**
     * Refreshes all user accounts from their original source(s). By default, this method does nothing; sub-classes may
     * override to refresh user account information from a database or remote directory.
     */
    ...
    /**
     * Refreshes the memory-resident user registry if necessary. If the refresh was peformed, this method returns true;
     * false if the memory-resident cache was already up-to-date.
     * 
     * @return boolean
     */
            ...
            if (lastModified > userFileLastModified) {
                try {
                    ...
                    JAXBElement<RepositoryUsers> documentElement =
                        (JAXBElement<RepositoryUsers>) FileUtils.unmarshalFileContent( registryFile, unmarshaller );
