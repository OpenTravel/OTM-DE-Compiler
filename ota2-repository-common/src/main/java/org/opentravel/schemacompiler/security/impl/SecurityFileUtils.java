...
/**
 * Utility methods used for loading and saving the contents of security-related files in the OTA2.0 repository.
 * 
 * @author S. Livezey
 */
public class SecurityFileUtils {
     ...
     * 
     * @param file the file from which to load the group assignments
     * @return GroupAssignments
     * @throws IOException thrown if the contents of the file cannot be loaded
     */
     ...
     * 
     * @param file the file to which the group assignments will be saved
     * @param groupAssignments the group assignments to save
     * @throws IOException thrown if the file content cannot be saved
     */
    public void saveGroupAssignments(File file, GroupAssignments groupAssignments) throws IOException {
        saveFile( file, objectFactory.createGroupAssignments( groupAssignments ) );
    }

    /**
     * Returns the filename of the authorization file for the specified namespace. If the 'namespace' parameter is null,
     * the location of the global authorization file will be returned.
     * 
     * <p>
     * NOTE: Even though the file location is returned by this method, the existence of an authorization file is not
     * guaranteed by this method.
     * 
     * @param namespace the namespace for which to return the authorization file location
     * @return File
     * @throws RepositorySecurityException thrown if the location of the authorization file cannot be identified
     */
    public File getAuthorizationFile(String namespace) throws RepositorySecurityException {
        try {
            ...
            if (namespace != null) {
                authorizationFolder = repositoryManager.getFileManager().getNamespaceFolder( namespace, null );
            ...
            throw new RepositorySecurityException( "Unable to identify authorization file for namespace: " + namespace,
                e );
        }
    }
     ...
     * 
     * @param authorizationFile the file from which to load the namespace authorizations
     * @return NamespaceAuthorizations
     * @throws IOException thrown if the contents of the file cannot be loaded
     */
    public NamespaceAuthorizations loadNamespaceAuthorizations(File authorizationFile) throws IOException {
     ...
     * 
     * @param authorizationFile the file to which the namespace authorizations will be saved
     * @param authorizations the namespace authorizations to save
     * @throws IOException thrown if the file content cannot be saved
     */
    public void saveNamespaceAuthorizations(File authorizationFile, NamespaceAuthorizations authorizations)
        throws IOException {
    ...
    static {
        try {
            ...
            InputStream schemaStream = SecurityFileUtils.class.getResourceAsStream( SECURITY_SCHEMA_LOCATION );
