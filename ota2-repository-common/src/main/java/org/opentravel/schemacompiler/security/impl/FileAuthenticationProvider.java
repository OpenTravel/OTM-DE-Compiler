...
/**
 * Authentication provider that performs its checks against a credentials file on the repository's file system.
 * 
 * @author S. Livezey
 */
public class FileAuthenticationProvider extends AbstractAuthenticationProvider {
    ...
    public List<UserPrincipal> searchCandidateUsers(String searchCriteria, int maxResults) throws RepositoryException {
        throw new UnsupportedOperationException(
            "Repositories configured for local user management do not support candidate user searches." );
    }
