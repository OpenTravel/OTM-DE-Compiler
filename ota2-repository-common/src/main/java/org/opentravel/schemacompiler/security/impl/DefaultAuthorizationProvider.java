...
public class DefaultAuthorizationProvider implements AuthorizationProvider {
    ...
    /**
     * Assesses the user's permissions for the specified namespace and adjusts the granted permission as required. The
     * updated permission grant is returned by this method.
     * 
    ...
    /**
     * Searches the repository folder structure, looking for at least one authorization file. If even a single file is
     * identified, this method will return true.
     * 
    ...
    /**
     * Creates a default authorization file at the root directory of the repository folder structure. If the file cannot
     * be created, this method will simply log the error and return with no action.
     */
    ...
    /**
     * Returns the namespace hierarchy in the order that it must be traversed in order to determine a user's
    ...
    private List<String> getNamespaceHierarchy(String namespace) throws RepositorySecurityException {
        try {
            ...
            throw new RepositorySecurityException( "Unable to determine security hierarchy for namespace: " + namespace,
                e );
        }
    }
    ...
    /**
     * Returns a new <code>AuthorizationResource</code>. If an error occurs while creating it, a runtime exception will
     * be thrown.
     * 
