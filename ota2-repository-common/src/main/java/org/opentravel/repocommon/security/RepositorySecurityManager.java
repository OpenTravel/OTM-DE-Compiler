...
/**
 * Provides all authentication and authorization services required for secure operation of the OTA2.0 repository.
 * 
 * @author S. Livezey
 */
public interface RepositorySecurityManager {
    ...
    /**
     * Returns the user principal indicated by the HTTP authorization header provided. If the header value is null, the
     * anonymous user will be returned. If the user fails authentication, a <code>RepositorySecurityException</code>
     * will be thrown.
     * 
    ...
    /**
     * Returns the user principal indicated by the user ID and password credentials provided. If the header value is
     * null, the anonymous user will be returned. If the user fails authentication, a
    ...
    /**
     * Returns true if the user is authorized to perform the specified operation within the requested namespace.
     * 
     ...
     * 
     * @param user the user for which authorization is being requested
     * @param item the repository item to check for read permission
     * @return boolean
     * @throws RepositorySecurityException thrown if the user's authorizations cannot be resolved
     */
    ...
    /**
     * Returns true if the user is authorized to write the given repository item. Note that this method will always
     * return false for items not in DRAFT status.
     * 
     * @param user the user for which authorization is being requested
     * @param item the repository item to check for write permission
     * @return boolean
     * @throws RepositorySecurityException thrown if the user's authorizations cannot be resolved
     */
    ...
    /**
     * Returns true if the user is authorized to promote the given repository item to the next-level status.
     * 
     * @param user the user for which authorization is being requested
     * @param item the repository item to check for promote permission
     * @return boolean
     * @throws RepositorySecurityException thrown if the user's authorizations cannot be resolved
     */
