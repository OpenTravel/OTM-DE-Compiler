...
/**
 * Search result object that encapsulates all relevant information about a user's subscription in an OTM repository.
 */
public class SubscriptionSearchResult implements Comparable<SubscriptionSearchResult> {
    ...
    /**
     * Constructor that initializes this search result instance using the information provided.
     * 
    ...
    /**
     * Returns the list of events to which the user is subscribed within the scope of the subscription target.
     *
    ...
    public boolean equals(Object obj) {
        return (obj instanceof SubscriptionSearchResult) && (compareTo( (SubscriptionSearchResult) obj ) == 0);
    }
    ...
    /**
     * Performs a comparison of the two strings, accounting for null values that might exist.
     * 
