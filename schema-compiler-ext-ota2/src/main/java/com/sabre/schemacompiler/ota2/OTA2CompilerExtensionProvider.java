 ...
 */
package com.sabre.schemacompiler.ota2;
...
import com.sabre.schemacompiler.extension.CompilerExtension;
import com.sabre.schemacompiler.extension.CompilerExtensionProvider;
...
public class OTA2CompilerExtensionProvider implements CompilerExtensionProvider {
	...
	/**
	 * @see com.sabre.schemacompiler.extension.CompilerExtensionProvider#getCompilerExtensions()
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.extension.CompilerExtensionProvider#isSupportedExtension(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.extension.CompilerExtensionProvider#loadCompilerExtension(org.springframework.context.support.GenericApplicationContext, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.extension.CompilerExtensionProvider#loadGeneralCompilerExtensions(org.springframework.context.support.GenericApplicationContext)
	 */
	@Override
	...
	/**
	 * @see com.sabre.schemacompiler.extension.CompilerExtensionProvider#getExtensionResource(java.lang.String)
	 */
	@Override
	 ...
	 * @param urlMap  associates each extension ID with a list of URL locations for the Spring
	 ...
	 * @param configLocations  the classpath URL for the Spring configuration files that define
	 *						   the binding style
	 */
	...
	static {
		try {
			...
			registerBindingStyle( extensions, urlMap, OTA2CompilerConstants.OTA2_COMPILER_EXTENSION_ID, 50,
