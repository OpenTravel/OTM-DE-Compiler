...
public class TestAdminController extends AbstractConsoleTest {
    ...
    public static void setupTests() throws Exception {
        ...
        startTestServer( "versions-repository", 9297, jmsIndexRepositoryConfig,
                false, true, TestAdminController.class );
    }
    ...
    public void testManageRootNamespaces() throws Exception {
        try (WebClient client = newWebClient( true )) {
            ...
            assertTrue( page.asText().contains( "The root namespace cannot be created because it conflicts with an existing one." ) );
    ...
    public void testManageNamespacePermissions() throws Exception {
        try (WebClient client = newWebClient( true )) {
            ...
            HtmlOption option = select.getOptionByValue( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/version-test" );
    ...
    public void testManageLocalUsers() throws Exception {
        String[][] createAttempts = new String[][] {
            new String[] { "testuser", "Doe", "John", "john.doe@opentravel.org", "password", "password" },
        ...
        String[][] editAttempts = new String[][] {
            new String[] { "", "John", "john.doe@opentravel.org" },
            new String[] { "Doe", "John", "" },
            new String[] { "Doe", "John", "john.doe" },
            new String[] { "Doe", "John", "john.doe@opentravel.org" },
        };
        String[][] passwordAttempts = new String[][] {
            new String[] { "", "" },
            new String[] { "bad password", "bad password" },
            new String[] { "newpassword", "mismatch" },
        ...
        try (WebClient client = newWebClient( true )) {
            ...
            page = page.getAnchorByHref( "/ota2-repository-service/console/adminUsersEditLocal.html?userId=doej" ).click();
            ...
            page = page.getAnchorByHref( "/ota2-repository-service/console/adminUsersChangePassword.html?userId=doej" ).click();
    ...
    public void testManageGroups() throws Exception {
        ...
        try (WebClient client = newWebClient( true )) {
            ...
            page = page.getAnchorByHref( "/ota2-repository-service/console/adminGroupsEdit.html?groupName=TestGroup" ).click();
            ...
            // Delete the group
            page = page.getAnchorByHref( "/ota2-repository-service/console/adminGroupsDelete.html?groupName=TestGroup" ).click();
    ...
    public void testManageLibraries() throws Exception {
        ...
        try (WebClient client = newWebClient( true )) {
            String pageUrl = getLibraryUrl( "/console/libraryInfo.html",
