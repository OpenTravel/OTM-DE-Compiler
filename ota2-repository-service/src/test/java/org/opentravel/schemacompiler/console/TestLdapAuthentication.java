...
/**
 * Base class that defines LDAP authentication tests that should pass regardless
...
public abstract class TestLdapAuthentication extends AbstractConsoleTest {
    ...
    public void testManageLdapUsers() throws Exception {
        try (WebClient client = newWebClient( true )) {
            ...
            page = page.getAnchorByHref( "/ota2-repository-service/console/adminUsersDelete.html?userId=doejane" ).click();
