...
/**
 * Base class for all tests that utilize a headless web browser to verifiy the
 * functions of the repository web console.
 */
public abstract class AbstractConsoleTest extends RepositoryTestBase {
    ...
    protected String getLibraryUrl(String urlPath, String baseNamespace, String filename,
