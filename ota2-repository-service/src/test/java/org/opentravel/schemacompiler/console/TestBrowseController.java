...
public abstract class TestBrowseController extends AbstractConsoleTest {
    ...
    public void testBrowsePage() throws Exception {
        String[] linksToFollow = new String[] { "http://www.OpenTravel.org",
                "ns", "OTA2", "SchemaCompiler", "version-test", "all versions" };
    ...
    private String getLibrarySubscriptionUrl(String baseNamespace, String libraryName, String version,
        ...
        return getLibraryUrl( "/console/librarySubscription.html", baseNamespace, filename, version ) +
                "&libraryName=" + URLEncoder.encode( libraryName, "UTF-8" ) +
