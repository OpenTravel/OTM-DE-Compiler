...
public class TestRepositorySearch extends RepositoryTestBase {
    ...
    public void testListNamespaces() throws Exception {
        ...
        assertTrue(
            allNamespaces.contains( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/version-test/v01_01_01" ) );
    }
    ...
    public void testListNamespaceItems_allVersions_includeDraft() throws Exception {
        ...
        List<RepositoryItem> items =
            testRepository.listItems( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/version-test", false, true );
    ...
    public void testListNamespaceItems_allVersions_finalOnly() throws Exception {
        ...
        try {
            ...
            items = testRepository.listItems( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/version-test", false,
                false );
    ...
    public void testListNamespaceItems_latestVersion_includeDraft() throws Exception {
        Repository testRepository = repositoryManager.get().getRepository( "test-repository" );
        List<RepositoryItem> items =
            testRepository.listItems( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/version-test", true, true );
        List<String> itemFilenames = getFilenames( items );
    ...
    public void testListNamespaceItems_latestVersion_finalOnly() throws Exception {
        ...
        try {
            ...
            items = testRepository.listItems( "http://www.OpenTravel.org/ns/OTA2/SchemaCompiler/version-test", true,
                false );
            itemFilenames = getFilenames( items );
