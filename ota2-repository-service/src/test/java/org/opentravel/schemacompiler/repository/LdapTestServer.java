...
/**
 * Provides a pre-populated embedded LDAP server used for testing the authentication
 * protocols of the OTA2.0 repository.
 */
public class LdapTestServer {
     ...
     * @param ldifFilePath  the path of the LDIF file to use when populating the directory (relative to /src/test/resources)
