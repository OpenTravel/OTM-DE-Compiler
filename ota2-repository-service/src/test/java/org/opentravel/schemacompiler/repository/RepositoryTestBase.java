...
public abstract class RepositoryTestBase {
    ...
    protected static File ldapLookupRepositoryConfig = new File( System.getProperty( "user.dir" ),
            "/target/test-classes/ota2-repository-config-ldaplookup.xml" );
    protected static File ldapSearchRepositoryConfig = new File( System.getProperty( "user.dir" ),
            "/target/test-classes/ota2-repository-config-ldapsearch.xml" );
    protected static File jmsIndexRepositoryConfig = new File( System.getProperty( "user.dir" ),
            "/target/test-classes/ota2-repository-config-jmsindex.xml" );
