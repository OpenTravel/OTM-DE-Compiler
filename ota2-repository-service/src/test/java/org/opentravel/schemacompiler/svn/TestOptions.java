...
public class TestOptions {
    ...
    public static TestOptions loadFrom(Properties properties) {
        ...
        return new TestOptions(repositoryUrl, tempDirectory, sqlite3Command, largeUpdateStep,
        		svnCommand, updateSchedule, apacheCtlCommand, apacheRoot, htpasswdCommand,
        		svnserveCommand);
    }
    
    public static TestOptions getDefaults(SVNURL repositoryUrl) {
        return new TestOptions(repositoryUrl, null, "sqlite3", 10, "svn",
        		new ArrayList<SVNRevisionRange>(), null, null, null, "svnserve");
    }
    ...
    public TestOptions(SVNURL repositoryUrl, File tempDirectory, String sqlite3Command,
    		long largeUpdateStep, String svnCommand, List<SVNRevisionRange> arrayList,
    		String apacheCtlCommand, File apacheRoot, String htpasswdCommand,
    		String svnserveCommand) {
