...
<table id="itemtable" style="width:100%;float:left;">
	...
	<c:if test="${libraryAssemblies.isEmpty()}">
		<tr class="d0">
			<td colspan="2">This library is not associated with any service assemblies</td>
		</tr>
	</c:if>
	<c:set var="rowStyle" value="d0" />
	<c:forEach var="assembly" items="${libraryAssemblies}">
