...
<form id="editUserForm" action="${pageContext.request.contextPath}/console/namespaceSubscription.html" method="post">
<input name="updateSubscription" type="hidden" value="true" />
<input name="baseNamespace" type="hidden" value="${baseNamespace}" />
<input name="cts" type="hidden" value="${cts}" />
<b>Namespace: </b>${baseNamespace}
<p><br/>
<span>From the table below, select the events for which you wish to receive email notifications in this namespace.</span>
<p><br/>
<table id="userTable" style="margin-left:25px">
	...
	<tr class="d0">
		<td style="text-align:center;"><input name="etNamespaceAction" type="checkbox" value="true" ${etNamespaceAction ? 'checked' : ''} /></td>
		<td><spring:message code="NAMESPACE_ACTION" /></td>
	</tr>
	<tr>
		<td colspan="2" style="text-align:right;">
			<c:choose>
				...
				<c:otherwise>
					<c:url var="cancelUrl" value="/console/browse.html">
