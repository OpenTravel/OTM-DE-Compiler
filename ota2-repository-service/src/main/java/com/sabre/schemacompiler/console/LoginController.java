...
import com.sabre.schemacompiler.security.impl.FileAuthenticationProvider;
			...
			if (currentUser == null) {
				...
				if ((oldPassword == null) || (oldPassword.length() == 0)) {
					...
					try {
						...
						securityManager.getUser(currentUser.getUserId(), oldPassword); // throws an exception if password is not valid
						FileAuthenticationProvider.saveUserCredentials( currentUser.getUserId(), newPassword, false, fileManager );
