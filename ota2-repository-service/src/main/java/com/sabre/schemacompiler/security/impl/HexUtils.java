...
/**
 * Utility methods useful in dealing used to convert byte arrays to and from
...
public class HexUtils {
	 ...
	 *                found, or the input string contains an odd number of
	 *                hexadecimal digits
	 */
	 ...
	 * @return int
	 * @exception IllegalArgumentException  thrown if an invalid hexadecimal digit is included
	 */
