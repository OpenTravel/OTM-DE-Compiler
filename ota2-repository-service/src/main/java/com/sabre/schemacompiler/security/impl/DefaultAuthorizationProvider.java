...
import com.sabre.schemacompiler.security.AuthorizationResource;
...
public class DefaultAuthorizationProvider implements AuthorizationProvider {
	...
	/**
	 * Constructor that provides the location of the web service's repository on the local file system.
	 * 
	...
	/**
	 * @see com.sabre.schemacompiler.security.AuthorizationProvider#getAuthorization(com.sabre.schemacompiler.security.UserPrincipal, java.lang.String)
	 */
	@Override
	public RepositoryPermission getAuthorization(UserPrincipal user, String namespace) throws RepositorySecurityException {
		...
		// Traverse up the namespace hierarchy gathering all of the granted and denied permissions for this user
	 ...
	 * 
	 * @param repositoryLocation  the repository location to search
	 * @return boolean
	 */
	...
	/**
	 * Creates a default authorization file at the root directory of the repository folder structure.  If
	 * the file cannot be created, this method will simply log the error and return with no action.
	 */
	...
	/**
	 * Returns the namespace hierarchy in the order that it must be traversed in order to determine a
	 * user's authorization scheme.
	 * 
	 * @param namespace  the namespace for which to return the hierarchy
	 * @return List<String>
	 * @throws RepositorySecurityException  thrown if the namespace URI is not valid
	 */
	private List<String> getNamespaceHierarchy(String namespace) throws RepositorySecurityException {
		try {
			...
			throw new RepositorySecurityException("Unable to determine security hierarchy for namespace: " + namespace, e);
		}
	}
	 ...
	 * 
	 * @param namespace  the namespace for which to returnt he authorization resource
	 * @return AuthorizationResource
	 * @throws RepositorySecurityException  thrown if the authorization resource file cannot be identified
	 */
	private synchronized AuthorizationResource getAuthorizationResource(String namespace) throws RepositorySecurityException {
	 ...
	 * 
	 * @param permission  the permission for which to return an ordinal rank
	 * @return int
	 */
