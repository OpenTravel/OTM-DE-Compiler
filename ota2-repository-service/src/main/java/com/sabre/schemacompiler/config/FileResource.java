 ...
 */
package com.sabre.schemacompiler.config;
...
/**
 * Generic resource that provides access to structured information that is loaded from a data file.  Each
 * time the resource is accessed, the timestamp of the file is checked to determine if the content of the
...
public abstract class FileResource<R> {
	...
	/**
	 * Returns the resource instance after first checking to determine if an update from
	...
	/**
	 * Checks the last-updated data of the file from which this resource is loaded.  If the file has been
	 * modified, its contents will be reloaded.  If an error occurs during reload, the problem will be logged
	 * and the existing resource value left unchanged.
	 * 
	 * @param dataFile  the data file that provides persistent content for this resource instance
	 */
	...
	/**
	 * Adjusts the internally-tracked modification date of the file resource, forcing it to be reloaded the
