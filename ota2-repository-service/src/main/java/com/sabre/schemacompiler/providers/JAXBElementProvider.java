 ...
 */
package com.sabre.schemacompiler.providers;
...
/**
 * Custom JAXB element provider that resolves the issue related to type bindings
 * when unmarshalling XML elements that belong to substitution groups.
 * 
 * @author S. Livezey
 */
public abstract class JAXBElementProvider extends AbstractJAXBElementProvider {
	...
	/**
	 * Constructor that specifies the injectable SAX parser factory and the jax-rs provider instances.
	 * 
	 * @param spf  the injectable SAX parser factory
	 * @param ps  the jax-rs provider instances
	 */
	...
	/**
	 * Constructor that specifies the injectable SAX parser factory and the jax-rs provider instances, as
	 * well as the media type to be supported by the provider.
	 * 
	 * @param spf  the injectable SAX parser factory
	 * @param ps  the jax-rs provider instances
	 * @param mt  the media type to be supported by this provider
	 */
	public JAXBElementProvider(@Context Injectable<SAXParserFactory> spf, @Context Providers ps,
	...
	/**
	 * @see com.sun.jersey.core.provider.jaxb.AbstractJAXBElementProvider#readFrom(java.lang.Class, javax.ws.rs.core.MediaType, javax.xml.bind.Unmarshaller, java.io.InputStream)
	 */
	protected final JAXBElement<?> readFrom(Class<?> type, MediaType mediaType, Unmarshaller u, InputStream entityStream)
			throws JAXBException {
		JAXBElement<?> jaxbElement = (JAXBElement<?>) u.unmarshal(getSAXSource(spf.getValue(), entityStream));
	...
	/**
	 * @see com.sun.jersey.core.provider.jaxb.AbstractJAXBElementProvider#writeTo(javax.xml.bind.JAXBElement, javax.ws.rs.core.MediaType, java.nio.charset.Charset, javax.xml.bind.Marshaller, java.io.OutputStream)
	 */
