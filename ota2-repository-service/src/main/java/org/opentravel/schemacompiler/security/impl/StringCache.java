...
public class StringCache {
     ...
     */
    protected static final HashMap<ByteEntry, int[]> bcStats = new HashMap<ByteEntry, int[]>(
            cacheSize);
     ...
     */
    protected static final HashMap<CharEntry, int[]> ccStats = new HashMap<CharEntry, int[]>(
            cacheSize);
