...
/**
 * Utility methods used for loading and saving the contents of security-related files in the
 * OTA2.0 repository.
 * 
 * @author S. Livezey
 */
public class SecurityFileUtils {
	...
	/**
	 * Returns the filename of the authorization file for the specified namespace.  If the 'namespace'
	 * parameter is null, the location of the global authorization file will be returned.
	 * 
	 * <p>NOTE: Even though the file location is returned by this method, the existence of an authorization
	 * file is not guaranteed by this method.
	 * 
	...
	public File getAuthorizationFile(String namespace) throws RepositorySecurityException {
		try {
			...
			throw new RepositorySecurityException("Unable to identify authorization file for namespace: " + namespace, e);
		}
	}
	 ...
	 * @throws IOException  thrown if the file content cannot be saved
	 */
	public void saveNamespaceAuthorizations(File authorizationFile, NamespaceAuthorizations authorizations) throws IOException {
