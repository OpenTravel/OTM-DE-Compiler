...
public class CharChunk implements Cloneable, Serializable, CharSequence {
    ...
    /**
     * When we need more space we'll either grow the buffer ( up to the limit ) or send it to a
     * channel.
     */
    ...
    public void append(char src[], int off, int len) throws IOException {
        ...
        if (len + end < 2 * limit) {
             ...
             * and then write the data directly. We can't avoid 2 writes, but we can write more on
             * the second
             */
            int avail = limit - end;
