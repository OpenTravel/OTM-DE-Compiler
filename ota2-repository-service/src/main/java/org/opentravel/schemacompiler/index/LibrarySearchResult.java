...
public class LibrarySearchResult extends SearchResult<TLLibrary> {
	...
	/**
	 * Returns the reference identity ID for the entity referenced with the given type-reference
	 * string.
	 * 
	...
	/**
	 * Returns the ID of the user who currently owns the lock on the library (null
	 * if not locked).
	 *
	 * @return String
	 */
	...
	/**
	 * Returns the namespace URI that is mapped to the specified prefix in this library
	 * or null if the prefix is not mapped to a namespace.
	 * 
