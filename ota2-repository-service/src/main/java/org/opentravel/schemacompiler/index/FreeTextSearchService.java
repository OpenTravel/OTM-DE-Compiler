...
public class FreeTextSearchService {
     ...
     *             thrown if an error occurs while retrieving content from the repository
     */
    public void indexAllRepositoryItems() throws RepositoryException {
        ...
        synchronized (indexingQueue) {
            try {
                ...
                throw new RepositoryException("Error clearing existing content from search index.",
                        e);
            }
        }
        ...
        for (String baseNamespace : repositoryManager.listBaseNamespaces()) {
            ...
            // Start by separating the contents of the base namespace into lists of versions for
            // each library
    ...
    /**
     * Submits the given repository item for indexing. The service does not need to be running for
     ...
     * 
     * @param item
     *            the repository item whose index is to be deleted
     */
    ...
    public List<RepositoryItem> query(String queryString, boolean latestVersionsOnly,
        ...
        return queryTask
                .queryRepositoryItems(queryString, latestVersionsOnly, includeDraftVersions);
    }
