...
/**
 * Servlet class that extends the Jersey JAX-RS servlet, adding a function to gracefully release
 * the indexing service resources when the servlet container is shut down.
 * 
 * @author S. Livezey
 */
public class RepositoryServlet extends ServletContainer {
	 ...
	 * 
	 * @param app  the JAX-RS application instance
	 */
	 ...
	 * 
	 * @param appClass  the type of application with which this servlet should be initialized
	 */
