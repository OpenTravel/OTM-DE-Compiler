...
/**
 * Helper class for rendering JSP pages that handles the deresolution of plain-text
 * entity references.
 * 
 * @author S. Livezey
 */
public class EntityNameResolver {
	...
	/**
	 * Returns the qualified name for the given entity reference.  If the entity is not a
	 * valid reference (including if it is a reference to an OTM built-in type) this method
	 * will return null.
	 * 
