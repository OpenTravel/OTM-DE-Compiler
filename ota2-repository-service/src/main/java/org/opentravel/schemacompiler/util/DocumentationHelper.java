...
/**
 * Helper class that assists with the rendering of <code>TLDocumentation</code> entries
 * for OTM <code>NamedEntity</code> objects.
 * 
 * @author S. Livezey
 */
public class DocumentationHelper {
	...
	public DocumentationHelper(EntitySearchResult indexEntity) {
		...
		if (entity instanceof TLDocumentationOwner) {
			...
			if (modelDoc != null) {
				...
				implementerDocs = deprecationDocs = referenceDocs
						= moreInfoDocs = otherDocs = Collections.emptyList();
			}
		}
	...
	public boolean hasAdditionalDocs() {
		return !implementerDocs.isEmpty() || !deprecationDocs.isEmpty() ||
				!referenceDocs.isEmpty() || !moreInfoDocs.isEmpty() || !otherDocs.isEmpty();
	}
