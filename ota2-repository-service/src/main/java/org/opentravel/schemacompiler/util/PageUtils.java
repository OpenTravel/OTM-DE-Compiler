...
public class PageUtils {
    ...
    /**
     * Return the extension reference string for the given entity if the entity contains such a reference.
     * 
    ...
    /**
     * Return the simple facet string for the given entity if the entity contains such a reference. If the given entity
     * is not a core or does not define a simple facet reference, this method will return null.
     * 
     * @param indexEntity the entity index document
     * @return String
     */
