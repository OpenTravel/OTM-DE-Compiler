 ...
 */
package com.sabre.schemacompiler.mvn;
...
public class OTA2SchemaCompilerMojo extends AbstractMojo implements CompileAllTaskOptions {
	...
	protected void displayOptions() {
		...
		log.info("libraryFile                   = " + ((libraryFile == null) ? "[NULL]" : libraryFile.getAbsolutePath()));
		log.info("catalog                       = " + ((catalog == null) ? "[NULL]" : catalog.getAbsolutePath()));
		log.info("outputFolder                  = " + ((outputFolder == null) ? "[NULL]" : outputFolder.getAbsolutePath()));
